...
* Update the default path to the log file in the configuration ([#15485](https://github.com/KhulnaSoft/integrations-core/pull/15485))
...
* Add `pyproject.toml` file ([#11551](https://github.com/KhulnaSoft/integrations-core/pull/11551))

## 1.13.0 / 2022-01-08 / Agent 7.34.0

***Added***:

* Support new implementation of Windows performance counters on Python 3 ([#10850](https://github.com/KhulnaSoft/integrations-core/pull/10850))
...
* Add runtime configuration validation ([#8878](https://github.com/KhulnaSoft/integrations-core/pull/8878))
...
* Active Directory to not use agentConfig ([#5938](https://github.com/KhulnaSoft/integrations-core/pull/5938))
...
* Adhere to code style ([#3483](https://github.com/KhulnaSoft/integrations-core/pull/3483))

## 1.3.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2975](https://github.com/KhulnaSoft/integrations-core/pull/2975))
