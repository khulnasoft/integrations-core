...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'active_directory', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-active_directory',
    version=ABOUT["__version__"],
    description='The Active Directory check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent active directory check',
    ...
    packages=['khulnasoft_checks.active_directory'],
