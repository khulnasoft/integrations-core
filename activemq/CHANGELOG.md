...
* Update some metric types ([#15040](https://github.com/KhulnaSoft/integrations-core/pull/15040))
...
* Add `pyproject.toml` file ([#11309](https://github.com/KhulnaSoft/integrations-core/pull/11309))
...
* Add runtime configuration validation ([#8879](https://github.com/KhulnaSoft/integrations-core/pull/8879))
...
* Add support for ActiveMQ Artemis ([#8527](https://github.com/KhulnaSoft/integrations-core/pull/8527))
...
* Add domain to metrics.yaml ([#7163](https://github.com/KhulnaSoft/integrations-core/pull/7163))
...
* Add config specs to activemq ([#6115](https://github.com/KhulnaSoft/integrations-core/pull/6115))

***Fixed***:

* Fix e2e test ([#6167](https://github.com/KhulnaSoft/integrations-core/pull/6167))
...
* Add log section ([#4013](https://github.com/KhulnaSoft/integrations-core/pull/4013))
