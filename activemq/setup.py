...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'activemq', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-activemq',
    version=ABOUT['__version__'],
    description='The ActiveMQ check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent activemq check',
    ...
    packages=['khulnasoft_checks.activemq'],
