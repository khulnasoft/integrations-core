...
* Add `pyproject.toml` file ([#11310](https://github.com/KhulnaSoft/integrations-core/pull/11310))
...
* Add runtime configuration validation ([#8880](https://github.com/KhulnaSoft/integrations-core/pull/8880))
...
* Add logs documentation ([#9069](https://github.com/KhulnaSoft/integrations-core/pull/9069))
...
* Add config specs to activemq xml ([#6116](https://github.com/KhulnaSoft/integrations-core/pull/6116))
...
* Standardize logging format ([#4896](https://github.com/KhulnaSoft/integrations-core/pull/4896))
...
* Update with proxy settings  ([#3361](https://github.com/KhulnaSoft/integrations-core/pull/3361))

## 1.2.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Adhere to code style ([#3323](https://github.com/KhulnaSoft/integrations-core/pull/3323))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2583
