...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "activemq_xml", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-activemq_xml',
    version=ABOUT["__version__"],
    description='The ActiveMQ XML check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent activemq_xml check',
    ...
    packages=['khulnasoft_checks.activemq_xml'],
