...
* Collect more `client_read` and `client_write` metrics by default ([#16423](https://github.com/KhulnaSoft/integrations-core/pull/16423))
...
* Fix missing latency metrics from other namespaces ([#12944](https://github.com/KhulnaSoft/integrations-core/pull/12944))
...
* Add OpenMetricsV2 Implementation ([#11845](https://github.com/KhulnaSoft/integrations-core/pull/11845))
...
* Fix broken latency metric collection ([#11752](https://github.com/KhulnaSoft/integrations-core/pull/11752))
...
* Add `pyproject.toml` file ([#11311](https://github.com/KhulnaSoft/integrations-core/pull/11311))
...
* Add runtime configuration validation ([#8881](https://github.com/KhulnaSoft/integrations-core/pull/8881))

## 1.12.0 / 2021-06-22 / Agent 7.30.0

***Added***:

* Stop using a deprecated method to support newer versions of Aerospike ([#9566](https://github.com/KhulnaSoft/integrations-core/pull/9566))
* Upgrade `aerospike` dependency on Python 3 ([#9552](https://github.com/KhulnaSoft/integrations-core/pull/9552))

***Fixed***:

* Handle command output with erroneous trailing separators ([#9571](https://github.com/KhulnaSoft/integrations-core/pull/9571))

## 1.11.0 / 2021-04-06 / Agent 7.28.0

***Added***:

* Support XDR metrics for Aerospike Enterprise 5.0+ ([#8696](https://github.com/KhulnaSoft/integrations-core/pull/8696))

## 1.10.1 / 2021-03-07 / Agent 7.27.0

***Fixed***:

* Return empty array instead of None ([#8532](https://github.com/KhulnaSoft/integrations-core/pull/8532))
* Fix logging ([#8515](https://github.com/KhulnaSoft/integrations-core/pull/8515))

## 1.10.0 / 2021-02-01

***Added***:

* Support Aerospike 5.3 ([#8430](https://github.com/KhulnaSoft/integrations-core/pull/8430))
...
* Add log pipeline ([#8068](https://github.com/KhulnaSoft/integrations-core/pull/8068))
* Update aerospike dependency ([#8044](https://github.com/KhulnaSoft/integrations-core/pull/8044))

***Fixed***:

* Update check signature ([#8157](https://github.com/KhulnaSoft/integrations-core/pull/8157))

## 1.8.3 / 2020-07-23 / Agent 7.22.0

***Fixed***:

* Fix empty result case ([#7192](https://github.com/KhulnaSoft/integrations-core/pull/7192))

## 1.8.2 / 2020-07-22

***Fixed***:

* Add debug log for get info calls ([#7182](https://github.com/KhulnaSoft/integrations-core/pull/7182))

## 1.8.1 / 2020-07-10

***Fixed***:

* Parse batch-index read latency metrics ([#6991](https://github.com/KhulnaSoft/integrations-core/pull/6991))
...
* Fix namespace valid chars matching regex ([#6352](https://github.com/KhulnaSoft/integrations-core/pull/6352))
* Fix namespace tagging for latency metrics ([#6345](https://github.com/KhulnaSoft/integrations-core/pull/6345))

## 1.7.0 / 2020-03-13 / Agent 7.19.0

***Added***:

* Add TLS config ([#6035](https://github.com/KhulnaSoft/integrations-core/pull/6035))
...
* Add latency and datacenter metrics for Aerospike also collect version metadata information ([#4969](https://github.com/KhulnaSoft/integrations-core/pull/4969))

## 1.4.0 / 2019-12-02 / Agent 7.16.0

***Added***:

* Standardize logging format ([#4897](https://github.com/KhulnaSoft/integrations-core/pull/4897))

## 1.3.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3484](https://github.com/KhulnaSoft/integrations-core/pull/3484))
...
* Add authentication and timeout options ([#3214](https://github.com/KhulnaSoft/integrations-core/pull/3214))
* Refactor check to use the official library ([#3212](https://github.com/KhulnaSoft/integrations-core/pull/3212))

## 1.0.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Officially support Aerospike ([#3078](https://github.com/KhulnaSoft/integrations-core/pull/3078))
