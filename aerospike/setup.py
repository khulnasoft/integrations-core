...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'aerospike', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-aerospike',
    version=ABOUT['__version__'],
    description='The Aerospike check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent aerospike check',
    ...
    packages=['khulnasoft_checks.aerospike'],
