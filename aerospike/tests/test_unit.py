...
from khulnasoft_checks.aerospike import AerospikeCheck
...
def test_collect_xdr_invalid_data(aggregator):
    ...
    with mock.patch('khulnasoft_checks.aerospike.AerospikeCheck.get_info', return_value="ERROR::XDR-not-configured"):
        check.collect_xdr()
