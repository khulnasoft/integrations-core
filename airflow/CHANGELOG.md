...
* Update mapping and tags in README.md ([#11967](https://github.com/KhulnaSoft/integrations-core/pull/11967)) Thanks [moshederri](https://github.com/moshederri).
* Update airflow integration dogstatsd_mapper_profiles example ([#12101](https://github.com/KhulnaSoft/integrations-core/pull/12101)) Thanks [jessezhang91](https://github.com/jessezhang91).
...
* Add `pyproject.toml` file ([#11312](https://github.com/KhulnaSoft/integrations-core/pull/11312))
...
* Fix airflow logs example ([#10475](https://github.com/KhulnaSoft/integrations-core/pull/10475))

## 2.1.0 / 2021-10-04 / Agent 7.32.0

***Added***:

* Add runtime configuration validation ([#8882](https://github.com/KhulnaSoft/integrations-core/pull/8882))
...
* Add support for Airflow 2 ([#9064](https://github.com/KhulnaSoft/integrations-core/pull/9064))
...
* Update check signature ([#8175](https://github.com/KhulnaSoft/integrations-core/pull/8175))
...
* airflow new metrics ([#7112](https://github.com/KhulnaSoft/integrations-core/pull/7112))
...
* DOCS-983 Airflow integration ([#6971](https://github.com/KhulnaSoft/integrations-core/pull/6971))
...
* Use config spec ([#6305](https://github.com/KhulnaSoft/integrations-core/pull/6305))
...
* Add airflow logs ([#5405](https://github.com/KhulnaSoft/integrations-core/pull/5405))

## 1.0.0 / 2020-01-06 / Agent 7.17.0

***Added***:

* Add Airflow integration ([#5232](https://github.com/KhulnaSoft/integrations-core/pull/5232))
