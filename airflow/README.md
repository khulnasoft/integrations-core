...
2. Update the Airflow configuration file `airflow.cfg` by adding the following configs:
   ...
   <div class="alert alert-warning"> Do not set `statsd_khulnasoft_enabled` to true. Enabling `statsd_khulnasoft_enabled` can create conflicts. To prevent issues, ensure that the variable is set to `False`.</div>
...
[5]: https://github.com/KhulnaSoft/integrations-core/blob/master/airflow/khulnasoft_checks/airflow/data/conf.yaml.example
...
[8]: https://docs.khulnasoft.com/getting_started/agent/autodiscovery/?tab=docker#integration-templates
[9]: https://docs.khulnasoft.com/agent/guide/agent-configuration-files/
[10]: https://docs.khulnasoft.com/agent/guide/agent-commands/?tab=agentv6#start-stop-and-restart-the-agent
[11]: https://docs.khulnasoft.com/help/
[12]: https://docs.khulnasoft.com/developers/dogstatsd/?tab=kubernetes#setup
