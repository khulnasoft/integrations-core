...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'airflow', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-airflow',
    version=ABOUT['__version__'],
    description='The Airflow check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent airflow check',
    ...
    packages=['khulnasoft_checks.airflow'],
