...
* Fix TypeError when tags are undefined ([#16496](https://github.com/KhulnaSoft/integrations-core/pull/16496))
...
* Update Boto3 dependency to 1.28.55 ([#15922](https://github.com/KhulnaSoft/integrations-core/pull/15922))
...
* Switch count method to monotonic count, that's correct for OM counts ([#13972](https://github.com/KhulnaSoft/integrations-core/pull/13972))
* Submit count versions of metrics that we mistakenly submit as gauges ([#13886](https://github.com/KhulnaSoft/integrations-core/pull/13886))
...
* Allow disabling querying an exporter ([#11306](https://github.com/KhulnaSoft/integrations-core/pull/11306))
* Add `pyproject.toml` file ([#11313](https://github.com/KhulnaSoft/integrations-core/pull/11313))
...
* Account for errors in boto client creation ([#10386](https://github.com/KhulnaSoft/integrations-core/pull/10386))

## 2.0.0 / 2021-10-04

***Changed***:

* Update Amazon MSK documentation to the new implementation ([#9993](https://github.com/KhulnaSoft/integrations-core/pull/9993))

***Added***:

* Update dependencies ([#10228](https://github.com/KhulnaSoft/integrations-core/pull/10228))
* Add proxy support in client initialization ([#10188](https://github.com/KhulnaSoft/integrations-core/pull/10188))
...
* Describe py3 requirement of use_openmetrics option ([#9714](https://github.com/KhulnaSoft/integrations-core/pull/9714))

## 1.8.0 / 2021-07-12

***Added***:

* Add metrics from label IDs ([#9643](https://github.com/KhulnaSoft/integrations-core/pull/9643))
...
* Allow the use of the new OpenMetrics implementation ([#9082](https://github.com/KhulnaSoft/integrations-core/pull/9082))
* Add runtime configuration validation ([#8883](https://github.com/KhulnaSoft/integrations-core/pull/8883))
...
* Add `kafka_consumer_group_ConsumerLagMetrics_Value` metric ([#9027](https://github.com/KhulnaSoft/integrations-core/pull/9027)) Thanks [idarlington](https://github.com/idarlington).
* Allow prometheus metrics path to be configurable ([#9028](https://github.com/KhulnaSoft/integrations-core/pull/9028))

## 1.4.1 / 2021-01-25 / Agent 7.26.0

***Fixed***:

* Hide auto-populated prometheus_url from config spec ([#8330](https://github.com/KhulnaSoft/integrations-core/pull/8330))
...
* Add ability to assume a specified role when retrieving MSK metadata ([#8118](https://github.com/KhulnaSoft/integrations-core/pull/8118)) Thanks [garrett528](https://github.com/garrett528).
...
* Add config specs ([#7291](https://github.com/KhulnaSoft/integrations-core/pull/7291))
...
* Add Amazon MSK integration ([#5127](https://github.com/KhulnaSoft/integrations-core/pull/5127))
