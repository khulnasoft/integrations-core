...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'amazon_msk', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-amazon-msk',
    version=ABOUT['__version__'],
    description='The Amazon MSK check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent amazon_msk check',
    ...
    packages=['khulnasoft_checks.amazon_msk'],
