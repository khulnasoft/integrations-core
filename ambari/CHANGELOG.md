...
* Bump the minimum base check version to 34.1.2 ([#16139](https://github.com/KhulnaSoft/integrations-core/pull/16139))
...
* Add `pyproject.toml` file ([#11314](https://github.com/KhulnaSoft/integrations-core/pull/11314))
...
* Add runtime configuration validation ([#8884](https://github.com/KhulnaSoft/integrations-core/pull/8884))
...
* Add e2e test for ambari ([#10052](https://github.com/KhulnaSoft/integrations-core/pull/10052))
...
* Update check signature ([#8176](https://github.com/KhulnaSoft/integrations-core/pull/8176))
...
* Add config spec ([#6307](https://github.com/KhulnaSoft/integrations-core/pull/6307))
...
* Standardize logging format ([#4898](https://github.com/KhulnaSoft/integrations-core/pull/4898))
...
* Add custom tags to service checks ([#4320](https://github.com/KhulnaSoft/integrations-core/pull/4320))

## 1.1.1 / 2019-07-09 / Agent 6.13.0

***Fixed***:

* Fix typo TSL => TLS ([#4072](https://github.com/KhulnaSoft/integrations-core/pull/4072))

## 1.1.0 / 2019-07-04

***Added***:

* Add logs multiline managing ([#3912](https://github.com/KhulnaSoft/integrations-core/pull/3912))
