...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "apache", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-apache',
    version=ABOUT["__version__"],
    description='The Apache Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent apache check',
    ...
    packages=['khulnasoft_checks.apache'],
