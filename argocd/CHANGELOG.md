...
* Collect metrics for ArgoCD ApplicationSet ([#15308](https://github.com/KhulnaSoft/integrations-core/pull/15308))
...
* Add ArgoCD notifications controller metrics ([#14690](https://github.com/KhulnaSoft/integrations-core/pull/14690)) Thanks [maxknee](https://github.com/maxknee).
...
* Fix error that was triggered by including configuration parameters not ending in `_endpoint` ([#13409](https://github.com/KhulnaSoft/integrations-core/pull/13409))

## 1.0.0 / 2022-11-16

***Added***:

* Argo CD Integration ([#13223](https://github.com/KhulnaSoft/integrations-core/pull/13223))
