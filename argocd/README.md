...
metadata:
  name: '<POD_NAME>'
  annotations:
    ad.khulnasoft.com/argocd-application-controller.checks: |
      {
        "argocd": {
          "init_config": {},
          "instances": [
...
metadata:
  name: '<POD_NAME>'
  annotations:
    ad.khulnasoft.com/argocd-server.checks: |
      {
        "argocd": {
          "init_config": {},
          "instances": [
...
metadata:
  name: '<POD_NAME>'
  annotations:
    ad.khulnasoft.com/argocd-repo-server.checks: |
      {
        "argocd": {
          "init_config": {},
          "instances": [
...
[4]: https://docs.khulnasoft.com/containers/kubernetes/integrations/?tab=kubernetesadv2
...
[7]: https://github.com/KhulnaSoft/integrations-core/blob/master/argocd/metadata.csv
[8]: https://github.com/KhulnaSoft/integrations-core/blob/master/argocd/assets/service_checks.json
[9]: https://docs.khulnasoft.com/help/
[10]: https://argo-cd.readthedocs.io/en/stable/operator-manual/installation/
[11]: https://docs.khulnasoft.com/integrations/openmetrics/
[12]: https://github.com/KhulnaSoft/integrations-core/blob/master/argocd/khulnasoft_checks/argocd/data/conf.yaml.example
[13]: https://github.com/KhulnaSoft/integrations-core/blob/7.45.x/argocd/khulnasoft_checks/argocd/data/conf.yaml.example#L164-L166
