...
## 1.13.1 / 2023-07-13 / Agent 7.47.0
...
* Add `pyproject.toml` file ([#11316](https://github.com/KhulnaSoft/integrations-core/pull/11316))
...
* Support new implementation of Windows performance counters on Python 3 ([#10863](https://github.com/KhulnaSoft/integrations-core/pull/10863))
...
* Fix config spec options ([#10634](https://github.com/KhulnaSoft/integrations-core/pull/10634))

## 1.8.0 / 2021-11-13

***Added***:

* Add runtime configuration validation ([#8886](https://github.com/KhulnaSoft/integrations-core/pull/8886))
...
* Update to Agent 6 signature ([#5939](https://github.com/KhulnaSoft/integrations-core/pull/5939))
...
* Adhere to code style ([#3486](https://github.com/KhulnaSoft/integrations-core/pull/3486))

## 1.1.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2986](https://github.com/KhulnaSoft/integrations-core/pull/2986))
...
* moves aspdotnet and dotnet clr metrics to their own checks ([#884](https://github.com/KhulnaSoft/integrations-core/pull/884))
