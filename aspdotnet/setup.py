...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'aspdotnet', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-aspdotnet',
    version=ABOUT["__version__"],
    description='The ASP .NET check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent aspdotnet check',
    ...
    packages=['khulnasoft_checks.aspdotnet'],
