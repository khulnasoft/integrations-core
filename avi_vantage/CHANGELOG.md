...
* Remove metric limit for Avi Vantage ([#14167](https://github.com/KhulnaSoft/integrations-core/pull/14167))
...
* Add `pyproject.toml` file ([#11317](https://github.com/KhulnaSoft/integrations-core/pull/11317))
...
* Add disable_generic tag ([#10164](https://github.com/KhulnaSoft/integrations-core/pull/10164))
...
* Bump base package requirement ([#9960](https://github.com/KhulnaSoft/integrations-core/pull/9960))

## 1.0.0 / 2021-08-06

***Added***:

* Add Avi Vantage integration ([#9481](https://github.com/KhulnaSoft/integrations-core/pull/9481))
