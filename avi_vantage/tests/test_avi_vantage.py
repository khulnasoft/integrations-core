...
from khulnasoft_checks.avi_vantage import AviVantageCheck
...
def test_integration(
    dd_environment, get_expected_metrics, aggregator, integration_instance, dd_run_check, khulnasoft_agent
):
