...
* Add `pyproject.toml` file ([#11318](https://github.com/KhulnaSoft/integrations-core/pull/11318))
...
* Add runtime configuration validation ([#8887](https://github.com/KhulnaSoft/integrations-core/pull/8887))
...
* Convert network and disk total metrics to counts ([#8345](https://github.com/KhulnaSoft/integrations-core/pull/8345))
...
* Add logs support ([#7877](https://github.com/KhulnaSoft/integrations-core/pull/7877))

## 1.0.0 / 2020-10-23

***Added***:

* Add Azure IoT Edge integration ([#7465](https://github.com/KhulnaSoft/integrations-core/pull/7465))
