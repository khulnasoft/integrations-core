...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'azure_iot_edge', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-azure_iot_edge',
    version=ABOUT['__version__'],
    description='The Azure IoT Edge check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent azure_iot_edge check',
    ...
    packages=['khulnasoft_checks.azure_iot_edge'],
