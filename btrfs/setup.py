...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "btrfs", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-btrfs',
    version=ABOUT["__version__"],
    description='The Btrfs check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent btrfs check',
    ...
    packages=['khulnasoft_checks.btrfs'],
