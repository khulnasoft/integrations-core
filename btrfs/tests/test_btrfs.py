...
# project
import khulnasoft_checks.btrfs

btrfs_check = khulnasoft_checks.btrfs.BTRFS('btrfs', {}, [{}])
...
@mock.patch('khulnasoft_checks.btrfs.btrfs.psutil.disk_partitions', return_value=get_mock_devices())
@mock.patch('khulnasoft_checks.btrfs.btrfs.BTRFS.get_usage', return_value=mock_get_usage())
...
@mock.patch('khulnasoft_checks.btrfs.btrfs.psutil.disk_partitions', return_value=get_mock_devices())
@mock.patch('khulnasoft_checks.btrfs.btrfs.fcntl.ioctl')
def test_get_usage(mock_ioctl, mock_device_list):
    khulnasoft_checks.btrfs.btrfs.TWO_LONGS_STRUCT = MockStruct([(0, 4), (0, 4)], 2)
    khulnasoft_checks.btrfs.btrfs.THREE_LONGS_STRUCT = MockStruct(mock_get_usage(), 2)
