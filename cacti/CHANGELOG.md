...
* Add `pyproject.toml` file ([#11320](https://github.com/KhulnaSoft/integrations-core/pull/11320))
...
* Add missing config option to spec and update examples to match implementation ([#10641](https://github.com/KhulnaSoft/integrations-core/pull/10641))

## 1.9.0 / 2021-11-13

***Added***:

* Add runtime configuration validation ([#8889](https://github.com/KhulnaSoft/integrations-core/pull/8889))

## 1.8.3 / 2021-07-15 / Agent 7.30.0

***Fixed***:

* Fix example config ([#9705](https://github.com/KhulnaSoft/integrations-core/pull/9705))
...
* Add log support ([#7699](https://github.com/KhulnaSoft/integrations-core/pull/7699))
...
* Add config spec ([#6551](https://github.com/KhulnaSoft/integrations-core/pull/6551))
...
* Standardize logging format ([#4901](https://github.com/KhulnaSoft/integrations-core/pull/4901))

## 1.5.0 / 2019-10-11 / Agent 6.15.0

***Added***:

* Allow custom port for mysql access ([#4654](https://github.com/KhulnaSoft/integrations-core/pull/4654))

## 1.4.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Adhere to code style ([#3325](https://github.com/KhulnaSoft/integrations-core/pull/3325))

## 1.3.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Finish Python 3 Support ([#2901](https://github.com/KhulnaSoft/integrations-core/pull/2901))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2622
[2]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[3]: https://github.com/KhulnaSoft/integrations-core/pull/1768
