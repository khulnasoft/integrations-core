...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'cacti', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cacti',
    version=ABOUT['__version__'],
    description='The Cacti check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent cacti check',
    ...
    packages=['khulnasoft_checks.cacti'],
