...
def _setup_mocks():
    ...
    mocks = [
        mock.patch('khulnasoft_checks.cacti.cacti.rrdtool'),
        mock.patch('khulnasoft_checks.cacti.cacti.pymysql.connect', return_value=mock_conn),
        mock.patch('khulnasoft_checks.cacti.CactiCheck._get_rrd_info', return_value=MOCK_INFO),
        mock.patch('khulnasoft_checks.cacti.CactiCheck._get_rrd_fetch', return_value=MOCK_FETCH),
    ]
