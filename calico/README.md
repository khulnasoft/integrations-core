...
3. To use Autodiscovery, modify `prometheus-pod`. Add the following snippet to your Prometheus YAML configuration file:
   ...
   metadata:
     [...]
     annotations:
      ad.khulnasoft.com/prometheus-pod.check_names: |
      ["openmetrics"]
      ad.khulnasoft.com/prometheus-pod.init_configs: |
      [{}]
      ad.khulnasoft.com/prometheus-pod.instances: |
        [
           {
...
[3]: https://github.com/KhulnaSoft/integrations-core/blob/master/calico/khulnasoft_checks/calico/data/conf.yaml.example
...
[6]: https://github.com/KhulnaSoft/integrations-core/blob/master/calico/metadata.csv
[7]: https://github.com/KhulnaSoft/integrations-core/blob/master/calico/assets/service_checks.json
[8]: https://docs.khulnasoft.com/help/
[9]: https://docs.tigera.io/calico/3.25/operations/monitor/monitor-component-metrics
[10]: https://docs.khulnasoft.com/developers/integrations/python/
[11]: https://app.khulnasoft.com/account/settings/agent/latest
