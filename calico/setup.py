...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'calico', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-calico',
    version=ABOUT['__version__'],
    description='The calico check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent calico check',
    ...
    packages=['khulnasoft_checks.calico'],
