...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'cassandra', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cassandra',
    version=ABOUT['__version__'],
    description='The Cassandra check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent cassandra check',
    ...
    packages=['khulnasoft_checks.cassandra'],
