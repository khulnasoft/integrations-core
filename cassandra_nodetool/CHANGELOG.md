...
* Add `pyproject.toml` file ([#11322](https://github.com/KhulnaSoft/integrations-core/pull/11322))
...
* Add runtime configuration validation ([#8891](https://github.com/KhulnaSoft/integrations-core/pull/8891))
...
* Add config specs ([#7318](https://github.com/KhulnaSoft/integrations-core/pull/7318))
...
* Use agent 6 signature ([#6442](https://github.com/KhulnaSoft/integrations-core/pull/6442))
...
* Remove shlex ([#5068](https://github.com/KhulnaSoft/integrations-core/pull/5068))

## 1.5.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3487](https://github.com/KhulnaSoft/integrations-core/pull/3487))

***Fixed***:

* Check error code of nodetool command ([#3632](https://github.com/KhulnaSoft/integrations-core/pull/3632))

## 1.4.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Support old nodetool output format ([#3253](https://github.com/KhulnaSoft/integrations-core/pull/3253)) Thanks [hitsumabushi](https://github.com/hitsumabushi).

## 1.3.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Finish Python3 Support ([#2905](https://github.com/KhulnaSoft/integrations-core/pull/2905))

## 1.2.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2761](https://github.com/KhulnaSoft/integrations-core/pull/2761))

## 1.1.0 / 2018-11-21 / Agent 6.8.0

***Added***:

* Add --ssl option to cassandra_nodetool check ([#2378](https://github.com/KhulnaSoft/integrations-core/pull/2378)) Thanks [laurieodgers](https://github.com/laurieodgers).

## 1.0.0 / 2018-10-13 / Agent 6.6.0

***Added***:

* Add cassandra_nodetool check ([#511](https://github.com/KhulnaSoft/integrations-core/pull/511))
...
* Convert port to a string before calling get_subprocess_output ([#1549](https://github.com/KhulnaSoft/integrations-core/pull/1549)) Thanks [jalaziz](https://github.com/jalaziz).
...
* add `cassandra_nodetool` integration ([#511](https://github.com/KhulnaSoft/integrations-core/issues/511) and [#704](https://github.com/KhulnaSoft/integrations-core/issues/704)
