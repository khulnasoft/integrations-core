...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'cassandra_nodetool', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cassandra_nodetool',
    version=ABOUT['__version__'],
    description='The Cassandra Nodetool check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent cassandra_nodetool check',
    ...
    packages=['khulnasoft_checks.cassandra_nodetool'],
