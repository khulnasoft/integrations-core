...
from khulnasoft_checks.cassandra_nodetool import CassandraNodetoolCheck
...
@patch('khulnasoft_checks.cassandra_nodetool.cassandra_nodetool.get_subprocess_output', side_effect=mock_output)
def test_check(mock_output, aggregator):
    _check(mock_output, aggregator)


@patch('khulnasoft_checks.cassandra_nodetool.cassandra_nodetool.get_subprocess_output', side_effect=mock_output_old_format)
