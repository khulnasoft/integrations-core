...
* Add OSD metadata tags ([#14201](https://github.com/KhulnaSoft/integrations-core/pull/14201)) Thanks [mxmeinhold](https://github.com/mxmeinhold).
...
* Add `pyproject.toml` file ([#11323](https://github.com/KhulnaSoft/integrations-core/pull/11323))
...
* Add runtime configuration validation ([#8892](https://github.com/KhulnaSoft/integrations-core/pull/8892))

## 2.4.1 / 2021-07-12 / Agent 7.30.0

***Fixed***:

* ceph agent 8 signature ([#9520](https://github.com/KhulnaSoft/integrations-core/pull/9520))

## 2.4.0 / 2021-04-19 / Agent 7.28.0

***Added***:

* Add Ceph Recovery metrics ([#8261](https://github.com/KhulnaSoft/integrations-core/pull/8261)) Thanks [mxmeinhold](https://github.com/mxmeinhold).
...
* Fail more gracefully ([#8456](https://github.com/KhulnaSoft/integrations-core/pull/8456))

## 2.3.0 / 2020-11-25 / Agent 7.25.0

***Added***:

* Support octopus version ([#8077](https://github.com/KhulnaSoft/integrations-core/pull/8077))
...
* Add ceph config spec ([#6563](https://github.com/KhulnaSoft/integrations-core/pull/6563))

***Fixed***:

* Capture type errors as well as key errors for osd perf metrics ([#6381](https://github.com/KhulnaSoft/integrations-core/pull/6381))

## 2.0.0 / 2020-04-04 / Agent 7.19.0

***Changed***:

* Account for "osdstats" key in newer versions ([#5855](https://github.com/KhulnaSoft/integrations-core/pull/5855))

***Fixed***:

* Fix response handling ([#6152](https://github.com/KhulnaSoft/integrations-core/pull/6152))
...
* Adhere to logging call convention ([#4738](https://github.com/KhulnaSoft/integrations-core/pull/4738))

## 1.7.0 / 2019-08-24 / Agent 6.14.0

***Added***:

* Remove unused version command ([#4249](https://github.com/KhulnaSoft/integrations-core/pull/4249))

## 1.6.0 / 2019-07-09 / Agent 6.13.0

***Added***:

* Add log setup and configuration ([#3960](https://github.com/KhulnaSoft/integrations-core/pull/3960))
...
* Adhere to code style ([#3488](https://github.com/KhulnaSoft/integrations-core/pull/3488))

## 1.4.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2837](https://github.com/KhulnaSoft/integrations-core/pull/2837))
...
* Update the check to make it work with ceph luminous ([#926](https://github.com/KhulnaSoft/integrations-core/issues/926)
* Allow sending specific service checks using to the more detailed luminous health checks ([#926](https://github.com/KhulnaSoft/integrations-core/issues/926)
* Add metric for number of active monitors ([#956](https://github.com/KhulnaSoft/integrations-core/pull/956)

## 1.1.0 / 2017-07-18

***Added***:

* Add option to define the cluster name ([#438](https://github.com/KhulnaSoft/integrations-core/issues/438), thanks [@borisroman](https://github)com/borisroman)
