...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "ceph", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ceph',
    version=ABOUT["__version__"],
    description='The Ceph check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ceph check',
    ...
    packages=['khulnasoft_checks.ceph'],
