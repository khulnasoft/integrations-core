...
from khulnasoft_checks.ceph import Ceph
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("raw.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("warn.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("ceph_luminous_warn.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("ceph_luminous_ok.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("raw2.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("ceph_10.2.2.json"))
...
@mock.patch("khulnasoft_checks.ceph.Ceph._collect_raw", return_value=mock_data("ceph_10.2.2_mon_health.json"))
