...
* Add more FQDN and L7 metrics ([#16164](https://github.com/KhulnaSoft/integrations-core/pull/16164))

## 3.1.0 / 2023-10-26

***Added***:

* Add missing Azure metrics ([#16073](https://github.com/KhulnaSoft/integrations-core/pull/16073))
...
* Add more kvstore metrics ([#15483](https://github.com/KhulnaSoft/integrations-core/pull/15483)) Thanks [antonipp](https://github.com/antonipp).
* Add missing cilium metrics ([#15284](https://github.com/KhulnaSoft/integrations-core/pull/15284))
...
* Add `pyproject.toml` file ([#11324](https://github.com/KhulnaSoft/integrations-core/pull/11324))
* Add new operator metrics ([#11193](https://github.com/KhulnaSoft/integrations-core/pull/11193))
...
* Support the new OpenMetrics V2 implementation ([#10840](https://github.com/KhulnaSoft/integrations-core/pull/10840))
...
* Add runtime configuration validation ([#8893](https://github.com/KhulnaSoft/integrations-core/pull/8893))
...
* Re-revert cilium AD change ([#9901](https://github.com/KhulnaSoft/integrations-core/pull/9901))

## 1.7.1 / 2021-07-13 / Agent 7.30.0

***Fixed***:

* Revert cilium AD change ([#9683](https://github.com/KhulnaSoft/integrations-core/pull/9683))

## 1.7.0 / 2021-07-12

***Added***:

* Update container identifier ([#9512](https://github.com/KhulnaSoft/integrations-core/pull/9512))

***Fixed***:

* Use cilium-agent and cilium as autodiscover identifiers ([#9518](https://github.com/KhulnaSoft/integrations-core/pull/9518))
...
* Fix openmetrics integrations config specs ([#8000](https://github.com/KhulnaSoft/integrations-core/pull/8000))
...
* Add config specs ([#7319](https://github.com/KhulnaSoft/integrations-core/pull/7319))
...
* Add Cilium version metadata ([#5408](https://github.com/KhulnaSoft/integrations-core/pull/5408))
...
* Remove unused variables ([#5173](https://github.com/KhulnaSoft/integrations-core/pull/5173))

## 1.0.1 / 2019-12-06 / Agent 7.16.1

***Fixed***:

* Raise configuration errors ([#5163](https://github.com/KhulnaSoft/integrations-core/pull/5163))

## 1.0.0 / 2019-11-19

***Added***:

* New Integration: Cilium ([#4665](https://github.com/KhulnaSoft/integrations-core/pull/4665))
