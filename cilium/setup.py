...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'cilium', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cilium',
    version=ABOUT['__version__'],
    description='The Cilium check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent cilium check',
    ...
    packages=['khulnasoft_checks.cilium'],
