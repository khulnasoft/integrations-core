...
* Add `pyproject.toml` file ([#11325](https://github.com/KhulnaSoft/integrations-core/pull/11325))
...
* Fix required config option ([#10629](https://github.com/KhulnaSoft/integrations-core/pull/10629))

## 1.17.0 / 2021-11-13

***Added***:

* Add runtime configuration validation ([#8894](https://github.com/KhulnaSoft/integrations-core/pull/8894))

***Fixed***:

* Harmonize check and config options ([#10488](https://github.com/KhulnaSoft/integrations-core/pull/10488))
...
* Add config spec ([#6314](https://github.com/KhulnaSoft/integrations-core/pull/6314))
...
* Update request wrapper with password and A6 signature ([#5684](https://github.com/KhulnaSoft/integrations-core/pull/5684))

## 1.8.2 / 2019-12-27 / Agent 7.17.0

***Fixed***:

* Ensure only one session object per url ([#5334](https://github.com/KhulnaSoft/integrations-core/pull/5334))

## 1.8.1 / 2019-12-02 / Agent 7.16.0

***Fixed***:

* Use RequestsWrapper ([#5037](https://github.com/KhulnaSoft/integrations-core/pull/5037))
...
* Standardize logging format ([#4902](https://github.com/KhulnaSoft/integrations-core/pull/4902))

***Fixed***:

* Refresh auth token when it expires ([#5039](https://github.com/KhulnaSoft/integrations-core/pull/5039))
...
* Fix event submission call ([#4044](https://github.com/KhulnaSoft/integrations-core/pull/4044))
...
* Improve API logs ([#3794](https://github.com/KhulnaSoft/integrations-core/pull/3794))
...
* Adhere to code style ([#3489](https://github.com/KhulnaSoft/integrations-core/pull/3489))

## 1.4.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#3029](https://github.com/KhulnaSoft/integrations-core/pull/3029))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2659
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2465
[3]: https://github.com/KhulnaSoft/integrations-core/pull/2267
[4]: https://github.com/KhulnaSoft/integrations-core/pull/1986
[5]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[6]: https://github.com/KhulnaSoft/integrations-core/pull/1785
