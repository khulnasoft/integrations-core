...
Verify that the output you get from cURLing the endpoint matches any of the metrics collected in `khulnasoft_checks/cisco_aci/aci_metrics.py`. If none of the statistics match, this means that the endpoint is not emitting any statistics that the integration can collect.
...
[3]: https://github.com/KhulnaSoft/integrations-core/blob/master/cisco_aci/khulnasoft_checks/cisco_aci/data/conf.yaml.example
...
[7]: https://github.com/KhulnaSoft/integrations-core/blob/master/cisco_aci/metadata.csv
[8]: https://github.com/KhulnaSoft/integrations-core/blob/master/cisco_aci/assets/service_checks.json
