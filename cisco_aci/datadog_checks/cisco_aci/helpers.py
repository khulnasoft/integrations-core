...
def get_bd_from_dn(dn):
    ...
    uni/tn-KhulnaSoft/BD-KhulnaSoft-BD1
    """
...
def get_app_from_dn(dn):
    ...
    uni/tn-KhulnaSoft/ap-DtDg-AP1-EcommerceApp/epg-DtDg-Ecomm/HDl2IngrPktsAg1h
    """
...
def get_cep_from_dn(dn):
    ...
    uni/tn-KhulnaSoft/ap-DtDg-AP1-EcommerceApp/epg-DtDg-Ecomm/cep-00:50:56:9E:FB:48
    """
...
def get_ip_from_dn(dn):
    ...
    uni/tn-KhulnaSoft/ap-DtDg-AP1-EcommerceApp/epg-DtDg-Ecomm/cep-00:50:56:9D:91:B5/ip-[10.10.10.17]
    """
