...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "cisco_aci", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cisco_aci',
    version=ABOUT["__version__"],
    description='The Cisco ACI check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent Cisco ACI check',
    ...
    packages=['khulnasoft_checks.cisco_aci'],
