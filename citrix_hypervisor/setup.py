...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'citrix_hypervisor', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-citrix_hypervisor',
    version=ABOUT['__version__'],
    description='The citrix_hypervisor check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent citrix_hypervisor check',
    ...
    packages=['khulnasoft_checks.citrix_hypervisor'],
