...
* Make service check tests unitary. Add metadata entrypoint ([#13753](https://github.com/KhulnaSoft/integrations-core/pull/13753))
...
* Add active parts metric and support clickhouse 22 ([#12104](https://github.com/KhulnaSoft/integrations-core/pull/12104)) Thanks [spanneberg](https://github.com/spanneberg).
...
* Add `pyproject.toml` file ([#11327](https://github.com/KhulnaSoft/integrations-core/pull/11327))
...
* Add runtime configuration validation ([#8895](https://github.com/KhulnaSoft/integrations-core/pull/8895))

## 2.4.1 / 2021-10-12 / Agent 7.32.0

***Fixed***:

* Bump base package requirements ([#10390](https://github.com/KhulnaSoft/integrations-core/pull/10390))
...
* Add support for Clickhouse v21 ([#9235](https://github.com/KhulnaSoft/integrations-core/pull/9235))
...
* Support Clickhouse metrics v20 ([#8779](https://github.com/KhulnaSoft/integrations-core/pull/8779))
...
* Remove `calculate_text_stack_trace` setting to allow the use of read-only accounts ([#6637](https://github.com/KhulnaSoft/integrations-core/pull/6637)) Thanks [TheMcGoose](https://github.com/TheMcGoose).
...
* Add config specs to clickhouse ([#7433](https://github.com/KhulnaSoft/integrations-core/pull/7433))
...
* Update `can_connect` service check status on each check run ([#7006](https://github.com/KhulnaSoft/integrations-core/pull/7006)) Thanks [isaachui](https://github.com/isaachui).

## 1.3.1 / 2020-06-19 / Agent 7.21.0

***Fixed***:

* Submit `can_connect` service check on each check run ([#6926](https://github.com/KhulnaSoft/integrations-core/pull/6926))
...
* Add new metrics: `cache_dictionary.update_queue.batches`, `cache_dictionary.update_queue.keys`  ([#5976](https://github.com/KhulnaSoft/integrations-core/pull/5976))
...
* Add newly-documented metrics ([#5795](https://github.com/KhulnaSoft/integrations-core/pull/5795))
* Add new metric for tracking MySQL connections ([#5700](https://github.com/KhulnaSoft/integrations-core/pull/5700))

## 1.0.1 / 2020-01-24 / Agent 7.17.0

***Fixed***:

* Fix config ([#5551](https://github.com/KhulnaSoft/integrations-core/pull/5551))
