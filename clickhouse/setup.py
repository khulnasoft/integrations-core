...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'clickhouse', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='khulnasoft agent clickhouse check',
    ...
    packages=['khulnasoft_checks.clickhouse'],
