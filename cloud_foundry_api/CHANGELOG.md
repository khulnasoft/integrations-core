...
* Add `pyproject.toml` file ([#11328](https://github.com/KhulnaSoft/integrations-core/pull/11328))
...
* Add runtime configuration validation ([#8896](https://github.com/KhulnaSoft/integrations-core/pull/8896))
...
* Add integration for Cloud Foundry API ([#6832](https://github.com/KhulnaSoft/integrations-core/pull/6832))

## 0.2.0 / 2020-08-10 / Agent 7.22.0

***Added***:

* Add space and org names as tags to events ([#7297](https://github.com/KhulnaSoft/integrations-core/pull/7297))

***Fixed***:

* Stop sending events multiple times ([#7293](https://github.com/KhulnaSoft/integrations-core/pull/7293))
