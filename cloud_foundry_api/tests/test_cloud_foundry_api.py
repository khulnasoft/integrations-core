...
from khulnasoft_checks.base.errors import CheckException, ConfigurationError
from khulnasoft_checks.cloud_foundry_api import CloudFoundryApiCheck
...
@mock.patch("khulnasoft_checks.cloud_foundry_api.cloud_foundry_api.time.time", return_value=FREEZE_TIME)
@mock.patch.object(CloudFoundryApiCheck, "discover_api", return_value=("v3", "uaa_url"))
...
@mock.patch.object(CloudFoundryApiCheck, "get_orgs", return_value={"org_guid": "org_name"})
@mock.patch.object(CloudFoundryApiCheck, "get_spaces", return_value={"space_guid": "space_name"})
@mock.patch("khulnasoft_checks.cloud_foundry_api.cloud_foundry_api.get_next_url", side_effect=["next", ""])
@mock.patch.object(CloudFoundryApiCheck, "http")
