...
* Add autodiscover hosts feature to Cloudera integration ([#13738](https://github.com/KhulnaSoft/integrations-core/pull/13738))

## 1.0.1 / 2023-01-27 / Agent 7.43.0

***Fixed***:

* Make debug logging less verbose ([#13814](https://github.com/KhulnaSoft/integrations-core/pull/13814))
