...
* Add new metrics from CockroachDB 23 ([#14492](https://github.com/KhulnaSoft/integrations-core/pull/14492))
* Add new metrics to CockroachDB integration ([#14484](https://github.com/KhulnaSoft/integrations-core/pull/14484))
...
* Collect schedules_BACKUP_last_completed_time metric ([#13825](https://github.com/KhulnaSoft/integrations-core/pull/13825))

## 2.5.0 / 2022-12-09 / Agent 7.42.0

***Added***:

* Collect additional metrics ([#13339](https://github.com/KhulnaSoft/integrations-core/pull/13339))

## 2.4.1 / 2022-10-28 / Agent 7.41.0

***Fixed***:

* Remove metrics limit from legacy version of the integration ([#13038](https://github.com/KhulnaSoft/integrations-core/pull/13038))
...
* Document Openmetrics V2 version of backup metrics ([#12730](https://github.com/KhulnaSoft/integrations-core/pull/12730))

## 2.3.0 / 2022-08-05 / Agent 7.39.0

***Added***:

* [CockroachDB] Add additional metrics for CockroachDB integration ([#12382](https://github.com/KhulnaSoft/integrations-core/pull/12382)) Thanks [tomellis91](https://github.com/tomellis91).
...
* Add `pyproject.toml` file ([#11329](https://github.com/KhulnaSoft/integrations-core/pull/11329))
...
* Allow the use of the new OpenMetrics implementation ([#11026](https://github.com/KhulnaSoft/integrations-core/pull/11026))

***Fixed***:

* Bump base package ([#11070](https://github.com/KhulnaSoft/integrations-core/pull/11070))
...
* Add runtime configuration validation ([#8897](https://github.com/KhulnaSoft/integrations-core/pull/8897))
...
* Add config specs ([#7439](https://github.com/KhulnaSoft/integrations-core/pull/7439))
...
* Collect metadata for CockroachDB ([#5924](https://github.com/KhulnaSoft/integrations-core/pull/5924))
...
* Adhere to code style ([#3490](https://github.com/KhulnaSoft/integrations-core/pull/3490))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2150
