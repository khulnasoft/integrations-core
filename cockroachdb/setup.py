...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'cockroachdb', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-cockroachdb',
    version=ABOUT['__version__'],
    description='The CockroachDB check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent cockroachdb check',
    ...
    packages=['khulnasoft_checks.cockroachdb'],
