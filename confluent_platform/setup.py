...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'confluent_platform', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-confluent_platform',
    version=ABOUT['__version__'],
    description='The Confluent Platform check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent confluent_platform check',
    ...
    packages=['khulnasoft_checks.confluent_platform'],
