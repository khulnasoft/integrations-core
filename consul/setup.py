...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "consul", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-consul',
    version=ABOUT['__version__'],
    description='The Consul Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent consul check',
    ...
    packages=['khulnasoft_checks.consul'],
