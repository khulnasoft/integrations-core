...
from khulnasoft_checks.consul import ConsulCheck
from khulnasoft_checks.consul.common import MAX_SERVICES
...
def test_consul_request(aggregator, instance, mocker):
    consul_check = ConsulCheck(common.CHECK_NAME, {}, [consul_mocks.MOCK_CONFIG])
    mocker.patch("khulnasoft_checks.base.utils.serialization.json.loads")
    with mock.patch("khulnasoft_checks.consul.consul.requests.get") as mock_requests_get:
