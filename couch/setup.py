...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "couch", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-couch',
    version=ABOUT["__version__"],
    description='The CouchDB check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent couch check',
    ...
    packages=['khulnasoft_checks.couch'],
