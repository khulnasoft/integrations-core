...
from khulnasoft_checks.couch import CouchDb, errors

from . import common


@pytest.mark.usefixtures("dd_environment")
def test_collect_metadata_instance(aggregator, khulnasoft_agent, instance):
    ...
    khulnasoft_agent.assert_metadata(common.CHECK_ID, version_metadata)
