...
* [Couchbase] Adds cmd_lookup per bucket and cleans metadata ([#15299](https://github.com/KhulnaSoft/integrations-core/pull/15299))
...
* Add `pyproject.toml` file ([#11334](https://github.com/KhulnaSoft/integrations-core/pull/11334))
...
* Add support for Index Statistics metrics ([#10784](https://github.com/KhulnaSoft/integrations-core/pull/10784))
...
* Add runtime configuration validation ([#8902](https://github.com/KhulnaSoft/integrations-core/pull/8902))
...
* Add support for Sync Gateway metrics ([#8691](https://github.com/KhulnaSoft/integrations-core/pull/8691))
* Refactor and use new Agent signature ([#8712](https://github.com/KhulnaSoft/integrations-core/pull/8712))
...
* Fix error log message ([#8271](https://github.com/KhulnaSoft/integrations-core/pull/8271))
...
* Add config specs ([#7466](https://github.com/KhulnaSoft/integrations-core/pull/7466))
...
* Update `conf.yaml.example` log collection section ([#5977](https://github.com/KhulnaSoft/integrations-core/pull/5977))

## 1.12.1 / 2019-12-06 / Agent 7.16.0

***Fixed***:

* Fix version metadata parsing ([#5148](https://github.com/KhulnaSoft/integrations-core/pull/5148))

## 1.12.0 / 2019-12-02

***Added***:

* add version metadata ([#4985](https://github.com/KhulnaSoft/integrations-core/pull/4985))
* Standardize logging format ([#4905](https://github.com/KhulnaSoft/integrations-core/pull/4905))
...
* Fix typo for couchbase.by_node.cluster_membership service check ([#4565](https://github.com/KhulnaSoft/integrations-core/pull/4565))

## 1.10.0 / 2019-09-16

***Added***:

* Add log documentation in the example configuration file ([#4537](https://github.com/KhulnaSoft/integrations-core/pull/4537))
...
* Add RequestsWrapper to couchbase ([#4119](https://github.com/KhulnaSoft/integrations-core/pull/4119))

## 1.8.1 / 2019-07-12 / Agent 6.13.0

***Fixed***:

* Change `couchbase.by_bucket.avg_bg_wait_time` metric unit from second to microsecond ([#4078](https://github.com/KhulnaSoft/integrations-core/pull/4078))

## 1.8.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3494](https://github.com/KhulnaSoft/integrations-core/pull/3494))

## 1.7.1 / 2019-03-29 / Agent 6.11.0

***Fixed***:

* Fixed a typo in the example config file ([#3173](https://github.com/KhulnaSoft/integrations-core/pull/3173))

## 1.7.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2851](https://github.com/KhulnaSoft/integrations-core/pull/2851))

***Fixed***:

* Stop using deprecated 'device_name' parameter. ([#2847](https://github.com/KhulnaSoft/integrations-core/pull/2847))

## 1.6.1 / 2018-11-23 / Agent 6.8.0

***Fixed***:

* Keep running the check when one endpoint fails ([#2638](https://github.com/KhulnaSoft/integrations-core/pull/2638))

## 1.6.0 / 2018-11-14

***Added***:

* Add ssl_verify option ([#2584](https://github.com/KhulnaSoft/integrations-core/pull/2584))
...
* Add Couchbase health and cluster membership service checks and alerts ([#1593](https://github.com/KhulnaSoft/integrations-core/pull/1593))
...
* Couchbase integration was not working during server set up ([#1571](https://github.com/KhulnaSoft/integrations-core/pull/1571))

## 1.3.0 / 2018-05-11

***Added***:

* Hardcode the 8091 port in the Autodiscovery template ([#1444](https://github.com/KhulnaSoft/integrations-core/pull/1444) for more information)
...
* Fix the conversion of request_time* metrics ([#705](https://github.com/KhulnaSoft/integrations-core/issues/705)

## 1.1.0 / 2017-07-18

***Added***:

* Add new metrics for query monitoring ([#405](https://github.com/KhulnaSoft/integrations-core/issues/405))
