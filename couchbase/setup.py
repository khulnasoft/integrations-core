...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "couchbase", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-couchbase',
    version=ABOUT['__version__'],
    description='The Couchbase check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent couchbase check',
    ...
    packages=['khulnasoft_checks.couchbase'],
