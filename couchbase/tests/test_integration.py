...
from khulnasoft_checks.couchbase import Couchbase
from khulnasoft_checks.couchbase.couchbase_consts import (
...
def test_metadata(instance_query, dd_run_check, khulnasoft_agent):
