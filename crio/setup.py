...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'crio', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-crio',
    version=ABOUT['__version__'],
    description='The Crio check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent crio check container runtime kubernetes',
    ...
    packages=['khulnasoft_checks.crio'],
