...
You can also define or modify environment variables with the cluster-scoped init script path using the UI, Databricks CLI, or invoking the Clusters API:
  ...
  - Set `DD_SITE` to your site: {{< region-param key="dd_site" code="true" >}}. Defaults to `khulnasoft.com`
{{% /site-region %}}
partial -->
...
If you stored your `khulnasoft_init_script.sh` directly in the `Shared` workspace, you can access the file at the following path: `/Shared/khulnasoft_init_script.sh`.

If you stored your `khulnasoft_init_script.sh` directly in a user workspace, you can access the file at the following path: `/Users/$EMAIL_ADDRESS/khulnasoft_init_script.sh`.
...
[2]: https://docs.khulnasoft.com/integrations/spark/?tab=host
[3]: https://app.khulnasoft.com/integrations/spark
...
[8]: https://docs.khulnasoft.com/integrations/spark/#metrics
