...
* Add full support for cheap profiling metrics ([#15602](https://github.com/KhulnaSoft/integrations-core/pull/15602))
...
* Add the DCGM Exporter integration ([#14589](https://github.com/KhulnaSoft/integrations-core/pull/14589))
