...
@click.option('--api-url', default="api.khulnasoft.com", help='The API URL to use, e.g. "api.khulnasoft.com"')
...
def generate_metrics(app: Application, integration: str, api_url: str, api_key: str):
    ...
    from khulnasoft_api_client.v2.api.metrics_api import MetricsApi
    from khulnasoft_api_client.v2.model.metric_intake_type import MetricIntakeType
    from khulnasoft_api_client.v2.model.metric_payload import MetricPayload
    from khulnasoft_api_client.v2.model.metric_point import MetricPoint
    from khulnasoft_api_client.v2.model.metric_resource import MetricResource
    from khulnasoft_api_client.v2.model.metric_series import MetricSeries
    from khulnasoft_checks.dev.utils import get_hostname
