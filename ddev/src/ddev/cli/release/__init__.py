...
import click
from khulnasoft_checks.dev.tooling.commands.release.build import build
from khulnasoft_checks.dev.tooling.commands.release.make import make
from khulnasoft_checks.dev.tooling.commands.release.tag import tag
from khulnasoft_checks.dev.tooling.commands.release.trello import trello
from khulnasoft_checks.dev.tooling.commands.release.upload import upload
