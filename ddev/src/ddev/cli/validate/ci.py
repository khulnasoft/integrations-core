...
def code_coverage_enabled(check_name, app):
    if check_name in ('khulnasoft_checks_base', 'khulnasoft_checks_dev', 'khulnasoft_checks_downloader', 'ddev'):
        return True
...
def ci(app: Application, sync: bool):
    ...
    test_workflow = (
        ...
        else 'KhulnaSoft/integrations-core/.github/workflows/test-target.yml@master'
    )
    ...
    for project, data in list(projects.items()):
        ...
        # https://github.com/KhulnaSoft/integrations-core/pull/6760#issuecomment-634976885
