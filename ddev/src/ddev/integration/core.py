...
class Integration:
    ...
    def package_directory(self) -> Path:
        if self.name == 'ddev':
            ...
            if self.name == 'khulnasoft_checks_base':
                directory = 'base'
            elif self.name == 'khulnasoft_checks_dev':
                directory = 'dev'
            elif self.name == 'khulnasoft_checks_downloader':
                directory = 'downloader'
            else:
                directory = self.package_directory_name

            return self.path / 'khulnasoft_checks' / directory
    ...
    def is_agent_check(self) -> bool:
        package_root = self.path / 'khulnasoft_checks' / self.package_directory_name / '__init__.py'
    ...
    def is_jmx_check(self) -> bool:
        return (self.path / 'khulnasoft_checks' / self.package_directory_name / 'data' / 'metrics.yaml').is_file()
