...
def repo_with_history(tmp_path_factory):
    ...
    write_agent_requirements(repo.path, ['foo==1.5.0', 'bar==1.0.0', 'khulnasoft_checks_base==2.1.3'])
    commit('second')
    ...
    write_dummy_pyproject(repo.path, 'khulnasoft_checks_downloader')
    write_dummy_pyproject(repo.path, 'khulnasoft_checks_base')
