...
"""
        "* khulnasoft_checks_base [3.0.0]"
        "(https://github.com/KhulnaSoft/integrations-core/blob/master/khulnasoft_checks_base/CHANGELOG.md) "
        "**BREAKING CHANGE**"
    )
...
* khulnasoft_checks_base [2.1.3](https://github.com/KhulnaSoft/integrations-core/blob/master/khulnasoft_checks_base/CHANGELOG.md)
"""
    )
    return (
        repo_with_history,
