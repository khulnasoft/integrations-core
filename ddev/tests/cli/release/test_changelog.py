...
class TestFix:
    ...
    def test_no_pr(self, ddev, repository, helpers, network_replay, mocker):
        ...
        assert changelog.read_text() == helpers.dedent(
            ...
            * Add changelog enforcement ([#15476](https://github.com/KhulnaSoft/integrations-core/pull/15476))
...
def repo_with_towncrier(repository, helpers):
    (repository.path / 'towncrier.toml').write_text(
        helpers.dedent(
            ...
            issue_format = "([#{issue}](https://github.com/KhulnaSoft/integrations-core/pull/{issue}))"
...
class TestBuild:
    ...
    def build_changelog(self, repo_with_towncrier):
        ...
        from khulnasoft_checks.dev.tooling.commands.release.changelog import changelog
        from khulnasoft_checks.dev.tooling.constants import set_root
    ...
    def test_build(self, setup_changelog_build, helpers, build_changelog):
        ...
        assert changelog.read_text() == helpers.dedent(
            ...
            * Foo ([#1](https://github.com/KhulnaSoft/integrations-core/pull/1))
            * Foo

                  Bar ([#3](https://github.com/KhulnaSoft/integrations-core/pull/3))

            ***Fixed***:

            * Bar ([#2](https://github.com/KhulnaSoft/integrations-core/pull/2))
