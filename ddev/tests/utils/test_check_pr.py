...
diff --git a/snowflake/khulnasoft_checks/snowflake/queries.py b/snowflake/khulnasoft_checks/snowflake/queries.py
index 9e83ef8f4b0c..d7d3c5fb62ff 100644
--- a/snowflake/khulnasoft_checks/snowflake/queries.py
+++ b/snowflake/khulnasoft_checks/snowflake/queries.py
@@ -191,12 +191,15 @@
 PipeHistory = {
     'name': 'pipe.metrics',
     'query': (
