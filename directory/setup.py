...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "directory", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-directory',
    version=ABOUT["__version__"],
    description='The Directory check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent directory check',
    ...
    packages=['khulnasoft_checks.directory'],
