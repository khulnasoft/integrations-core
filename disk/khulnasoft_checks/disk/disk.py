...
from khulnasoft_checks.base import AgentCheck, ConfigurationError, is_affirmative
from khulnasoft_checks.base.utils.platform import Platform
from khulnasoft_checks.base.utils.subprocess_output import SubprocessOutputEmptyError, get_subprocess_output
from khulnasoft_checks.base.utils.timeout import TimeoutException, timeout

if platform.system() == 'Windows':
    import win32wnet

    # See: https://github.com/KhulnaSoft/integrations-core/pull/1109#discussion_r167133580
    IGNORE_CASE = re.I
    ...
    def collect_latency_metrics(self):
        for disk_name, disk in iteritems(psutil.disk_io_counters(perdisk=True)):
            ...
            try:
                ...
                # See: https://github.com/KhulnaSoft/integrations-core/pull/7323#issuecomment-756427024
