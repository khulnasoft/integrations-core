...
* Add `pyproject.toml` file ([#11339](https://github.com/KhulnaSoft/integrations-core/pull/11339))
...
* Add runtime configuration validation ([#8906](https://github.com/KhulnaSoft/integrations-core/pull/8906))

## 2.0.1 / 2021-07-12 / Agent 7.30.0

***Fixed***:

* Use agent 8 signature ([#9544](https://github.com/KhulnaSoft/integrations-core/pull/9544))
...
* Refactor and remove legacy hack for Agent 5's build system ([#6682](https://github.com/KhulnaSoft/integrations-core/pull/6682))
...
* Add config spec ([#6560](https://github.com/KhulnaSoft/integrations-core/pull/6560))

## 1.5.2 / 2020-04-24 / Agent 7.19.0

***Fixed***:

* Fix missing `time.clock` attribute in Python 3.8 ([#6478](https://github.com/KhulnaSoft/integrations-core/pull/6478))
...
* Make nameserver optional in the configuration ([#4283](https://github.com/KhulnaSoft/integrations-core/pull/4283))

## 1.4.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3501](https://github.com/KhulnaSoft/integrations-core/pull/3501))
...
* add ability to check A, CNAME and MX results ([#2615](https://github.com/KhulnaSoft/integrations-core/pull/2615)) Thanks [volksman](https://github.com/volksman).
...
* Fix parsing of requirements file so that `dnspython` is listed as a req ([#1603](https://github.com/KhulnaSoft/integrations-core/pull/1603))

## 1.1.0 / 2017-10-10

***Added***:

* Adds ability to specify a custom port for your nameserver ([#756](https://github.com/KhulnaSoft/integrations-core/issues/756)
...
* use time.clock under windows ([#330](https://github.com/KhulnaSoft/integrations-core/issues/330)
