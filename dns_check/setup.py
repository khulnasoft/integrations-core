...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "dns_check", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-dns_check',
    version=ABOUT['__version__'],
    description='The DNS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent dns_check check',
    ...
    packages=['khulnasoft_checks.dns_check'],
