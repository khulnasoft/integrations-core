...
from khulnasoft_checks.dev.tooling.catalog_const import DASHBOARD_NOT_POSSIBLE, PROCESS_SIGNATURE_EXCLUDE
...
def render_check_signatures_progress():
    exclude = {'khulnasoft_checks_base', 'khulnasoft_checks_dev', 'khulnasoft_checks_downloader'}
