...
parameter of the [ConfigSpec](#khulnasoft_checks.dev.tooling.configuration.ConfigSpec) class.
...
- `validators` - This refers to an array of pre-defined field validators to use. Every entry will refer to a relative import path to a
  field validator under `khulnasoft_checks.base.utils.models.validation` and will be executed in the defined order.
...
::: khulnasoft_checks.dev.tooling.configuration.ConfigSpec
    options:
      heading_level: 3
      members:
        - __init__
