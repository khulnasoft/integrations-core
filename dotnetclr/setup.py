...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'dotnetclr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-dotnetclr',
    version=ABOUT["__version__"],
    description='The .NET CLR check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent .NET CLR check',
    ...
    packages=['khulnasoft_checks.dotnetclr'],
