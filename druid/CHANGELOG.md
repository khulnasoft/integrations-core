...
* Add `pyproject.toml` file ([#11341](https://github.com/KhulnaSoft/integrations-core/pull/11341))
...
* Add runtime configuration validation ([#8908](https://github.com/KhulnaSoft/integrations-core/pull/8908))
...
* Add config specs ([#6728](https://github.com/KhulnaSoft/integrations-core/pull/6728))
...
* Add druid logs ([#4561](https://github.com/KhulnaSoft/integrations-core/pull/4561))

## 1.0.0 / 2019-10-11

***Added***:

* Adhere to logging call convention ([#4735](https://github.com/KhulnaSoft/integrations-core/pull/4735))
