...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'druid', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-druid',
    version=ABOUT['__version__'],
    description='The druid check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent druid check',
    ...
    packages=['khulnasoft_checks.druid'],
