...
* Add storage_stats support for Windows ([#16014](https://github.com/KhulnaSoft/integrations-core/pull/16014))

***Fixed***:

* Fix blkio_stats bad metrics for Windows ([#16014](https://github.com/KhulnaSoft/integrations-core/pull/16014))

## 4.0.1 / 2023-08-25 / Agent 7.48.0

***Fixed***:

* Fix ECS Fargate memory task limit units ([#15656](https://github.com/KhulnaSoft/integrations-core/pull/15656))
...
* Add task Memory Limit to ECS Fargate integration ([#15401](https://github.com/KhulnaSoft/integrations-core/pull/15401))
...
* Add ephemeral storage metrics for fargate check ([#14775](https://github.com/KhulnaSoft/integrations-core/pull/14775))
...
* Add task CPU Limit to ECS Fargate integration and use nanocore as CPU unit ([#13551](https://github.com/KhulnaSoft/integrations-core/pull/13551))
...
* Do not emit `ecs.fargate.mem.limit` metric when no memory hard-limit has been set ([#11484](https://github.com/KhulnaSoft/integrations-core/pull/11484))
* Add tls_protocols_allowed option documentation ([#11251](https://github.com/KhulnaSoft/integrations-core/pull/11251))

***Added***:

* Add `pyproject.toml` file ([#11342](https://github.com/KhulnaSoft/integrations-core/pull/11342))
...
* Add Windows support for ECS Fargate ([#10521](https://github.com/KhulnaSoft/integrations-core/pull/10521))

***Fixed***:

* Fix CPU metrics on ECS Fargate ([#10409](https://github.com/KhulnaSoft/integrations-core/pull/10409))

## 2.13.0 / 2021-10-04 / Agent 7.32.0

***Added***:

* Add runtime configuration validation ([#8909](https://github.com/KhulnaSoft/integrations-core/pull/8909))
...
* Amazon fargate config specs ([#8003](https://github.com/KhulnaSoft/integrations-core/pull/8003))

## 2.10.0 / 2020-08-10 / Agent 7.22.0

***Added***:

* Support include/exclude containers in ECS Fargate ([#7165](https://github.com/KhulnaSoft/integrations-core/pull/7165))
...
* Collect network metrics for ECS Fargate ([#6216](https://github.com/KhulnaSoft/integrations-core/pull/6216))
...
* Fix CPU metrics ([#5404](https://github.com/KhulnaSoft/integrations-core/pull/5404))
...
* Fix ecs_fargate timeout ([#4518](https://github.com/KhulnaSoft/integrations-core/pull/4518))

## 2.3.0 / 2019-08-24 / Agent 6.14.0

***Added***:

* Update with proxy settings and request wrapper ([#3477](https://github.com/KhulnaSoft/integrations-core/pull/3477))

## 2.2.2 / 2019-07-17 / Agent 6.13.0

***Fixed***:

* Use tagger with container_id prefix ([#4126](https://github.com/KhulnaSoft/integrations-core/pull/4126))
...
* Adhere to code style ([#3503](https://github.com/KhulnaSoft/integrations-core/pull/3503))

## 2.1.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2885](https://github.com/KhulnaSoft/integrations-core/pull/2885))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2601
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2206
[3]: https://github.com/KhulnaSoft/integrations-core/pull/1959
[4]: https://github.com/KhulnaSoft/integrations-core/pull/1518
