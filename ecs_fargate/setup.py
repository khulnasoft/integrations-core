...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'ecs_fargate', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ecs_fargate',
    version=ABOUT['__version__'],
    description='The ECS Fargate check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ecs_fargate check',
    ...
    packages=['khulnasoft_checks.ecs_fargate'],
