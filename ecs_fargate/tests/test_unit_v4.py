...
def test_successful_check_linux_v4(check, aggregator, dd_run_check):
    ...
    with mock.patch('khulnasoft_checks.ecs_fargate.ecs_fargate.requests.get', side_effect=mocked_requests_get_linux_v4):
        with mock.patch("khulnasoft_checks.ecs_fargate.ecs_fargate.get_tags", side_effect=mocked_get_tags_v4):
