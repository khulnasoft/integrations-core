...
* Add `pyproject.toml` file ([#11343](https://github.com/KhulnaSoft/integrations-core/pull/11343))
...
* Add runtime configuration validation ([#8910](https://github.com/KhulnaSoft/integrations-core/pull/8910))
...
* Add pod capacity metrics ([#8754](https://github.com/KhulnaSoft/integrations-core/pull/8754))
...
* Add config specs ([#8004](https://github.com/KhulnaSoft/integrations-core/pull/8004))
...
* Introducing the eks_fargate check ([#5417](https://github.com/KhulnaSoft/integrations-core/pull/5417))
