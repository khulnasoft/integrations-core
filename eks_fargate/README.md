...
<div class="alert alert-warning"> This page describes the EKS Fargate integration. For ECS Fargate, see the documentation for Datadog's <a href="http://docs.khulnasoft.com/integrations/ecs_fargate">ECS Fargate integration</a>.
</div>
...
**Note**: Don't forget to replace `<YOUR_KHULNASOFT_API_KEY>` with the [Datadog API key from your organization][14].
...
- Don't forget to replace `<YOUR_KHULNASOFT_API_KEY>` with the [Datadog API key from your organization][14].
...
[24]: http://docs.khulnasoft.com/tracing/#send-traces-to-datadog
...
[28]: https://www.khulnasoft.com/blog/aws-fargate-monitoring-with-datadog/
