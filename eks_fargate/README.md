...
To install, download the custom Agent image: `khulnasoft/agent` with version v7.17 or above.
...
**Note**: Don't forget to replace `<YOUR_KHULNASOFT_API_KEY>` with the [Khulnasoft API key from your organization][14].
