...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'eks_fargate', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-eks_fargate',
    version=ABOUT['__version__'],
    description='The eks_fargate check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent eks_fargate check',
    ...
    packages=['khulnasoft_checks.eks_fargate'],
