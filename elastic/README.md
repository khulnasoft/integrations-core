...
metadata:
  name: elasticsearch
  annotations:
    ad.khulnasoft.com/elasticsearch.check_names: '["elastic"]'
    ad.khulnasoft.com/elasticsearch.init_configs: '[{}]'
    ad.khulnasoft.com/elasticsearch.instances: |
      [
        {
          "url": "http://%%host%%:9200"
        }
...
metadata:
  name: elasticsearch
  annotations:
    ad.khulnasoft.com/elasticsearch.checks: |
      {
        "elastic": {
          "init_config": {},
          "instances": [
...
metadata:
  name: elasticsearch
  annotations:
    ad.khulnasoft.com/elasticsearch.logs: '[{"source":"elasticsearch","service":"<SERVICE_NAME>"}]'
spec:
  containers:
    - name: elasticsearch
```
...
[1]: https://raw.githubusercontent.com/KhulnaSoft/integrations-core/master/elastic/images/elasticsearch-dash.png
[2]: https://app.khulnasoft.com/account/settings/agent/latest
[3]: https://docs.khulnasoft.com/agent/guide/agent-configuration-files/#agent-configuration-directory
[4]: https://github.com/KhulnaSoft/integrations-core/blob/master/elastic/khulnasoft_checks/elastic/data/conf.yaml.example
[5]: https://docs.khulnasoft.com/getting_started/tagging/assigning_tags?tab=noncontainerizedenvironments#file-location
...
[9]: https://docs.khulnasoft.com/tracing/send_traces/
[10]: https://docs.khulnasoft.com/tracing/setup/
[11]: https://docs.khulnasoft.com/integrations/faq/why-isn-t-elasticsearch-sending-all-my-metrics/
[12]: https://docs.khulnasoft.com/agent/docker/integrations/?tab=docker
...
[15]: https://docs.khulnasoft.com/agent/kubernetes/apm/?tab=java
[16]: https://docs.khulnasoft.com/agent/kubernetes/daemonset_setup/?tab=k8sfile#apm-and-distributed-tracing
[17]: https://docs.khulnasoft.com/agent/kubernetes/integrations/?tab=kubernetes
[18]: https://docs.khulnasoft.com/agent/kubernetes/integrations/?tab=kubernetes#configuration
[19]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=containerinstallation#setup
[20]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=daemonset#configuration
[21]: https://docs.khulnasoft.com/agent/amazon_ecs/logs/?tab=linux
[22]: https://docs.khulnasoft.com/agent/amazon_ecs/apm/?tab=ec2metadataendpoint#setup
[23]: https://docs.khulnasoft.com/agent/guide/agent-commands/#agent-status-and-information
[25]: https://github.com/KhulnaSoft/integrations-core/blob/master/elastic/metadata.csv
[26]: https://github.com/KhulnaSoft/integrations-core/blob/master/elastic/assets/service_checks.json
[27]: https://docs.khulnasoft.com/integrations/faq/elastic-agent-can-t-connect/
[28]: https://www.khulnasoft.com/blog/monitor-elasticsearch-performance-metrics
