...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "elastic", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-elastic',
    version=ABOUT["__version__"],
    description='The Elastic Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent elastic check',
    ...
    packages=['khulnasoft_checks.elastic'],
