...
* Add local rate limit metrics ([#16313](https://github.com/KhulnaSoft/integrations-core/pull/16313))
* Add new RBAC metrics in Legacy check ([#16432](https://github.com/KhulnaSoft/integrations-core/pull/16432))
* Add connect state metric for OpenmetricsV2 and add way to collect shadow prefixes in legacy check for RBAC metrics ([#16453](https://github.com/KhulnaSoft/integrations-core/pull/16453))
* Add a `endpoint` tag to every metric in the legacy version of the check ([#16478](https://github.com/KhulnaSoft/integrations-core/pull/16478))

## 3.2.0 / 2023-11-10 / Agent 7.50.0

***Added***:

* Add rbac metrics ([#16165](https://github.com/KhulnaSoft/integrations-core/pull/16165))

## 3.1.0 / 2023-09-29 / Agent 7.49.0

***Added***:

* Add [TCP proxy statistics](https://www.envoyproxy.io/docs/envoy/latest/configuration/listeners/network_filters/tcp_proxy_filter#statistics) ([#15704](https://github.com/KhulnaSoft/integrations-core/pull/15704))
...
* Disable server info and version collection when collect_server_info is false ([#14610](https://github.com/KhulnaSoft/integrations-core/pull/14610))
...
* Add GRPC access log metrics ([#13932](https://github.com/KhulnaSoft/integrations-core/pull/13932))
...
* Parse and add the tag `stat_prefix` to `ext_authz` metrics if possible ([#13930](https://github.com/KhulnaSoft/integrations-core/pull/13930))

***Fixed***:

* Add missing metrics ([#14036](https://github.com/KhulnaSoft/integrations-core/pull/14036) and [#14088](https://github.com/KhulnaSoft/integrations-core/pull/14088))

## 2.4.1 / 2023-01-20 / Agent 7.43.0

***Fixed***:

* Fix metric mapping of counter metrics in the Openmetrics V2 version of the check ([#13573](https://github.com/KhulnaSoft/integrations-core/pull/13573))
...
* [Envoy] Support `envoy.cluster.outlier_detection.*` in OpenMetrics V2 ([#11860](https://github.com/KhulnaSoft/integrations-core/pull/11860))
...
* Add ext_authz and ratelimiter metrics to OpenMetrics implementation ([#12451](https://github.com/KhulnaSoft/integrations-core/pull/12451))

## 2.2.0 / 2022-06-27

***Added***:

* Add ext_authz metrics to envoy integration ([#12374](https://github.com/KhulnaSoft/integrations-core/pull/12374)) Thanks [Kaycell](https://github.com/Kaycell).
...
* Add `pyproject.toml` file ([#11345](https://github.com/KhulnaSoft/integrations-core/pull/11345))
...
* Support Openmetrics metrics collection ([#10752](https://github.com/KhulnaSoft/integrations-core/pull/10752))
...
* Add v3 API metrics ([#9468](https://github.com/KhulnaSoft/integrations-core/pull/9468))
* Rename cluster_name tag to envoy_cluster ([#9430](https://github.com/KhulnaSoft/integrations-core/pull/9430))

## 1.22.0 / 2021-05-06 / Agent 7.29.0

***Added***:

* Add collect_server_info config option ([#9298](https://github.com/KhulnaSoft/integrations-core/pull/9298))
* Add missing Envoy HTTP router filter vhost metrics ([#8586](https://github.com/KhulnaSoft/integrations-core/pull/8586)) Thanks [csssuf](https://github.com/csssuf).

## 1.21.1 / 2021-04-20 / Agent 7.28.0

***Fixed***:

* Fix retry parsing when metric has multiple metric parts ([#9189](https://github.com/KhulnaSoft/integrations-core/pull/9189))

## 1.21.0 / 2021-04-09

***Added***:

* Add retry option when metric is not found ([#9120](https://github.com/KhulnaSoft/integrations-core/pull/9120))
* Add runtime configuration validation ([#8912](https://github.com/KhulnaSoft/integrations-core/pull/8912))
...
* Update check signature ([#8258](https://github.com/KhulnaSoft/integrations-core/pull/8258))

## 1.20.0 / 2020-10-31 / Agent 7.24.0

***Added***:

* Add newly documented metrics ([#7765](https://github.com/KhulnaSoft/integrations-core/pull/7765))
...
* Add encoding in log config sample ([#7708](https://github.com/KhulnaSoft/integrations-core/pull/7708))

***Fixed***:

* Update Watchdog metrics ([#7740](https://github.com/KhulnaSoft/integrations-core/pull/7740))
* Properly handle a parsing edge case ([#7717](https://github.com/KhulnaSoft/integrations-core/pull/7717))
...
* envoy config specs ([#7157](https://github.com/KhulnaSoft/integrations-core/pull/7157))
...
* Use inclusive naming ([#7156](https://github.com/KhulnaSoft/integrations-core/pull/7156))
...
* Handle server info for envoy <= 1.8 ([#6740](https://github.com/KhulnaSoft/integrations-core/pull/6740))

## 1.15.1 / 2020-05-19

***Fixed***:

* Safer metadata error handling ([#6685](https://github.com/KhulnaSoft/integrations-core/pull/6685))

## 1.15.0 / 2020-05-17

***Added***:

* Collect version metadata ([#6595](https://github.com/KhulnaSoft/integrations-core/pull/6595))
...
* Update doc about whitelist and blacklist ([#5875](https://github.com/KhulnaSoft/integrations-core/pull/5875))
...
* Add support for more metrics in Envoy integration ([#5537](https://github.com/KhulnaSoft/integrations-core/pull/5537)) Thanks [csssuf](https://github.com/csssuf).
...
* Add new metrics for Redis ([#4946](https://github.com/KhulnaSoft/integrations-core/pull/4946)) Thanks [tony612](https://github.com/tony612).
...
* Add xDS-related metrics ([#4634](https://github.com/KhulnaSoft/integrations-core/pull/4634)) Thanks [csssuf](https://github.com/csssuf).
...
* Add RequestsWrapper to envoy ([#4120](https://github.com/KhulnaSoft/integrations-core/pull/4120))

## 1.8.0 / 2019-07-04 / Agent 6.13.0

***Added***:

* Add cluster.ssl metrics to Envoy integration ([#3976](https://github.com/KhulnaSoft/integrations-core/pull/3976)) Thanks [csssuf](https://github.com/csssuf).
* Add Envoy upstream_rq_completed cluster metrics ([#3955](https://github.com/KhulnaSoft/integrations-core/pull/3955)) Thanks [csssuf](https://github.com/csssuf).

## 1.7.0 / 2019-06-19

***Added***:

* Add more listener metrics ([#3922](https://github.com/KhulnaSoft/integrations-core/pull/3922))

## 1.6.0 / 2019-06-18

***Added***:

* Add logs config to envoy ([#3918](https://github.com/KhulnaSoft/integrations-core/pull/3918))

## 1.5.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Adhere to style ([#3366](https://github.com/KhulnaSoft/integrations-core/pull/3366))
...
* Add ability to whitelist/blacklist metrics ([#1975](https://github.com/KhulnaSoft/integrations-core/pull/1975))

## 1.2.1 / 2018-06-14 / Agent 6.4.0

***Fixed***:

* properly send tags for histograms ([#1741](https://github.com/KhulnaSoft/integrations-core/pull/1741))

## 1.2.0 / 2018-06-07

***Added***:

* support histograms, fix count submission ([#1616](https://github.com/KhulnaSoft/integrations-core/pull/1616))
