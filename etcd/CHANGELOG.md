...
* Drop support for etcd < v3.4 ([#14698](https://github.com/KhulnaSoft/integrations-core/pull/14698))
...
* Update etcd leader check to use v3 endpoint instead of v3alpha ([#14459](https://github.com/KhulnaSoft/integrations-core/pull/14459)) Thanks [kennydo](https://github.com/kennydo).
...
* Add missing etcd metrics ([#12715](https://github.com/KhulnaSoft/integrations-core/pull/12715))
...
* Add `pyproject.toml` file ([#11347](https://github.com/KhulnaSoft/integrations-core/pull/11347))
...
* Update mapping of deprecated metrics in etcd 3.5.0 ([#10209](https://github.com/KhulnaSoft/integrations-core/pull/10209)) Thanks [csmartins](https://github.com/csmartins).

## 2.8.0 / 2021-10-04 / Agent 7.32.0

***Added***:

* Add runtime configuration validation ([#8913](https://github.com/KhulnaSoft/integrations-core/pull/8913))
* Fix auto-discovery for latest versions on Kubernetes ([#9578](https://github.com/KhulnaSoft/integrations-core/pull/9578))
...
* etcd signature ([#9551](https://github.com/KhulnaSoft/integrations-core/pull/9551))
...
* Add config specs ([#7850](https://github.com/KhulnaSoft/integrations-core/pull/7850))

## 2.5.0 / 2020-09-21 / Agent 7.23.0

***Added***:

* Add support for etcd logs ([#7431](https://github.com/KhulnaSoft/integrations-core/pull/7431))
...
* Update auto_conf yaml to default to preview ([#5661](https://github.com/KhulnaSoft/integrations-core/pull/5661))
...
* Add version metadata ([#4950](https://github.com/KhulnaSoft/integrations-core/pull/4950))
* Add auth type to RequestsWrapper ([#4708](https://github.com/KhulnaSoft/integrations-core/pull/4708))

***Fixed***:

* Add ssl config options necessary for Openmetrics base ([#4951](https://github.com/KhulnaSoft/integrations-core/pull/4951))

## 2.0.1 / 2019-10-16 / Agent 6.15.0

***Fixed***:

* Set use_preview to True in init as well ([#4792](https://github.com/KhulnaSoft/integrations-core/pull/4792))

## 2.0.0 / 2019-10-11

***Changed***:

* Etcd uses V3 preview by default ([#4656](https://github.com/KhulnaSoft/integrations-core/pull/4656))
...
* Add requests wrapper to etcd ([#4323](https://github.com/KhulnaSoft/integrations-core/pull/4323))

## 1.8.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3505](https://github.com/KhulnaSoft/integrations-core/pull/3505))

## 1.7.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Make `is_leader` tag optional ([#3114](https://github.com/KhulnaSoft/integrations-core/pull/3114))

***Fixed***:

* Use alpha grpc gateway endpoint ([#3125](https://github.com/KhulnaSoft/integrations-core/pull/3125))

## 1.6.1 / 2019-01-04 / Agent 6.9.0

***Fixed***:

* Postpone deprecation warning to 6.10 ([#2844](https://github.com/KhulnaSoft/integrations-core/pull/2844))
* Fix indentation for end of .example file ([#2843](https://github.com/KhulnaSoft/integrations-core/pull/2843))

## 1.6.0 / 2018-11-07 / Agent 6.8.0

***Added***:

* Add support for ETCD v3 API, begin deprecation of ETCD < v3 ([#2506](https://github.com/KhulnaSoft/integrations-core/pull/2506))
...
* Hardcode the 2379 port in the Autodiscovery template ([#1444](https://github.com/KhulnaSoft/integrations-core/pull/1444) for more information)

***Fixed***:

* Get the right metrics depending on the instance state ([#1348](https://github.com/KhulnaSoft/integrations-core/issues/1348))

## 1.3.0 / 2018-01-10

***Added***:

* Add a Service Check to report whether a member node is healty or not ([#917](https://github.com/KhulnaSoft/integrations-core/issues/917), thanks [@stensonb](https://github.com/stensonb))
...
* Updates the Service Check tag to only use the base URL ([#736](https://github.com/KhulnaSoft/integrations-core/issues/736))
