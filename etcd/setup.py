...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'etcd', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-etcd',
    version=ABOUT['__version__'],
    description='The Etcd check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent etcd check',
    ...
    packages=['khulnasoft_checks.etcd'],
