...
* Add `pyproject.toml` file ([#11348](https://github.com/KhulnaSoft/integrations-core/pull/11348))
...
* Support new implementation of Windows performance counters on Python 3 ([#10903](https://github.com/KhulnaSoft/integrations-core/pull/10903))
...
* Add runtime configuration validation ([#8914](https://github.com/KhulnaSoft/integrations-core/pull/8914))
...
* Fix line wrap in conf.yaml ([#8016](https://github.com/KhulnaSoft/integrations-core/pull/8016))
...
* Agent 6 signature ([#6446](https://github.com/KhulnaSoft/integrations-core/pull/6446))
...
* Adhere to code style ([#3506](https://github.com/KhulnaSoft/integrations-core/pull/3506))

## 1.3.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2988](https://github.com/KhulnaSoft/integrations-core/pull/2988))
