...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'exchange_server', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-exchange_server',
    version=ABOUT["__version__"],
    description='The MS Exchange check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent exchange check',
    ...
    packages=['khulnasoft_checks.exchange_server'],
