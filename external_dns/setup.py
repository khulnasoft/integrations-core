...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'external_dns', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-external_dns',
    version=ABOUT['__version__'],
    description='The ExternalDNS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent external_dns check',
    ...
    packages=['khulnasoft_checks.external_dns'],
