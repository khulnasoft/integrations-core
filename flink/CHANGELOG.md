...
* Add `pyproject.toml` file ([#11350](https://github.com/KhulnaSoft/integrations-core/pull/11350))
...
* Remove instances from flink conf.yaml ([#5912](https://github.com/KhulnaSoft/integrations-core/pull/5912))

## 1.0.0 / 2020-02-21

***Added***:

* Add flink integration ([#5613](https://github.com/KhulnaSoft/integrations-core/pull/5613))
