...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'flink', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-flink',
    version=ABOUT['__version__'],
    description='The Flink check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent flink check',
    ...
    packages=['khulnasoft_checks.flink'],
