...
* Add `pyproject.toml` file ([#11351](https://github.com/KhulnaSoft/integrations-core/pull/11351))
...
* Add runtime configuration validation ([#8916](https://github.com/KhulnaSoft/integrations-core/pull/8916))
...
* Add support for additional metrics ([#7685](https://github.com/KhulnaSoft/integrations-core/pull/7685))
...
* Reduce log level of version collection warnings to DEBUG ([#6930](https://github.com/KhulnaSoft/integrations-core/pull/6930))
...
* Add config specs ([#6147](https://github.com/KhulnaSoft/integrations-core/pull/6147))
...
* Support Fluentd config API endpoint for metadata collection ([#6062](https://github.com/KhulnaSoft/integrations-core/pull/6062))
* Allow disabling metadata collection in fluentd ([#6061](https://github.com/KhulnaSoft/integrations-core/pull/6061))

## 1.5.0 / 2019-11-26 / Agent 7.16.0

***Added***:

* Collect version metadata for Fluentd ([#5057](https://github.com/KhulnaSoft/integrations-core/pull/5057))
...
* Fix request wrapper timeout and add test ([#4375](https://github.com/KhulnaSoft/integrations-core/pull/4375))
* Add support for proxy settings ([#3479](https://github.com/KhulnaSoft/integrations-core/pull/3479))
...
* Adhere to code style ([#3507](https://github.com/KhulnaSoft/integrations-core/pull/3507))

## 1.1.1 / 2019-03-29 / Agent 6.11.0

***Fixed***:

* Support fluentd v1's monitor_agent metrics ([#2965](https://github.com/KhulnaSoft/integrations-core/pull/2965)) Thanks [repeatedly](https://github.com/repeatedly).
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2735
