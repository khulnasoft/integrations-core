...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'fluentd', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-fluentd',
    version=ABOUT['__version__'],
    description='The Fluentd check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent fluentd check',
    ...
    packages=['khulnasoft_checks.fluentd'],
