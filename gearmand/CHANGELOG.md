...
* Add `pyproject.toml` file ([#11352](https://github.com/KhulnaSoft/integrations-core/pull/11352))
...
* Update config example to match implementation and refactor tests ([#10639](https://github.com/KhulnaSoft/integrations-core/pull/10639))

## 2.1.0 / 2021-11-13

***Added***:

* Add runtime configuration validation ([#8917](https://github.com/KhulnaSoft/integrations-core/pull/8917))
...
* Add log integration ([#7616](https://github.com/KhulnaSoft/integrations-core/pull/7616))

## 1.7.0 / 2020-09-21 / Agent 7.23.0

***Added***:

* Add config spec ([#7612](https://github.com/KhulnaSoft/integrations-core/pull/7612))
...
* Collect version metadata ([#5927](https://github.com/KhulnaSoft/integrations-core/pull/5927))
...
* Fix misleading gearman.workers metric (#4515) ([#4520](https://github.com/KhulnaSoft/integrations-core/pull/4520)) Thanks [orgito](https://github.com/orgito).

## 1.3.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3508](https://github.com/KhulnaSoft/integrations-core/pull/3508))
...
* Re-use gearman admin connections, fixes connection leak issue ([#422](https://github.com/KhulnaSoft/integrations-core/issues/422), thanks [@sophaskins](https://github)com/sophaskins)
