...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'gearmand', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-gearmand',
    version=ABOUT['__version__'],
    description='The Gearmand check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent gearmand check',
    ...
    packages=['khulnasoft_checks.gearmand'],
