...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'gitlab', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-gitlab',
    version=ABOUT['__version__'],
    description='The Gitlab check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent gitlab check',
    ...
    packages=['khulnasoft_checks.gitlab'],
