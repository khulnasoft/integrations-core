...
* Fix some default values in the configuration file ([#14602](https://github.com/KhulnaSoft/integrations-core/pull/14602))
...
* Add `pyproject.toml` file ([#11354](https://github.com/KhulnaSoft/integrations-core/pull/11354))
...
* Add runtime configuration validation ([#8919](https://github.com/KhulnaSoft/integrations-core/pull/8919))
...
* Add log support ([#7455](https://github.com/KhulnaSoft/integrations-core/pull/7455))
* Add RequestsWrapper option to support UTF-8 for basic auth ([#7441](https://github.com/KhulnaSoft/integrations-core/pull/7441))
* Add configuration spec ([#7397](https://github.com/KhulnaSoft/integrations-core/pull/7397))
...
* Collect version metadata ([#6894](https://github.com/KhulnaSoft/integrations-core/pull/6894))
...
* update gitlab_runner metrics ([#4799](https://github.com/KhulnaSoft/integrations-core/pull/4799))
...
* Add requests wrapper to gitlab_runner ([#4218](https://github.com/KhulnaSoft/integrations-core/pull/4218))

***Fixed***:

* Update RequestsWrapper with read/connect timeout ([#4241](https://github.com/KhulnaSoft/integrations-core/pull/4241))

## 2.3.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3510](https://github.com/KhulnaSoft/integrations-core/pull/3510))
...
* Support Python 3 ([#2886](https://github.com/KhulnaSoft/integrations-core/pull/2886))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/1978
