...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'gitlab_runner', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-gitlab_runner',
    version=ABOUT['__version__'],
    description='The Gitlab Runner check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent gitlab_runner check',
    ...
    packages=['khulnasoft_checks.gitlab_runner'],
