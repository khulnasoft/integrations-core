...
* Add `pyproject.toml` file ([#11355](https://github.com/KhulnaSoft/integrations-core/pull/11355))
...
* Add runtime configuration validation ([#8920](https://github.com/KhulnaSoft/integrations-core/pull/8920))

***Fixed***:

* Fix version parsing ([#9423](https://github.com/KhulnaSoft/integrations-core/pull/9423))
...
* Fix error handling when Agent has no sudo access ([#8470](https://github.com/KhulnaSoft/integrations-core/pull/8470))

## 1.1.0 / 2021-01-25

***Added***:

* Document glusterfs logs support ([#8411](https://github.com/KhulnaSoft/integrations-core/pull/8411))

## 1.0.0 / 2021-01-21

***Added***:

* New Integration: GlusterFS ([#8159](https://github.com/KhulnaSoft/integrations-core/pull/8159))
