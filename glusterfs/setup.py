...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'glusterfs', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-glusterfs',
    version=ABOUT['__version__'],
    description='The GlusterFS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent glusterfs check',
    ...
    packages=['khulnasoft_checks.glusterfs'],
