...
from khulnasoft_checks.dev import WaitFor, docker_run, run_command
...
def mock_gstatus_data():
    ...
    with open(f_name) as f:
        data = f.read()
    with mock.patch('khulnasoft_checks.glusterfs.check.get_subprocess_output', return_value=(data, '', 0)):
        yield
