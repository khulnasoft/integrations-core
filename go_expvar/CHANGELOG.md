...
* Add `pyproject.toml` file ([#11356](https://github.com/KhulnaSoft/integrations-core/pull/11356))
...
* Set log level to debug for memstats ([#10605](https://github.com/KhulnaSoft/integrations-core/pull/10605))
...
* Add runtime configuration validation ([#8922](https://github.com/KhulnaSoft/integrations-core/pull/8922))
...
* Add config specs ([#8006](https://github.com/KhulnaSoft/integrations-core/pull/8006))
...
* Add additional logging ([#6128](https://github.com/KhulnaSoft/integrations-core/pull/6128))
* Add go_expvar.memstats.total_alloc.count  ([#6005](https://github.com/KhulnaSoft/integrations-core/pull/6005))
...
* Revert "Submit total_alloc as monotonic count" ([#5972](https://github.com/KhulnaSoft/integrations-core/pull/5972))

## 1.7.1 / 2020-02-22

***Fixed***:

* Submit total_alloc as monotonic count ([#5703](https://github.com/KhulnaSoft/integrations-core/pull/5703))

## 1.7.0 / 2019-12-02 / Agent 7.16.0

***Added***:

* Adhere to logging style ([#5106](https://github.com/KhulnaSoft/integrations-core/pull/5106))
* Add count type to go_expvar ([#5097](https://github.com/KhulnaSoft/integrations-core/pull/5097))
...
* Fix error handling ([#4505](https://github.com/KhulnaSoft/integrations-core/pull/4505))

## 1.5.0 / 2019-08-24

***Added***:

* Add proxy settings support ([#3743](https://github.com/KhulnaSoft/integrations-core/pull/3743))

***Fixed***:

* Update __init__ method params ([#4243](https://github.com/KhulnaSoft/integrations-core/pull/4243))

## 1.4.0 / 2019-06-27 / Agent 6.13.0

***Added***:

* Add monotonic_counter support to go_expvar ([#3992](https://github.com/KhulnaSoft/integrations-core/pull/3992))

## 1.3.0 / 2019-06-20 / Agent 6.12.0

***Added***:

* Do not compile regexes on each run ([#3949](https://github.com/KhulnaSoft/integrations-core/pull/3949))

## 1.2.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3511](https://github.com/KhulnaSoft/integrations-core/pull/3511))

## 1.1.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2833](https://github.com/KhulnaSoft/integrations-core/pull/2833))
...
* Move Goexpvar to pytest ([#2089](https://github.com/KhulnaSoft/integrations-core/pull/2089))
...
* Fix path tag appended to all metrics matching path regex ([#472](https://github.com/KhulnaSoft/integrations-core/issues/472)
