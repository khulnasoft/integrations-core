...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'go_expvar', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-go_expvar',
    version=ABOUT['__version__'],
    description='The Go Expvar check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent go_expvar check',
    ...
    packages=['khulnasoft_checks.go_expvar'],
