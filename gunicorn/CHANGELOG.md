...
* Add `pyproject.toml` file ([#11357](https://github.com/KhulnaSoft/integrations-core/pull/11357))
...
* Add runtime configuration validation ([#8923](https://github.com/KhulnaSoft/integrations-core/pull/8923))
...
* Improve readability a bit ([#8454](https://github.com/KhulnaSoft/integrations-core/pull/8454))

## 1.14.1 / 2021-01-15 / Agent 7.26.0

***Fixed***:

* Prevent raising an error if the master process no longer exists ([#8314](https://github.com/KhulnaSoft/integrations-core/pull/8314))
...
* Add config specs ([#7258](https://github.com/KhulnaSoft/integrations-core/pull/7258))

***Fixed***:

* Update logs config service field to optional ([#7209](https://github.com/KhulnaSoft/integrations-core/pull/7209))
* Debug logs for failing to retrieve metadata, also add ability to disa… ([#7255](https://github.com/KhulnaSoft/integrations-core/pull/7255))
...
* Add version metadata ([#4968](https://github.com/KhulnaSoft/integrations-core/pull/4968))

***Fixed***:

* Remove shlex ([#5064](https://github.com/KhulnaSoft/integrations-core/pull/5064))
...
* Fix mac compatibility ([#3853](https://github.com/KhulnaSoft/integrations-core/pull/3853))
...
* Adhere to code style ([#3512](https://github.com/KhulnaSoft/integrations-core/pull/3512))
...
* Support Python 3 ([#2752](https://github.com/KhulnaSoft/integrations-core/pull/2752))
...
* Gunicorn intergration - fix problem with multiple master processes ([#1839](https://github.com/KhulnaSoft/integrations-core/pull/1839)) Thanks [mrmm](https://github.com/mrmm).
