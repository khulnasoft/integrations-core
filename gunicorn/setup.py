...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'gunicorn', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-gunicorn',
    version=ABOUT['__version__'],
    description='The Gunicorn check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent gunicorn check',
    ...
    packages=['khulnasoft_checks.gunicorn'],
