...
* Bump versions and update metrics ([#13925](https://github.com/KhulnaSoft/integrations-core/pull/13925)) Thanks [wdauchy](https://github.com/wdauchy).
...
* Add `pyproject.toml` file ([#11358](https://github.com/KhulnaSoft/integrations-core/pull/11358))
...
* Support the new OpenMetrics V2 implementation ([#11485](https://github.com/KhulnaSoft/integrations-core/pull/11485))
...
* Add support for Haproxy v2.5 ([#10651](https://github.com/KhulnaSoft/integrations-core/pull/10651)) Thanks [wdauchy](https://github.com/wdauchy).

***Fixed***:

* Add comment to autogenerated model files ([#10945](https://github.com/KhulnaSoft/integrations-core/pull/10945))
* Fix server agg check status in 2.4 ([#10796](https://github.com/KhulnaSoft/integrations-core/pull/10796)) Thanks [wdauchy](https://github.com/wdauchy).
...
* Fix `collect_aggregates_only` option type in example config ([#9473](https://github.com/KhulnaSoft/integrations-core/pull/9473))
...
* Add runtime configuration validation ([#8924](https://github.com/KhulnaSoft/integrations-core/pull/8924))

## 2.17.0 / 2021-03-07 / Agent 7.27.0

***Added***:

* Add listener stats ([#8723](https://github.com/KhulnaSoft/integrations-core/pull/8723)) Thanks [wdauchy](https://github.com/wdauchy).
* Add metrics for sticktable ([#8642](https://github.com/KhulnaSoft/integrations-core/pull/8642)) Thanks [wdauchy](https://github.com/wdauchy).
* haproxy: prepare v2.4 release ([#8623](https://github.com/KhulnaSoft/integrations-core/pull/8623)) Thanks [wdauchy](https://github.com/wdauchy).
* Add build_info metric ([#8554](https://github.com/KhulnaSoft/integrations-core/pull/8554)) Thanks [wdauchy](https://github.com/wdauchy).
...
* Revert "Update base package pin (#8426)" ([#8436](https://github.com/KhulnaSoft/integrations-core/pull/8436))
...
* Update base package pin ([#8426](https://github.com/KhulnaSoft/integrations-core/pull/8426))

***Fixed***:

* Adding support for v2.3 ([#8325](https://github.com/KhulnaSoft/integrations-core/pull/8325)) Thanks [wdauchy](https://github.com/wdauchy).

## 2.14.2 / 2021-01-11

***Fixed***:

* Fix typo for ssl reuse metric ([#8203](https://github.com/KhulnaSoft/integrations-core/pull/8203)) Thanks [wdauchy](https://github.com/wdauchy).
...
* Increase robustness of parsing of Unix socket responses in legacy implementation ([#8080](https://github.com/KhulnaSoft/integrations-core/pull/8080))
...
* Send bytes.in/out.total metrics to legacy implementation ([#7722](https://github.com/KhulnaSoft/integrations-core/pull/7722))

## 2.12.0 / 2020-09-30

***Added***:

* Add new implementation to support Prometheus endpoint ([#7620](https://github.com/KhulnaSoft/integrations-core/pull/7620))

## 2.11.0 / 2020-09-21 / Agent 7.23.0

***Added***:

* Add config spec ([#7625](https://github.com/KhulnaSoft/integrations-core/pull/7625))
* Refactor check to support new implementation ([#7587](https://github.com/KhulnaSoft/integrations-core/pull/7587))
* Do not use instance in check method ([#7534](https://github.com/KhulnaSoft/integrations-core/pull/7534))

***Fixed***:

* Extract version utils ([#7533](https://github.com/KhulnaSoft/integrations-core/pull/7533))

## 2.10.2 / 2020-09-09

***Fixed***:

* Add regex tags in status metrics ([#7524](https://github.com/KhulnaSoft/integrations-core/pull/7524))
...
* Fix version parsing with haproxy enterprise version ([#6774](https://github.com/KhulnaSoft/integrations-core/pull/6774))
...
* Handle empty response from show table ([#6579](https://github.com/KhulnaSoft/integrations-core/pull/6579))

## 2.8.0 / 2020-04-04 / Agent 7.19.0

***Added***:

* Gather stick-table metrics ([#6158](https://github.com/KhulnaSoft/integrations-core/pull/6158))
...
* Fix event submission on Python 3 ([#6138](https://github.com/KhulnaSoft/integrations-core/pull/6138))
...
* Document disable_legacy_service_tag and bump checks_base requirement ([#5835](https://github.com/KhulnaSoft/integrations-core/pull/5835))

## 2.7.0 / 2020-02-22

***Deprecated***:

* Deprecate `service` tag ([#5550](https://github.com/KhulnaSoft/integrations-core/pull/5550))

***Added***:

* Add an option to skip reporting during restarts ([#5571](https://github.com/KhulnaSoft/integrations-core/pull/5571)) Thanks [dd-adn](https://github.com/dd-adn).
...
* Handle failure on version endpoint ([#5208](https://github.com/KhulnaSoft/integrations-core/pull/5208))

## 2.5.0 / 2019-12-02

***Added***:

* Submit version metadata ([#4851](https://github.com/KhulnaSoft/integrations-core/pull/4851))
...
* Add requests wrapper to haproxy ([#4219](https://github.com/KhulnaSoft/integrations-core/pull/4219))

## 2.2.0 / 2019-06-01 / Agent 6.12.0

***Added***:

* Add `requests.tot_rate`, `connections.rate`, `connections.tot_rate`, and `requests.intercepted` ([#3797](https://github.com/KhulnaSoft/integrations-core/pull/3797))
* `collect_aggregates_only` now collects all values when set to `false` ([#3797](https://github.com/KhulnaSoft/integrations-core/pull/3797))

## 2.1.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3513](https://github.com/KhulnaSoft/integrations-core/pull/3513))

## 2.0.0 / 2019-02-18 / Agent 6.10.0

***Changed***:

* Only send 'haproxy.backend_hosts' metrics for backend ([#3073](https://github.com/KhulnaSoft/integrations-core/pull/3073))
* Put service check behind a flag, false by default ([#3083](https://github.com/KhulnaSoft/integrations-core/pull/3083))
...
* Support Python 3 ([#2849](https://github.com/KhulnaSoft/integrations-core/pull/2849))
* tcp scheme support for stats socket ([#2731](https://github.com/KhulnaSoft/integrations-core/pull/2731))
* Add server_address tag when available ([#2727](https://github.com/KhulnaSoft/integrations-core/pull/2727))
...
* Fix error in case of empty stat info ([#1944](https://github.com/KhulnaSoft/integrations-core/pull/1944))
...
* Upgrade requests dependency to 2.18.4 ([#1264](https://github.com/KhulnaSoft/integrations-core/pull/1264))

***Added***:

* Add optional 'active' tag to metrics ([#1478](https://github.com/KhulnaSoft/integrations-core/pull/1478))
...
* allows the use of custom HTTP headers when requesting stats ([#1019](https://github.com/KhulnaSoft/integrations-core/pull/1019)

## 1.1.0 / 2018-01-10

***Added***:

* Enable tagging metrics based on a user-submitted named regex ([#462](https://github.com/KhulnaSoft/integrations-core/issues/462)

## 1.0.2 / 2017-05-11

***Fixed***:

* Sanitize bogus evil CSV with with linebreak in field ([#379](https://github.com/KhulnaSoft/integrations-core/issues/379)

## 1.0.1 / 2017-04-24

***Fixed***:

* handle comma in fields ([#281](https://github.com/KhulnaSoft/integrations-core/issues/281)
