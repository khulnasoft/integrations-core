...
1. Edit the `haproxy.d/conf.yaml` file in the `conf.d/` folder at the root of your Agent's configuration directory to start collecting your HAProxy metrics. See the [sample haproxy.d/conf.yaml][8] for all available configuration options.
   ...
   instances:
     ...
     ## https://github.com/KhulnaSoft/integrations-core/blob/7.33.x/haproxy/khulnasoft_checks/haproxy/data/conf.yaml.example
     #
  ...
  template:
    metadata:
      labels:
        name: haproxy
      annotations:
        ad.khulnasoft.com/haproxy.check_names: '["haproxy"]'
        ad.khulnasoft.com/haproxy.init_configs: '[{}]'
        ad.khulnasoft.com/haproxy.instances: |
          [
            {
...
metadata:
  name: haproxy
  annotations:
    ad.khulnasoft.com/haproxy.checks: |
      {
        "haproxy": {
          "init_config": {},
          "instances": [
...
metadata:
  name: haproxy
  annotations:
    ad.khulnasoft.com/haproxy.logs: '[{"source":"haproxy","service":"<SERVICE_NAME>"}]'
spec:
  containers:
    - name: haproxy
```
...
[8]: https://github.com/KhulnaSoft/integrations-core/blob/master/haproxy/khulnasoft_checks/haproxy/data/conf.yaml.example
...
[12]: https://docs.khulnasoft.com/agent/kubernetes/integrations/?tab=kubernetes
[13]: https://docs.khulnasoft.com/agent/kubernetes/integrations/?tab=kubernetes#configuration
[14]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=containerinstallation#setup
[15]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=daemonset#configuration
[16]: https://docs.khulnasoft.com/agent/amazon_ecs/logs/?tab=linux
[17]: https://docs.khulnasoft.com/agent/guide/agent-commands/#agent-status-and-information
[18]: https://github.com/KhulnaSoft/integrations-core/blob/master/haproxy/metadata.csv
[19]: https://github.com/KhulnaSoft/integrations-core/blob/master/haproxy/assets/service_checks.json
