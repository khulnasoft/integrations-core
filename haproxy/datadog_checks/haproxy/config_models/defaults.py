...
def instance_collate_status_tags_per_host():
    return True
...
def instance_collect_status_metrics_by_host():
    return False


def instance_count_status_by_service():
    return True
...
def instance_disable_legacy_service_tag():
    return False
...
def instance_enable_service_check():
    return False
...
def instance_startup_grace_seconds():
    return 0
...
def instance_tag_service_check_by_host():
    return False
