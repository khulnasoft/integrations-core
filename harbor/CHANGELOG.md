...
* Remove support for harbor < 1.10 ([#15634](https://github.com/KhulnaSoft/integrations-core/pull/15634))
...
* Add `pyproject.toml` file ([#11359](https://github.com/KhulnaSoft/integrations-core/pull/11359))
...
* Support v2 system volumes api  ([#10133](https://github.com/KhulnaSoft/integrations-core/pull/10133))
...
* Add runtime configuration validation ([#8925](https://github.com/KhulnaSoft/integrations-core/pull/8925))
...
* Support v2 ([#8269](https://github.com/KhulnaSoft/integrations-core/pull/8269))

## 1.7.0 / 2020-10-31 / Agent 7.24.0

***Added***:

* Add config spec ([#7845](https://github.com/KhulnaSoft/integrations-core/pull/7845))
...
* Add status check for Harbor's read-only status ([#6917](https://github.com/KhulnaSoft/integrations-core/pull/6917)) Thanks [bksteiny](https://github.com/bksteiny).
...
* Update base dependency for harbor ([#5841](https://github.com/KhulnaSoft/integrations-core/pull/5841))

## 1.3.0 / 2020-01-15 / Agent 7.17.0

***Added***:

* Refactor authentication to add support for Harbor 1.9 and 1.10 ([#5468](https://github.com/KhulnaSoft/integrations-core/pull/5468))
...
* Fix up doc and conf ([#4358](https://github.com/KhulnaSoft/integrations-core/pull/4358))
...
* Harbor - New integration ([#3799](https://github.com/KhulnaSoft/integrations-core/pull/3799))
