...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'harbor', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-harbor',
    version=ABOUT['__version__'],
    description='The harbor check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent harbor check',
    ...
    packages=['khulnasoft_checks.harbor'],
