...
* Add `pyproject.toml` file ([#11360](https://github.com/KhulnaSoft/integrations-core/pull/11360))
...
* Add runtime configuration validation ([#8926](https://github.com/KhulnaSoft/integrations-core/pull/8926))
...
* Document `mc_cluster_states` configuration option ([#6704](https://github.com/KhulnaSoft/integrations-core/pull/6704))
...
* Add Hazelcast integration ([#6236](https://github.com/KhulnaSoft/integrations-core/pull/6236))
