...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'hazelcast', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hazelcast',
    version=ABOUT['__version__'],
    description='The Hazelcast check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hazelcast check',
    ...
    packages=['khulnasoft_checks.hazelcast'],
