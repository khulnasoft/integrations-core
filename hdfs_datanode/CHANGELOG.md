...
* Add `pyproject.toml` file ([#11361](https://github.com/KhulnaSoft/integrations-core/pull/11361))
...
* Bump minimum base requirement to 15.7.0 ([#10604](https://github.com/KhulnaSoft/integrations-core/pull/10604))

## 2.1.0 / 2021-10-04 / Agent 7.32.0

***Added***:

* Add runtime configuration validation ([#8927](https://github.com/KhulnaSoft/integrations-core/pull/8927))
...
* Add config specs ([#6900](https://github.com/KhulnaSoft/integrations-core/pull/6900))
...
* Collect version metadata for hdfs_datanode ([#5088](https://github.com/KhulnaSoft/integrations-core/pull/5088))
...
* Use the new RequestsWrapper for connecting to services ([#4056](https://github.com/KhulnaSoft/integrations-core/pull/4056))

## 1.7.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3514](https://github.com/KhulnaSoft/integrations-core/pull/3514))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2856
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2591
[3]: https://github.com/KhulnaSoft/integrations-core/pull/2516
[4]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[5]: https://github.com/KhulnaSoft/integrations-core/pull/1674
[6]: https://github.com/KhulnaSoft/integrations-core/issues/714
