...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "hdfs_datanode", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hdfs_datanode',
    version=ABOUT['__version__'],
    description='The HDFS Datanode Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hdfs_datanode check',
    ...
    packages=['khulnasoft_checks.hdfs_datanode'],
