...
from khulnasoft_checks.hdfs_datanode import HDFSDataNode
...
def test_metadata(aggregator, mocked_request, mocked_metadata_request, khulnasoft_agent):
    """
    ...
    khulnasoft_agent.assert_metadata_count(6)
