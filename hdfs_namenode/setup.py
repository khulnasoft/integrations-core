...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "hdfs_namenode", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hdfs_namenode',
    version=ABOUT['__version__'],
    description='The HDFS Namenode check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hdfs_namenode check',
    ...
    packages=['khulnasoft_checks.hdfs_namenode'],
