...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'hive', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hive',
    version=ABOUT['__version__'],
    description='The hive check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hive check',
    ...
    packages=['khulnasoft_checks.hive'],
