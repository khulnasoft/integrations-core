...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'hivemq', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hivemq',
    version=ABOUT['__version__'],
    description='The HiveMQ check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hivemq check',
    ...
    packages=['khulnasoft_checks.hivemq'],
