...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "http_check", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-http_check',
    version=ABOUT['__version__'],
    description='The HTTP check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent http_check check',
    ...
    packages=['khulnasoft_checks.http_check'],
