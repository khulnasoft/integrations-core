...
def test_check_tsl_ca_cert(aggregator, dd_run_check):
    ...
    with mock.patch(
        'khulnasoft_checks.http_check.http_check.get_ca_certs_path',
...
def test_check_allow_redirects(aggregator):
    with mock.patch('khulnasoft_checks.http_check.http_check.get_ca_certs_path', new=mock_get_ca_certs_path):
