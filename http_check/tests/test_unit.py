...
from khulnasoft_checks.http_check import HTTPCheck, http_check
...
def test__init__():
    ...
    with mock.patch('khulnasoft_checks.http_check.http_check.get_ca_certs_path', return_value='bar'):
