...
from khulnasoft_checks.base.utils.headers import headers as agent_headers
from khulnasoft_checks.http_check.config import DEFAULT_EXPECTED_CODE, from_instance
