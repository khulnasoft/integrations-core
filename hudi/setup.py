...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'hudi', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hudi',
    version=ABOUT['__version__'],
    description='The Hudi check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hudi check',
    ...
    packages=['khulnasoft_checks.hudi'],
