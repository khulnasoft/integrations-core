...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'hyperv', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-hyperv',
    version=ABOUT['__version__'],
    description='The Hyper-V check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent hyperv check',
    ...
    packages=['khulnasoft_checks.hyperv'],
