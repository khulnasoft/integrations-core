...
* Add hostname as part of the subscription substring ([#15189](https://github.com/KhulnaSoft/integrations-core/pull/15189))
...
* Use `non_durable` queues when connecting to IBM Ace and also delete the subscription when disconnecting ([#14568](https://github.com/KhulnaSoft/integrations-core/pull/14568))

## 1.0.4 / 2023-02-15 / Agent 7.44.0

***Fixed***:

* Use `count` instead of `monotonic_count` for counters ([#13959](https://github.com/KhulnaSoft/integrations-core/pull/13959))
...
* Submit error message with non-OK service check statuses ([#12523](https://github.com/KhulnaSoft/integrations-core/pull/12523))

## 1.0.2 / 2022-05-15 / Agent 7.37.0

***Fixed***:

* Fix enumerated integer validation ([#11964](https://github.com/KhulnaSoft/integrations-core/pull/11964))

## 1.0.1 / 2022-04-14 / Agent 7.36.0

***Fixed***:

* Enable py3 only ([#11833](https://github.com/KhulnaSoft/integrations-core/pull/11833))

## 1.0.0 / 2022-04-04

***Added***:

* Add IBM ACE integration ([#11654](https://github.com/KhulnaSoft/integrations-core/pull/11654))
