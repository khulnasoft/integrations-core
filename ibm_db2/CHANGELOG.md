...
* Add option to control the connection timeout ([#14110](https://github.com/KhulnaSoft/integrations-core/pull/14110))
...
* Emit critical service check when connection is lost ([#12995](https://github.com/KhulnaSoft/integrations-core/pull/12995))

## 1.11.1 / 2022-08-26

***Fixed***:

* Get a connection every check run ([#12736](https://github.com/KhulnaSoft/integrations-core/pull/12736))
...
* Set enum of security option ([#11584](https://github.com/KhulnaSoft/integrations-core/pull/11584))

## 1.10.0 / 2022-02-19

***Added***:

* Add Security parameter ([#11236](https://github.com/KhulnaSoft/integrations-core/pull/11236)) Thanks [martintietz](https://github.com/martintietz).
* Add `pyproject.toml` file ([#11368](https://github.com/KhulnaSoft/integrations-core/pull/11368))
...
* Add runtime configuration validation ([#8934](https://github.com/KhulnaSoft/integrations-core/pull/8934))

## 1.8.1 / 2021-10-21

***Fixed***:

* Modify can_connect to emit every run ([#10455](https://github.com/KhulnaSoft/integrations-core/pull/10455))
...
* Log message for invalid queries ([#9797](https://github.com/KhulnaSoft/integrations-core/pull/9797))
...
* Add config specs ([#8007](https://github.com/KhulnaSoft/integrations-core/pull/8007))

## 1.5.1 / 2020-10-31 / Agent 7.24.0

***Fixed***:

* Fix default port value ([#7658](https://github.com/KhulnaSoft/integrations-core/pull/7658))
...
* Add parameters for SSL configuration ([#5587](https://github.com/KhulnaSoft/integrations-core/pull/5587))
...
* Add version metadata ([#5262](https://github.com/KhulnaSoft/integrations-core/pull/5262))

## 1.2.0 / 2019-12-16

***Added***:

* Retry connection after closed connection ([#5194](https://github.com/KhulnaSoft/integrations-core/pull/5194))

## 1.1.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3518](https://github.com/KhulnaSoft/integrations-core/pull/3518))

## 1.0.1 / 2019-04-10 / Agent 6.11.0

***Fixed***:

* Change `ibm_db2.connection.max` to gauge ([#3602](https://github.com/KhulnaSoft/integrations-core/pull/3602))

## 1.0.0 / 2019-03-29

***Added***:

* Add IBM Db2 ([#3095](https://github.com/KhulnaSoft/integrations-core/pull/3095))
