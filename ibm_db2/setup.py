...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'ibm_db2', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ibm_db2',
    version=ABOUT['__version__'],
    description='The IBM Db2 check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ibm_db2 check',
    ...
    packages=['khulnasoft_checks.ibm_db2'],
