...
* Add `cpu_usage.pct` metric from `ELAPSED_CPU_PERCENTAGE` retrieved from query ([#16332](https://github.com/KhulnaSoft/integrations-core/pull/16332))
...
* Add `selected_message_queues` flag to filter message queues and improve performances ([#12808](https://github.com/KhulnaSoft/integrations-core/pull/12808))

***Fixed***:

* Produce CRITICAL service check if it cannot connect ([#13114](https://github.com/KhulnaSoft/integrations-core/pull/13114))
...
* Add option to select which queries to run ([#11806](https://github.com/KhulnaSoft/integrations-core/pull/11806))
...
* Add `pyproject.toml` file ([#11369](https://github.com/KhulnaSoft/integrations-core/pull/11369))
* Add detailed CPU usage and status metrics ([#11081](https://github.com/KhulnaSoft/integrations-core/pull/11081))
...
* Log exceptions for troubleshooting ([#10368](https://github.com/KhulnaSoft/integrations-core/pull/10368))
* Add option to override default IBM i hostname ([#10383](https://github.com/KhulnaSoft/integrations-core/pull/10383))
...
* Add IBM i integration ([#9992](https://github.com/KhulnaSoft/integrations-core/pull/9992))
