...
from khulnasoft_checks.ibm_i import IbmICheck
from khulnasoft_checks.ibm_i.check import SystemInfo
...
def test_cancel(instance):
    ...
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess') as m:
        check.cancel()
...
def test_connection_subprocess(instance):
    check = IbmICheck('ibm_i', {}, [instance])
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck._create_connection_subprocess') as m:
...
def test_fetch_system_info(instance):
    ...
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.execute_query', return_value=[("hostname", "7", "3")]), mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess'
    ) as delete_conn:
...
def test_fetch_system_info_too_many(instance):
    ...
    check.log = mock.MagicMock()
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.execute_query', return_value=[1, 2]), mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess'
    ) as delete_conn:
        system_info = check.fetch_system_info()
...
def test_fetch_system_info_incorrect_schema(instance):
    ...
    check.log = mock.MagicMock()
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.execute_query', return_value=[[]]), mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess'
    ) as delete_conn:
        system_info = check.fetch_system_info()
...
def test_fetch_system_info_incorrect_version(instance):
    ...
    check.load_configuration_models()
    with mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck.execute_query', return_value=[["hostname", "invalid", 3]]
    ), mock.patch('khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess') as delete_conn:
        system_info = check.fetch_system_info()
...
def test_fetch_system_info_incorrect_release(instance):
    ...
    check.load_configuration_models()
    with mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck.execute_query', return_value=[["hostname", 7, "invalid"]]
    ), mock.patch('khulnasoft_checks.ibm_i.IbmICheck._delete_connection_subprocess') as delete_conn:
        system_info = check.fetch_system_info()
...
def test_query_error_system_info(instance):
    ...
    check.load_configuration_models()
    exc = Exception("boom")
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.execute_query', side_effect=exc):
        system_info = check.fetch_system_info()
...
def test_set_up_query_manager_error(instance):
    check = IbmICheck('ibm_i', {}, [instance])
    check.log = mock.MagicMock()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.fetch_system_info', return_value=None):
...
def test_set_up_query_manager_7_2(instance):
    ...
    check.log = mock.MagicMock()
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.fetch_system_info', return_value=SystemInfo("host", 7, 2)):
        check.set_up_query_manager()
...
def test_set_up_query_manager_7_4(instance):
    ...
    check.log = mock.MagicMock()
    check.load_configuration_models()
    with mock.patch('khulnasoft_checks.ibm_i.IbmICheck.fetch_system_info', return_value=SystemInfo("host", 7, 4)):
        check.set_up_query_manager()
    assert check._query_manager is not None
    assert check._query_manager.hostname == "host"
...
def test_check_query_error(aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.ibm_i.IbmICheck.fetch_system_info', return_value=SystemInfo("host", 7, 4)
    ), mock.patch('khulnasoft_checks.ibm_i.IbmICheck.execute_query', side_effect=Exception("boom")):
        assert check._query_manager is None
        check.check(instance)
        assert check._query_manager is not None
        assert check._query_manager.hostname == "host"
