...
# TODO: change to from khulnasoft_checks.base.utils.common import to_native_string when bumping base agent requirement
from khulnasoft_checks.base import to_string as to_native_string
