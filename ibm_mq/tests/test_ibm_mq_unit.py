...
def test_set_mqcd_version(instance):
    ...
    from khulnasoft_checks.ibm_mq.config import IBMMQConfig
...
def test_ssl_check_normal_connection_before_ssl_connection(instance_ssl_dummy):
    ...
    from khulnasoft_checks.ibm_mq.config import IBMMQConfig
    from khulnasoft_checks.ibm_mq.connection import get_queue_manager_connection
    ...
    with mock.patch(
        'khulnasoft_checks.ibm_mq.connection.get_normal_connection', side_effect=error
    ) as get_normal_connection, mock.patch('khulnasoft_checks.ibm_mq.connection.get_ssl_connection') as get_ssl_connection:
    ...
    for error_reason in [pymqi.CMQC.MQRC_HOST_NOT_AVAILABLE, pymqi.CMQC.MQRC_SSL_CONFIG_ERROR]:
        ...
        with mock.patch(
            ...
            'khulnasoft_checks.ibm_mq.connection.get_ssl_connection'
    ...
    with mock.patch('khulnasoft_checks.ibm_mq.connection.get_normal_connection') as get_normal_connection, mock.patch(
        'khulnasoft_checks.ibm_mq.connection.get_ssl_connection'
    ) as get_ssl_connection:
