...
def test_sanitize_strings(input_string, expected):
    from khulnasoft_checks.ibm_mq.utils import sanitize_strings
...
def test_calculate_elapsed_time(datestamp, timestamp, time_zone):
    ...
    from khulnasoft_checks.base.utils.time import EPOCH
    from khulnasoft_checks.ibm_mq.utils import calculate_elapsed_time
