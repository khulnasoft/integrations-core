...
* Fix `aarch64` compatibility of the `ibm_was` check by downgrading `lxml` to version 4.9.2 ([16080](https://github.com/KhulnaSoft/integrations-core/pull/16080))
...
* Log that we collect stats only when we in fact do collect them ([#13324](https://github.com/KhulnaSoft/integrations-core/pull/13324))
...
* Add `pyproject.toml` file ([#11371](https://github.com/KhulnaSoft/integrations-core/pull/11371))
...
* Add dd_run_check and remove unused config options ([#10623](https://github.com/KhulnaSoft/integrations-core/pull/10623))

## 1.11.0 / 2021-11-13

***Added***:

* Add runtime configuration validation ([#8936](https://github.com/KhulnaSoft/integrations-core/pull/8936))
...
* Change status warning to debug log ([#10278](https://github.com/KhulnaSoft/integrations-core/pull/10278))
...
* Refactor to only parse configuration once ([#8025](https://github.com/KhulnaSoft/integrations-core/pull/8025))
* Add config specs ([#8024](https://github.com/KhulnaSoft/integrations-core/pull/8024))
...
* Fix character casing logic for custom_queries_units_gauge option ([#4796](https://github.com/KhulnaSoft/integrations-core/pull/4796))

## 1.3.0 / 2019-10-11

***Added***:

* Add an option for custom count with units ([#4628](https://github.com/KhulnaSoft/integrations-core/pull/4628))

## 1.2.3 / 2019-09-23

***Fixed***:

* Don't assume nested tags exist ([#4605](https://github.com/KhulnaSoft/integrations-core/pull/4605))

## 1.2.2 / 2019-09-02 / Agent 6.14.0

***Fixed***:

* Fix bug where multinode clusters would report wrong server/node tag combination and duplicate metric values ([#4491](https://github.com/KhulnaSoft/integrations-core/pull/4491))
...
* Update metric type for JVM Metrics ([#4085](https://github.com/KhulnaSoft/integrations-core/pull/4085))

## 1.1.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Use request wrapper ([#3650](https://github.com/KhulnaSoft/integrations-core/pull/3650))
* Adhere to code style ([#3520](https://github.com/KhulnaSoft/integrations-core/pull/3520))

## 1.0.0 / 2019-02-20 / Agent 6.10.0

***Added***:

* Create IBM WAS Integration ([#2846](https://github.com/KhulnaSoft/integrations-core/pull/2846))
