...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'ibm_was', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ibm_was',
    version=ABOUT['__version__'],
    description='The IBM WAS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ibm_was check',
    ...
    packages=['khulnasoft_checks.ibm_was'],
