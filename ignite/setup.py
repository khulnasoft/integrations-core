...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'ignite', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ignite',
    version=ABOUT['__version__'],
    description='The ignite check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ignite check',
    ...
    packages=['khulnasoft_checks.ignite'],
