...
* Bump the minimum base check version ([#15448](https://github.com/KhulnaSoft/integrations-core/pull/15448))
...
* Fix `iis.*_up` service check when configured using a mapping ([#13747](https://github.com/KhulnaSoft/integrations-core/pull/13747))

## 2.18.2 / 2023-03-03 / Agent 7.44.0

***Fixed***:

* Fix leak due to a bug in `win32pdh.GetFormattedCouterArray()` ([#13901](https://github.com/KhulnaSoft/integrations-core/pull/13901))
* Change the performance counter used by the `iis.app_pool_up` service check so it can tell when the app pool is down ([#13734](https://github.com/KhulnaSoft/integrations-core/pull/13734))

## 2.18.1 / 2023-02-08 / Agent 7.42.2

***Fixed***:

* Fix IIS Check memory leaked due to a bug in win32pdh.GetFormattedCounterArray() ([#13897](https://github.com/KhulnaSoft/integrations-core/pull/13897))
...
* Remove http patch requests per second metric ([#11823](https://github.com/KhulnaSoft/integrations-core/pull/11823))
...
* Add `pyproject.toml` file ([#11373](https://github.com/KhulnaSoft/integrations-core/pull/11373))
...
* Add better filtering options ([#10775](https://github.com/KhulnaSoft/integrations-core/pull/10775))
* Add missing metric for the number of PATCH requests per second ([#10773](https://github.com/KhulnaSoft/integrations-core/pull/10773))
* Support new implementation of Windows performance counters on Python 3 ([#10546](https://github.com/KhulnaSoft/integrations-core/pull/10546))
...
* Add runtime configuration validation ([#8938](https://github.com/KhulnaSoft/integrations-core/pull/8938))

## 2.12.0 / 2021-08-02 / Agent 7.31.0

***Added***:

* Submit unknown iis counters ([#9807](https://github.com/KhulnaSoft/integrations-core/pull/9807))
...
* reuse base package refreshing ([#8823](https://github.com/KhulnaSoft/integrations-core/pull/8823))

## 2.10.5 / 2021-03-15

***Fixed***:

* Better recreate base class refreshing strategy ([#8821](https://github.com/KhulnaSoft/integrations-core/pull/8821))
...
* Add config specs ([#8109](https://github.com/KhulnaSoft/integrations-core/pull/8109))

## 2.10.2 / 2020-10-31 / Agent 7.24.0

***Fixed***:

* Fix metrics collection on non-english systems ([#7875](https://github.com/KhulnaSoft/integrations-core/pull/7875))

## 2.10.1 / 2020-08-19 / Agent 7.23.0

***Fixed***:

* Add debug lines on skipped metrics ([#7394](https://github.com/KhulnaSoft/integrations-core/pull/7394))
...
* Monitor application pools ([#6549](https://github.com/KhulnaSoft/integrations-core/pull/6549))
...
* Handle the refresh_counters flag ([#3840](https://github.com/KhulnaSoft/integrations-core/pull/3840))

## 2.5.0 / 2019-05-14

***Added***:

* Cosmetic cleanups ([#3706](https://github.com/KhulnaSoft/integrations-core/pull/3706))
* Adhere to code style ([#3521](https://github.com/KhulnaSoft/integrations-core/pull/3521))

## 2.4.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* adds `iis_host` tag to metrics ([#3294](https://github.com/KhulnaSoft/integrations-core/pull/3294))
...
* Support Python 3 ([#2999](https://github.com/KhulnaSoft/integrations-core/pull/2999))
...
* Fix 'attempted connection' metrics ([#1970](https://github.com/KhulnaSoft/integrations-core/pull/1970))
...
* Fixeded tag initialization & reporting ([#1185](https://github.com/KhulnaSoft/integrations-core/issues/1185))
...
* Use PDH instead of WMI to collect data. [#927](https://github.com/KhulnaSoft/integrations-core/issues/927)
