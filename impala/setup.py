...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'impala', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-impala',
    version=ABOUT['__version__'],
    description='The Impala check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent impala check',
    ...
    packages=['khulnasoft_checks.impala'],
