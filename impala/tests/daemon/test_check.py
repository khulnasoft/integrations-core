...
def test_daemon_mock_assert_metrics_using_metadata(dd_run_check, aggregator, daemon_check, mock_metrics):
...
@pytest.mark.unit
@pytest.mark.metrics_file("daemon", "metrics.txt")
def test_daemon_mock_assert_service_check(dd_run_check, aggregator, daemon_check, mock_metrics):
    dd_run_check(daemon_check)
...
@pytest.mark.unit
@pytest.mark.metrics_file("daemon", "metrics.txt")
def test_daemon_mock_assert_metrics(dd_run_check, aggregator, daemon_check, mock_metrics):
    dd_run_check(daemon_check)
