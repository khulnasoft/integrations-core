...
def test_daemon_check_integration_assert_metrics(dd_run_check, aggregator, daemon_check):
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_daemon_check_integration_assert_service_check(dd_run_check, aggregator, daemon_check):
    dd_run_check(daemon_check)
