...
def test_statestore_mock_assert_metrics_using_metadata(dd_run_check, aggregator, statestore_check, mock_metrics):
...
@pytest.mark.unit
@pytest.mark.metrics_file("statestore", "metrics.txt")
def test_statestore_mock_assert_service_check(dd_run_check, aggregator, statestore_check, mock_metrics):
    dd_run_check(statestore_check)
...
@pytest.mark.unit
@pytest.mark.metrics_file("statestore", "metrics.txt")
def test_statestore_mock_assert_metrics(dd_run_check, aggregator, statestore_check, mock_metrics):
    dd_run_check(statestore_check)
