...
def test_statestore_check_integration_assert_metrics(dd_run_check, aggregator, statestore_check):
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_statestore_check_integration_assert_service_check(dd_run_check, aggregator, statestore_check):
    dd_run_check(statestore_check)
