...
* Add additional Istio metrics ([#15820](https://github.com/KhulnaSoft/integrations-core/pull/15820))

## 5.1.0 / 2023-08-18 / Agent 7.48.0

***Added***:

* Add support for namespace in istio check ([#14611](https://github.com/KhulnaSoft/integrations-core/pull/14611))
...
* Add port for merged telemetry endpoint in Istio auto_conf ([#13204](https://github.com/KhulnaSoft/integrations-core/pull/13204))
...
* Add more tags to default exclude_labels and disable tag_by_endpoint in autoconf ([#11953](https://github.com/KhulnaSoft/integrations-core/pull/11953))
...
* Add image for OpenShift Service Mesh Proxy to ad_identifiers ([#11662](https://github.com/KhulnaSoft/integrations-core/pull/11662))
...
* Add `pyproject.toml` file ([#11374](https://github.com/KhulnaSoft/integrations-core/pull/11374))
...
* Support istio_agent metrics in sidecars ([#10702](https://github.com/KhulnaSoft/integrations-core/pull/10702))
...
* Update Istio to use OpenMetrics v2 by default ([#10304](https://github.com/KhulnaSoft/integrations-core/pull/10304))
...
* Enable exclude_labels and update documentation ([#10020](https://github.com/KhulnaSoft/integrations-core/pull/10020))
...
* Allow the use of the new OpenMetrics implementation ([#9588](https://github.com/KhulnaSoft/integrations-core/pull/9588))
...
* Add more pilot metrics ([#9337](https://github.com/KhulnaSoft/integrations-core/pull/9337)) Thanks [hari2192](https://github.com/hari2192).

***Fixed***:

* Bump base package requirement ([#9606](https://github.com/KhulnaSoft/integrations-core/pull/9606))
...
* Add runtime configuration validation ([#8939](https://github.com/KhulnaSoft/integrations-core/pull/8939))

## 3.10.0 / 2021-03-07 / Agent 7.27.0

***Added***:

* Add sidecar injection failed and skipped metrics ([#8751](https://github.com/KhulnaSoft/integrations-core/pull/8751))

## 3.9.1 / 2021-02-26

***Fixed***:

* Allow custom metrics for legacy istio ([#8700](https://github.com/KhulnaSoft/integrations-core/pull/8700))
...
* Update default port ([#7796](https://github.com/KhulnaSoft/integrations-core/pull/7796))
...
* Enable `send_monotonic_with_gauge` to submit mesh metrics as monotonic counts ([#5707](https://github.com/KhulnaSoft/integrations-core/pull/5707))

## 3.2.1 / 2020-05-22 / Agent 7.20.0

***Fixed***:

* Remove `destination_service` and `source_workload` from label blacklist ([#6712](https://github.com/KhulnaSoft/integrations-core/pull/6712))
...
* Add TCP mesh metrics mapping ([#6466](https://github.com/KhulnaSoft/integrations-core/pull/6466))

## 3.1.0 / 2020-04-23

***Added***:

* Add autodiscovery config and default tag exclusion ([#6375](https://github.com/KhulnaSoft/integrations-core/pull/6375))
* Support istiod metrics ([#6426](https://github.com/KhulnaSoft/integrations-core/pull/6426))
* Refactor to support different versions of istio ([#6360](https://github.com/KhulnaSoft/integrations-core/pull/6360))
* Add configuration template spec ([#6320](https://github.com/KhulnaSoft/integrations-core/pull/6320))
* Refactor check and support new Agent signature ([#6341](https://github.com/KhulnaSoft/integrations-core/pull/6341))

## 3.0.0 / 2020-04-04 / Agent 7.19.0

***Changed***:

* Blacklist metric `mcp_source.request_acks_total` due to high cardinality ([#6185](https://github.com/KhulnaSoft/integrations-core/pull/6185))
...
* Blacklist `galley_mcp_source_message_size_bytes` histogram ([#4433](https://github.com/KhulnaSoft/integrations-core/pull/4433))

## 2.4.1 / 2019-07-16 / Agent 6.13.0

***Fixed***:

* Comment out mixer and mesh by default from configuration ([#4121](https://github.com/KhulnaSoft/integrations-core/pull/4121))

## 2.4.0 / 2019-06-24

***Added***:

* Support citadel endpoint ([#3962](https://github.com/KhulnaSoft/integrations-core/pull/3962))

## 2.3.1 / 2019-06-19

***Fixed***:

* Istio Mixer and Mesh endpoints should be optional ([#3875](https://github.com/KhulnaSoft/integrations-core/pull/3875)) Thanks [mikekatica](https://github.com/mikekatica).

## 2.3.0 / 2019-05-31 / Agent 6.12.0

***Added***:

* Support pilot and galley metrics ([#3734](https://github.com/KhulnaSoft/integrations-core/pull/3734))

## 2.2.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3522](https://github.com/KhulnaSoft/integrations-core/pull/3522))

## 2.1.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#3014](https://github.com/KhulnaSoft/integrations-core/pull/3014))

***Fixed***:

* Update example config to match docs ([#3046](https://github.com/KhulnaSoft/integrations-core/pull/3046))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/1979
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2093
[3]: https://github.com/KhulnaSoft/integrations-core/pull/1993
[4]: https://github.com/bobbytables
[5]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[6]: https://github.com/KhulnaSoft/integrations-core/pull/1581
