...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "istio", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-istio',
    version=ABOUT["__version__"],
    description='The istio check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent istio check',
    ...
    packages=['khulnasoft_checks.istio'],
