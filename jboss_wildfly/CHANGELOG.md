...
* Correct metric_type for wildfly metrics ([#8706](https://github.com/KhulnaSoft/integrations-core/pull/8706)) Thanks [codylerum](https://github.com/codylerum).

***Added***:

* Add `pyproject.toml` file ([#11375](https://github.com/KhulnaSoft/integrations-core/pull/11375))
...
* Add runtime configuration validation ([#8940](https://github.com/KhulnaSoft/integrations-core/pull/8940))
...
* Add missing custom_jar_paths option to config ([#7809](https://github.com/KhulnaSoft/integrations-core/pull/7809))
...
* Fix service check name and add config spec ([#6225](https://github.com/KhulnaSoft/integrations-core/pull/6225))

***Fixed***:

* Remove logs sourcecategory ([#6121](https://github.com/KhulnaSoft/integrations-core/pull/6121))
* Various doc fixes ([#5944](https://github.com/KhulnaSoft/integrations-core/pull/5944))

## 1.1.1 / 2019-12-02 / Agent 7.16.0

***Fixed***:

* Update example config to require `username` and `password` ([#4445](https://github.com/KhulnaSoft/integrations-core/pull/4445))

## 1.1.0 / 2019-06-18 / Agent 6.13.0

***Added***:

* Add log setup and configuration ([#3672](https://github.com/KhulnaSoft/integrations-core/pull/3672))

## 1.0.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* JBoss/WildFly JMX Integration ([#3320](https://github.com/KhulnaSoft/integrations-core/pull/3320))
