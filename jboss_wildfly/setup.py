...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'jboss_wildfly', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-jboss_wildfly',
    version=ABOUT['__version__'],
    description='The JBoss/WildFly check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent jboss wildfly check',
    ...
    packages=['khulnasoft_checks.jboss_wildfly'],
