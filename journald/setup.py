...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'journald', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-journald',
    version=ABOUT['__version__'],
    description='The journald check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent journald check',
    ...
    packages=['khulnasoft_checks.journald'],
