...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kafka', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kafka',
    version=ABOUT['__version__'],
    description='The Kafka check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kafka check',
    ...
    packages=['khulnasoft_checks.kafka'],
