...
from khulnasoft_checks.kafka_consumer import KafkaCheck
...
def test_oauth_config(
    ...
    with expected_exception:
        with mock.patch(
            'khulnasoft_checks.kafka_consumer.kafka_consumer.KafkaClient',
...
@mock.patch("khulnasoft_checks.kafka_consumer.kafka_consumer.KafkaClient")
...
def test_when_empty_string_consumer_group_then_skip(kafka_instance):
    ...
    with mock.patch("khulnasoft_checks.kafka_consumer.client.AdminClient.list_consumer_groups", return_value=future):
