...
* Create `tag_not_null` type which doesn't set the tag when tag value is none ([#14503](https://github.com/KhulnaSoft/integrations-core/pull/14503))
...
* Add only_custom_queries option to database utils ([#10314](https://github.com/KhulnaSoft/integrations-core/pull/10314))
...
* Implements token reader for DC/OS Auth JWT token retrieval with login ([#7785](https://github.com/KhulnaSoft/integrations-core/pull/7785))
...
* Add service_identity dependency ([#3256](https://github.com/KhulnaSoft/integrations-core/pull/3256))
...
* Use 'format()' function to create device tag ([#2822](https://github.com/KhulnaSoft/integrations-core/pull/2822))
...
* Set requests stream option to false when scraping Prometheus endpoints ([#1596](https://github.com/KhulnaSoft/integrations-core/pull/1596))

***Fixed***:

* upgrade requests dependency ([#1734](https://github.com/KhulnaSoft/integrations-core/pull/1734))

## 1.3.0 / 2018-06-07

***Added***:

* Support for gathering metrics from prometheus endpoint for the kubelet itself. ([#1581](https://github.com/KhulnaSoft/integrations-core/pull/1581))
* include wmi for compat ([#1565](https://github.com/KhulnaSoft/integrations-core/pull/1565))
* added missing tailfile util ([#1566](https://github.com/KhulnaSoft/integrations-core/pull/1566))

***Fixed***:

* change default value of AgentCheck.check_id for Agent 6 ([#1652](https://github.com/KhulnaSoft/integrations-core/pull/1652))
* [base] when running A6, mirror logging behavior ([#1561](https://github.com/KhulnaSoft/integrations-core/pull/1561))
...
* Clean-up export for `PDHBaseCheck` + export `WinPDHCounter`. [#1183](https://github.com/KhulnaSoft/integrations-core/issues/1183)
