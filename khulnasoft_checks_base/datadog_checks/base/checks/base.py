...
if khulnasoft_agent.get_config('disable_unsafe_yaml'):
...
class AgentCheck(object):
    ...
    # See https://github.com/KhulnaSoft/integrations-core/pull/2093 for more information.
    ...
    def __init__(self, *args, **kwargs):
        ...
        # everywhere just yet. It's complicated... See: https://github.com/KhulnaSoft/integrations-core/pull/5573
        ...
        # `self.hostname` is deprecated, use `khulnasoft_agent.get_hostname()` instead
        self.hostname = khulnasoft_agent.get_hostname()  # type: str
    ...
    def check_version(self):
        ...
        if not hasattr(self, '_check_version'):
            # 'khulnasoft_checks.<PACKAGE>.<MODULE>...'
    ...
    def is_metadata_collection_enabled():
        # type: () -> bool
        return is_affirmative(khulnasoft_agent.get_config('enable_metadata_collection'))
    ...
    def read_persistent_cache(self, key):
        ...
        Parameters:
            ...
            key (str):
                the key to retrieve
        """
        return khulnasoft_agent.read_persistent_cache(self._persistent_cache_id(key))
    ...
    def write_persistent_cache(self, key, value):
        ...
        Parameters:
            ...
            value (str):
                the value to store
        """
        khulnasoft_agent.write_persistent_cache(self._persistent_cache_id(key), value)
    ...
    def set_external_tags(self, external_tags):
        ...
        try:
            ...
            khulnasoft_agent.set_external_tags(new_tags)
        except IndexError:
    ...
    def run(self):
        ...
        try:
            ...
            if is_affirmative(self.instance.get('process_isolation', self.init_config.get('process_isolation', False))):
                ...
                run_with_isolation(self, aggregator, khulnasoft_agent)
            else:
    ...
    def should_profile_memory(self):
        ...
        return 'profile_memory' in self.init_config or (
            khulnasoft_agent.tracemalloc_enabled() and should_profile_memory(khulnasoft_agent, self.name)
        )
