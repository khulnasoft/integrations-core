...
from khulnasoft_checks.base.utils.db.types import Transformer  # noqa: F401
from khulnasoft_checks.base.utils.serialization import json
from khulnasoft_checks.base.utils.tracing import INTEGRATION_TRACING_SERVICE_NAME, tracing_enabled
...
def resolve_db_host(db_host):
    agent_hostname = khulnasoft_agent.get_hostname()
...
def obfuscate_sql_with_metadata(query, options=None):
    ...
    statement = khulnasoft_agent.obfuscate_sql(query, options)
