...
from .constants import KNOWN_KHULNASOFT_AGENT_SETTER_METHODS, EnvVars


def run_with_isolation(check, aggregator, khulnasoft_agent):
    ...
    process = subprocess.Popen(
        [
            ...
            'from khulnasoft_checks.base.utils.replay.redirect import run_check;'
    ...
    with process:
        ...
        for line in iter(process.stdout.readline, b''):
            ...
            elif message_type == 'khulnasoft_agent':
                method = message['method']
                value = getattr(khulnasoft_agent, method)(*message['args'], **message['kwargs'])
                if method not in KNOWN_KHULNASOFT_AGENT_SETTER_METHODS:
