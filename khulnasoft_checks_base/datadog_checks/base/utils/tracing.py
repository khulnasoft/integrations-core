...
def tracing_enabled():
    ...
    """
    integration_tracing = is_affirmative(khulnasoft_agent.get_config('integration_tracing'))
    integration_tracing_exhaustive = is_affirmative(khulnasoft_agent.get_config('integration_tracing_exhaustive'))
