...
from khulnasoft_checks.base import ensure_bytes
from khulnasoft_checks.checks.openmetrics import OpenMetricsBaseCheck
...
def test_labels_not_added_as_tag_once_for_each_metric(
    ...
    # avoid regression on https://github.com/KhulnaSoft/dd-agent/pull/3359
    check.submit_openmetric(metric, ref_gauge, mocked_prometheus_scraper_config)
...
def test_metadata_default(mocked_openmetrics_check_factory, text_data, khulnasoft_agent):
...
def test_metadata_transformer(mocked_openmetrics_check_factory, text_data, khulnasoft_agent):
    instance = dict(OPENMETRICS_CHECK_INSTANCE)
...
def test_use_process_start_time(
    ...
    khulnasoft_agent.set_process_start_time(agent_start_time)
