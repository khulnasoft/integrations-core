...
from khulnasoft_checks.base.checks.kubelet_base.base import KubeletBase, urljoin
from khulnasoft_checks.base.utils.date import UTC
...
def test_compute_pod_expiration_datetime(monkeypatch):
    # Invalid input
    with mock.patch("khulnasoft_checks.base.checks.kubelet_base.base.get_config", return_value="") as p:
        assert KubeletBase.compute_pod_expiration_datetime() is None
        p.assert_called_with("kubernetes_pod_expiration_duration")

    with mock.patch("khulnasoft_checks.base.checks.kubelet_base.base.get_config", return_value="invalid"):
        assert KubeletBase.compute_pod_expiration_datetime() is None

    # Disabled
    with mock.patch("khulnasoft_checks.base.checks.kubelet_base.base.get_config", return_value="0"):
        assert KubeletBase.compute_pod_expiration_datetime() is None

    # Set to 15 minutes
    with mock.patch("khulnasoft_checks.base.checks.kubelet_base.base.get_config", return_value="900"):
