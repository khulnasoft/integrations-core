...
def test_config_digest_authtype():
    ...
    with mock.patch('khulnasoft_checks.base.utils.http.requests_auth.HTTPDigestAuth') as m:
...
def test_config_ntlm():
    ...
    with mock.patch('khulnasoft_checks.base.utils.http.requests_ntlm.HttpNtlmAuth') as m:
        RequestsWrapper(instance, init_config)
...
def test_config_aws():
    ...
    with mock.patch('khulnasoft_checks.base.utils.http.requests_aws.BotoAWSRequestsAuth') as m:
        RequestsWrapper(instance, init_config)
