...
from khulnasoft_checks.base.utils.http import RequestsWrapper
from khulnasoft_checks.base.utils.time import get_timestamp
from khulnasoft_checks.dev import TempDir
from khulnasoft_checks.dev.fs import read_file, write_file
...
class TestAuthTokenDCOSReaderCreation:
    ...
    def test_private_key_path_missing(self):
        instance = {
            'auth_token': {
                'reader': {'type': 'dcos_auth', 'login_url': 'https://example.com', 'service_account': 'khulnasoft_agent'},
                'writer': {'type': 'header'},
            }
        }
        init_config = {}
        ...
        instance = {
            'auth_token': {
                'reader': {
                    ...
                    'service_account': 'khulnasoft_agent',
                    'private_key_path': {},
                },
                'writer': {'type': 'header'},
            }
