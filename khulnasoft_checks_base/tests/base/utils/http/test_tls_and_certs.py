...
class TestAIAChasing:
    ...
    def test_fetch_intermediate_certs(self, port):
        ...
        with mock.patch('khulnasoft_checks.base.utils.http.create_socket_connection') as mock_create_socket_connection:
            with mock.patch('khulnasoft_checks.base.utils.http.RequestsWrapper.handle_auth_token'):
