...
from khulnasoft_checks.base.utils.time import (
    EPOCH,
    UTC,
...
class TestCurrentDatetime:
    ...
    def test_default_utc(self, mocker):
        datetime_obj = mocker.patch('khulnasoft_checks.base.utils.time.datetime')
...
class TestTimestamp:
    ...
    def test_default(self, mocker):
        time_time = mocker.patch('khulnasoft_checks.base.utils.time.epoch_offset')
        get_timestamp()
