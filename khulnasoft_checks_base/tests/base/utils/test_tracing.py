...
from khulnasoft_checks.base.stubs import aggregator
from khulnasoft_checks.base.utils.tracing import (
...
def test_traced_class(integration_tracing, integration_tracing_exhaustive, khulnasoft_agent):
    def _get_config(key):
        return {
    ...
    with mock.patch.object(khulnasoft_agent, 'get_config', _get_config), mock.patch('ddtrace.tracer') as tracer:
