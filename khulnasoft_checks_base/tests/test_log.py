...
from khulnasoft_checks import log
from khulnasoft_checks.base import AgentCheck
from khulnasoft_checks.base.log import DEFAULT_FALLBACK_LOGGER, CheckLogFormatter, get_check_logger, init_logging
...
def test_log_trace_context_injection(integration_tracing_enabled):
    ...
    with mock.patch('khulnasoft_checks.base.log.tracing_enabled', _tracing_enabled):
