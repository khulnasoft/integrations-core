...
from khulnasoft_checks.base import AgentCheck, ensure_bytes, ensure_unicode

SET_CHECK_METADATA_METHOD = 'khulnasoft_checks.base.stubs.khulnasoft_agent.set_check_metadata'
...
class TestAttribute:
    ...
    def test_no_check_id_error(self):
        ...
        with mock.patch('khulnasoft_checks.base.checks.base.using_stub_aggregator', False):
...
class TestMetadataEntrypoint:
    def test_no_op_if_collection_disabled(self, khulnasoft_agent):
        # type: () -> None
