...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'khulnasoft_checks_dependency_provider', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-khulnasoft_checks_dependency_provider',
    version=ABOUT['__version__'],
    description='The khulnasoft_checks_dependency_provider check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent khulnasoft_checks_dependency_provider check',
    ...
    packages=['khulnasoft_checks.khulnasoft_checks_dependency_provider'],
