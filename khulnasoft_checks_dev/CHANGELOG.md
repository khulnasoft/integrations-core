...
* Add short hand for force-env-rebuild ([#15716](https://github.com/KhulnaSoft/integrations-core/pull/15716))
...
* Update templates for new integrations ([#12744](https://github.com/KhulnaSoft/integrations-core/pull/12744))
...
* Make log_patterns match all logs ([#12623](https://github.com/KhulnaSoft/integrations-core/pull/12623))
...
* Fix IBM ACE validation ([#11964](https://github.com/KhulnaSoft/integrations-core/pull/11964))
...
* Allow setting DD_SITE in org config ([#10285](https://github.com/KhulnaSoft/integrations-core/pull/10285))
...
* Fix `meta dash export` ([#9652](https://github.com/KhulnaSoft/integrations-core/pull/9652))
...
* Stop collecting empty coverage reports for non-Python checks ([#9297](https://github.com/KhulnaSoft/integrations-core/pull/9297))
...
* Fix validation of Agent deps when using single check ([#8461](https://github.com/KhulnaSoft/integrations-core/pull/8461))
...
* Fix new Check template ([#6811](https://github.com/KhulnaSoft/integrations-core/pull/6811))
...
* Include uncommitted git files to files_changed ([#6480](https://github.com/KhulnaSoft/integrations-core/pull/6480))
* Add constant for jmx default metrics ([#6507](https://github.com/KhulnaSoft/integrations-core/pull/6507))
* Make integration template adhere to file name conventions ([#6493](https://github.com/KhulnaSoft/integrations-core/pull/6493))
...
* Update `release make` to avoid committing new files ([#6263](https://github.com/KhulnaSoft/integrations-core/pull/6263))
* Add validation for per_unit_name and line numbers for all errors ([#6394](https://github.com/KhulnaSoft/integrations-core/pull/6394))
* Validate metrics using metadata.csv ([#6027](https://github.com/KhulnaSoft/integrations-core/pull/6027))
* Add verbose mode to validate config ([#6302](https://github.com/KhulnaSoft/integrations-core/pull/6302))
* Validate metadata doesn't contain `|` ([#6333](https://github.com/KhulnaSoft/integrations-core/pull/6333))

***Fixed***:

* Fix style to account for new flake8 rules ([#6620](https://github.com/KhulnaSoft/integrations-core/pull/6620))
* Fix typo in README template for new community integrations ([#6585](https://github.com/KhulnaSoft/integrations-core/pull/6585))
* Remove metrics file from JMX template's config spec ([#6559](https://github.com/KhulnaSoft/integrations-core/pull/6559))
* Remove `dd_check_types` from check template ([#6460](https://github.com/KhulnaSoft/integrations-core/pull/6460))
* Remove `metrics.yaml` from non testable files ([#6280](https://github.com/KhulnaSoft/integrations-core/pull/6280))
* Hide openmetrics template options that are typically overridden ([#6338](https://github.com/KhulnaSoft/integrations-core/pull/6338))

## 3.5.0 / 2020-04-14

***Added***:

* Update documentation links in new integration templates ([#6294](https://github.com/KhulnaSoft/integrations-core/pull/6294))
* Add validation for Unicode characters in metric metadata ([#6318](https://github.com/KhulnaSoft/integrations-core/pull/6318))
* Add default template to openmetrics & jmx config ([#6328](https://github.com/KhulnaSoft/integrations-core/pull/6328))
* Add config spec ability to control whether options are enabled by default ([#6322](https://github.com/KhulnaSoft/integrations-core/pull/6322))
* Allow `dd_environment` fixtures to accept arbitrary arguments ([#6306](https://github.com/KhulnaSoft/integrations-core/pull/6306))

## 3.4.0 / 2020-04-08

***Added***:

* Add Container App team to ddev trello tool ([#6268](https://github.com/KhulnaSoft/integrations-core/pull/6268))
...
* Fix e2e config ([#6261](https://github.com/KhulnaSoft/integrations-core/pull/6261))

## 3.3.0 / 2020-04-04

***Added***:

* Allow arbitrary repos in CLI config ([#6254](https://github.com/KhulnaSoft/integrations-core/pull/6254))
...
* Add OpenMetrics config spec template ([#6142](https://github.com/KhulnaSoft/integrations-core/pull/6142))
* Add validation for checks to not use the legacy agent signature ([#6086](https://github.com/KhulnaSoft/integrations-core/pull/6086))
* Validate `metric_to_check` is listed in `metadata.csv` ([#6170](https://github.com/KhulnaSoft/integrations-core/pull/6170))
* Add `display_priority` to config spec ([#6229](https://github.com/KhulnaSoft/integrations-core/pull/6229))
* Add `jmx_url` to JMX config spec template ([#6230](https://github.com/KhulnaSoft/integrations-core/pull/6230))
* Trigger CI if contents of `tests/` changes ([#6223](https://github.com/KhulnaSoft/integrations-core/pull/6223))
* Add `service_check_prefix` config to jmx ([#6163](https://github.com/KhulnaSoft/integrations-core/pull/6163))
* Consider log collection for `meta catalog` ([#6191](https://github.com/KhulnaSoft/integrations-core/pull/6191))
* Add metadata to integrations catalog ([#6169](https://github.com/KhulnaSoft/integrations-core/pull/6169))
* Add `default` value field for config specs ([#6178](https://github.com/KhulnaSoft/integrations-core/pull/6178))
* Add utility for temporarily stopping Docker services ([#5715](https://github.com/KhulnaSoft/integrations-core/pull/5715))
* Add `ddev test` option to verify support of new metrics ([#6141](https://github.com/KhulnaSoft/integrations-core/pull/6141))

***Fixed***:

* Add `send_distribution_sums_as_monotonic` to openmetrics config spec ([#6247](https://github.com/KhulnaSoft/integrations-core/pull/6247))
* Include moved files to changed files for testing purposes ([#6174](https://github.com/KhulnaSoft/integrations-core/pull/6174))

## 3.2.0 / 2020-03-24

***Added***:

* Use Trello for QA release script ([#6125](https://github.com/KhulnaSoft/integrations-core/pull/6125))
* Add script to resolve username from email ([#6099](https://github.com/KhulnaSoft/integrations-core/pull/6099))
* Add validation to catch legacy imports ([#6081](https://github.com/KhulnaSoft/integrations-core/pull/6081))
* Upgrade and pin mypy to 0.770 ([#6090](https://github.com/KhulnaSoft/integrations-core/pull/6090))
* Add config spec option for compact YAML representations of nested arrays ([#6082](https://github.com/KhulnaSoft/integrations-core/pull/6082))
* Order changelog entries by type ([#5995](https://github.com/KhulnaSoft/integrations-core/pull/5995))
* Upgrade virtualenv to 20.0.8 ([#5980](https://github.com/KhulnaSoft/integrations-core/pull/5980))
* Add config spec templates for JMX integrations ([#5978](https://github.com/KhulnaSoft/integrations-core/pull/5978))
...
* Remove reference to check in logs-only template ([#6106](https://github.com/KhulnaSoft/integrations-core/pull/6106))
* Fix pathing issues with CI setup script ([#6100](https://github.com/KhulnaSoft/integrations-core/pull/6100))
* Bump classifiers ([#6083](https://github.com/KhulnaSoft/integrations-core/pull/6083))
* Make aggregator stub support multiple jmx instances ([#5966](https://github.com/KhulnaSoft/integrations-core/pull/5966))

## 3.1.0 / 2020-03-02

***Added***:

* Handle logs only integrations for legacy config validator ([#5900](https://github.com/KhulnaSoft/integrations-core/pull/5900))
* Allow excluding specific checks when performing bulk releases ([#5878](https://github.com/KhulnaSoft/integrations-core/pull/5878))

***Fixed***:

* Pin virtualenv to 20.0.5 ([#5891](https://github.com/KhulnaSoft/integrations-core/pull/5891))
* Fix E2E parsing of JMX collector output ([#5849](https://github.com/KhulnaSoft/integrations-core/pull/5849))

## 3.0.0 / 2020-02-22

***Changed***:

* Switch to comparing between arbitrary tags/release branches to `ddev release testable` ([#5556](https://github.com/KhulnaSoft/integrations-core/pull/5556))

***Added***:

* Add `service` option to default configuration ([#5805](https://github.com/KhulnaSoft/integrations-core/pull/5805))
* Add ability for config templates to reference other templates ([#5804](https://github.com/KhulnaSoft/integrations-core/pull/5804))
* Better error messages on config specs errors ([#5763](https://github.com/KhulnaSoft/integrations-core/pull/5763))
* Add an option to skip environment creation for tests ([#5760](https://github.com/KhulnaSoft/integrations-core/pull/5760))
* Create an integration catalog command in ddev ([#5660](https://github.com/KhulnaSoft/integrations-core/pull/5660))
* Add tag_prefix argument to the changelog command ([#5741](https://github.com/KhulnaSoft/integrations-core/pull/5741))
* Add type checking to integration check template ([#5711](https://github.com/KhulnaSoft/integrations-core/pull/5711))
* Refactor root initialization to common utils ([#5705](https://github.com/KhulnaSoft/integrations-core/pull/5705))
* Add `agent_requirements.in` to non testable files ([#5693](https://github.com/KhulnaSoft/integrations-core/pull/5693))
* Add git dep support to dep validation cmd ([#5692](https://github.com/KhulnaSoft/integrations-core/pull/5692))
* Add support for tab completion to CLI ([#5674](https://github.com/KhulnaSoft/integrations-core/pull/5674))
* Upgrade virtualenv dependency to 20.x ([#5680](https://github.com/KhulnaSoft/integrations-core/pull/5680))

***Fixed***:

* Fix error when scrubbing non-org secrets ([#5827](https://github.com/KhulnaSoft/integrations-core/pull/5827))
* Switch to Python 3.8 in check integration template ([#5717](https://github.com/KhulnaSoft/integrations-core/pull/5717))
* Switch to Agent 6+ signature in check integration test ([#5718](https://github.com/KhulnaSoft/integrations-core/pull/5718))

## 2.4.0 / 2020-02-05

***Added***:

* Upgrade coverage dependency ([#5647](https://github.com/KhulnaSoft/integrations-core/pull/5647))

## 2.3.0 / 2020-02-05

***Added***:

* Move CI setup script to ddev ([#5651](https://github.com/KhulnaSoft/integrations-core/pull/5651))
* Add `internal` to repo choices ([#5649](https://github.com/KhulnaSoft/integrations-core/pull/5649))
* Move remaining flake8 config to .flake8 ([#5635](https://github.com/KhulnaSoft/integrations-core/pull/5635))

## 2.2.0 / 2020-02-04

***Added***:

* Ignore `__path__` for type hinting of all integrations ([#5639](https://github.com/KhulnaSoft/integrations-core/pull/5639))
* Modify QA release script to create Jira issues instead of Trello cards ([#5457](https://github.com/KhulnaSoft/integrations-core/pull/5457))
* Add script to remove all labels from an issue or pull request ([#5636](https://github.com/KhulnaSoft/integrations-core/pull/5636))
* Always pass PROGRAM* to tox ([#5631](https://github.com/KhulnaSoft/integrations-core/pull/5631))
* Add meta command to upgrade the Python version of all test environments ([#5616](https://github.com/KhulnaSoft/integrations-core/pull/5616))
* Use the latest beta release of virtualenv for performance improvements ([#5617](https://github.com/KhulnaSoft/integrations-core/pull/5617))
* Add type checking support to Tox plugin ([#5595](https://github.com/KhulnaSoft/integrations-core/pull/5595))
* Update `validate agent-reqs` cmd to list unreleased checks ([#5610](https://github.com/KhulnaSoft/integrations-core/pull/5610))
* Allow specifying `release changelog` output file ([#5608](https://github.com/KhulnaSoft/integrations-core/pull/5608))
* Allow --help for `run` command ([#5602](https://github.com/KhulnaSoft/integrations-core/pull/5602))
* Update in-toto and its deps ([#5599](https://github.com/KhulnaSoft/integrations-core/pull/5599))

***Fixed***:

* Stop mounting the docker socket to allow jmx tests to pass ([#5601](https://github.com/KhulnaSoft/integrations-core/pull/5601))

## 2.1.0 / 2020-01-30

***Added***:

* Support CI validation for internal repo ([#5567](https://github.com/KhulnaSoft/integrations-core/pull/5567))
* Make new integrations use config specs ([#5580](https://github.com/KhulnaSoft/integrations-core/pull/5580))
* Add --org-name/-o to `env start` ([#5458](https://github.com/KhulnaSoft/integrations-core/pull/5458))
* Add some helpful output to ddev env ls command ([#5576](https://github.com/KhulnaSoft/integrations-core/pull/5576))
* Add Networks and Processes teams in ddev trello tool ([#5560](https://github.com/KhulnaSoft/integrations-core/pull/5560))

***Fixed***:

* Fix metric validation ([#5581](https://github.com/KhulnaSoft/integrations-core/pull/5581))
* Avoid long break in error message ([#5575](https://github.com/KhulnaSoft/integrations-core/pull/5575))

## 2.0.0 / 2020-01-27

***Changed***:

* Remove Python 2 support from CLI ([#5512](https://github.com/KhulnaSoft/integrations-core/pull/5512))

***Added***:

* Add validation for CI infrastructure configuration ([#5479](https://github.com/KhulnaSoft/integrations-core/pull/5479))
* Upgrade dependencies ([#5528](https://github.com/KhulnaSoft/integrations-core/pull/5528))
* Add service check name validator and sync ([#5501](https://github.com/KhulnaSoft/integrations-core/pull/5501))
* Run flake8 after formatting fixes ([#5492](https://github.com/KhulnaSoft/integrations-core/pull/5492))
* Add meta command to convert metadata.csv files to Markdown tables ([#5461](https://github.com/KhulnaSoft/integrations-core/pull/5461))

***Fixed***:

* Add support for in-toto >= 0.4.2 ([#5497](https://github.com/KhulnaSoft/integrations-core/pull/5497))

## 1.4.0 / 2020-01-13

***Added***:

* Validate metric names normalization in metadata.csv ([#5437](https://github.com/KhulnaSoft/integrations-core/pull/5437))

***Fixed***:

* Fix function call for `release testable` ([#5432](https://github.com/KhulnaSoft/integrations-core/pull/5432))

## 1.3.0 / 2020-01-09

***Added***:

* Add debug option to base ddev command ([#5386](https://github.com/KhulnaSoft/integrations-core/pull/5386))
* Add meta command to translate MIB names to OIDs in SNMP profiles ([#5397](https://github.com/KhulnaSoft/integrations-core/pull/5397))
* Update license years in integration templates ([#5384](https://github.com/KhulnaSoft/integrations-core/pull/5384))

***Fixed***:

* Fix a few style lints to handle Python 2 ([#5389](https://github.com/KhulnaSoft/integrations-core/pull/5389))

## 1.2.0 / 2019-12-31

***Changed***:

* Change `wrapper` arg for environment runners to `wrappers` ([#5361](https://github.com/KhulnaSoft/integrations-core/pull/5361))

***Added***:

* Add mechanism to cross-mount temporary log files between containers ([#5346](https://github.com/KhulnaSoft/integrations-core/pull/5346))

## 1.1.0 / 2019-12-27

***Added***:

* Refactor terraform configs ([#5339](https://github.com/KhulnaSoft/integrations-core/pull/5339))
* Make configuration specs an asset ([#5337](https://github.com/KhulnaSoft/integrations-core/pull/5337))
* Add meta command to export dashboards ([#5332](https://github.com/KhulnaSoft/integrations-core/pull/5332))
* Make changes and changelog command work with other repos ([#5331](https://github.com/KhulnaSoft/integrations-core/pull/5331))
* Decrease default verbosity of tracebacks in pytest ([#5291](https://github.com/KhulnaSoft/integrations-core/pull/5291))
* Add more global utilities the pytest plugin ([#5283](https://github.com/KhulnaSoft/integrations-core/pull/5283))
* Display Docker Compose logs when test environment fails to start ([#5258](https://github.com/KhulnaSoft/integrations-core/pull/5258))
* Implement configuration specifications ([#5072](https://github.com/KhulnaSoft/integrations-core/pull/5072))
* Add support for switching between multiple orgs' API/APP keys ([#5197](https://github.com/KhulnaSoft/integrations-core/pull/5197))

***Fixed***:

* Always pass USERNAME to tox ([#5335](https://github.com/KhulnaSoft/integrations-core/pull/5335))
* Fix agent status with ddev ([#5293](https://github.com/KhulnaSoft/integrations-core/pull/5293))
* Remove command to validate Python 3 compatibility ([#5246](https://github.com/KhulnaSoft/integrations-core/pull/5246))
* Pin coverage to 4.5.4 ([#5224](https://github.com/KhulnaSoft/integrations-core/pull/5224))

## 1.0.1 / 2019-12-06

***Fixed***:

* Fix a bug where we accidentally recorded git-ignored files in in-toto ([#5129](https://github.com/KhulnaSoft/integrations-core/pull/5129))

## 1.0.0 / 2019-12-02

***Changed***:

* Remove logos folder from template ([#4988](https://github.com/KhulnaSoft/integrations-core/pull/4988))
* Remove logo validation ([#4964](https://github.com/KhulnaSoft/integrations-core/pull/4964))

***Added***:

* Support downloading universal and pure Python wheels ([#4981](https://github.com/KhulnaSoft/integrations-core/pull/4981))
* Support more metric types for `ddev meta prom` ([#5071](https://github.com/KhulnaSoft/integrations-core/pull/5071))
* Improve prompts in `ddev clean` ([#5061](https://github.com/KhulnaSoft/integrations-core/pull/5061))
* Add command to navigate to config directory ([#5054](https://github.com/KhulnaSoft/integrations-core/pull/5054))
* Use a stub class for metadata testing ([#4919](https://github.com/KhulnaSoft/integrations-core/pull/4919))
* Add saved_views metadata field to integration templates ([#4584](https://github.com/KhulnaSoft/integrations-core/pull/4584))

***Fixed***:

* Handle formatting edge cases for `meta changes` ([#4970](https://github.com/KhulnaSoft/integrations-core/pull/4970))
* Never sign an empty release ([#4933](https://github.com/KhulnaSoft/integrations-core/pull/4933))
* Update requirements when updating check ([#4895](https://github.com/KhulnaSoft/integrations-core/pull/4895))

## 0.39.0 / 2019-10-25

***Added***:

* Add junit option to `ddev env e2e` command ([#4879](https://github.com/KhulnaSoft/integrations-core/pull/4879))

***Fixed***:

* Change the team label map for Trello card creation ([#4852](https://github.com/KhulnaSoft/integrations-core/pull/4852))
* Update metadata link in template ([#4869](https://github.com/KhulnaSoft/integrations-core/pull/4869))

## 0.38.3 / 2019-10-17

***Fixed***:

* Fix CHANGELOG.md template to make it work with `ddev release changelog` ([#4808](https://github.com/KhulnaSoft/integrations-core/pull/4808))

## 0.38.2 / 2019-10-17

***Fixed***:

* Handle the case of pylint returning empty output ([#4801](https://github.com/KhulnaSoft/integrations-core/pull/4801))

## 0.38.1 / 2019-10-15

***Fixed***:

* Fix ddev testable command to properly use the tag, fallback on the branch if absent ([#4775](https://github.com/KhulnaSoft/integrations-core/pull/4775))
...
* Add flake8-logging-format ([#4711](https://github.com/KhulnaSoft/integrations-core/pull/4711))

***Fixed***:

* Fix lint flake8-logging-format command ([#4728](https://github.com/KhulnaSoft/integrations-core/pull/4728))

## 0.37.0 / 2019-10-09

***Added***:

* Increase default Agent flush timeout ([#4714](https://github.com/KhulnaSoft/integrations-core/pull/4714))

***Fixed***:

* Remove default version from env test ([#4718](https://github.com/KhulnaSoft/integrations-core/pull/4718))
* Handle other Agent images in E2E ([#4710](https://github.com/KhulnaSoft/integrations-core/pull/4710))

## 0.36.0 / 2019-10-07

***Added***:

* Update teams in ddev trello tool ([#4702](https://github.com/KhulnaSoft/integrations-core/pull/4702))
* Add dashboard validation ([#4694](https://github.com/KhulnaSoft/integrations-core/pull/4694))

***Fixed***:

* Don't use a7 ([#4680](https://github.com/KhulnaSoft/integrations-core/pull/4680))

## 0.35.1 / 2019-09-30

***Fixed***:

* Auto detect changes and run tests when yaml files change ([#4657](https://github.com/KhulnaSoft/integrations-core/pull/4657))
...
* Improve RetryError message ([#4619](https://github.com/KhulnaSoft/integrations-core/pull/4619))
* Reload environments if there are extra startup commands ([#4614](https://github.com/KhulnaSoft/integrations-core/pull/4614))
* Add warning to create command if name is lowercase ([#4564](https://github.com/KhulnaSoft/integrations-core/pull/4564))

## 0.33.0 / 2019-09-19

***Added***:

* Update tooling for Azure Pipelines ([#4536](https://github.com/KhulnaSoft/integrations-core/pull/4536))

***Fixed***:

* Stop identifying core vs extras from the working directory name ([#4583](https://github.com/KhulnaSoft/integrations-core/pull/4583))

## 0.32.0 / 2019-08-24

***Added***:

* Don't fail e2e on unsupported platforms ([#4398](https://github.com/KhulnaSoft/integrations-core/pull/4398))
* Add K8S e2e util ([#4203](https://github.com/KhulnaSoft/integrations-core/pull/4203))
* Add SSH port forward e2e util ([#4147](https://github.com/KhulnaSoft/integrations-core/pull/4147))
* Deployment environment with Terraform ([#4039](https://github.com/KhulnaSoft/integrations-core/pull/4039))
* Support Python 3 when calling pip for extra E2E start up commands ([#4213](https://github.com/KhulnaSoft/integrations-core/pull/4213))
* Make `docker_run` clean up volumes and orphaned containers ([#4212](https://github.com/KhulnaSoft/integrations-core/pull/4212))
* Allow multiple docker Agents to coexist for E2E by randomly assigning ports ([#4205](https://github.com/KhulnaSoft/integrations-core/pull/4205))
* Add docker_volumes option to E2E metadata ([#4178](https://github.com/KhulnaSoft/integrations-core/pull/4178))
* Add env check for jmx integrations ([#4146](https://github.com/KhulnaSoft/integrations-core/pull/4146))

***Fixed***:

* Use the new Python 2 / 3 Docker images ([#4246](https://github.com/KhulnaSoft/integrations-core/pull/4246))
* Don't put integer in environment ([#4234](https://github.com/KhulnaSoft/integrations-core/pull/4234))
* Use utcnow instead of now ([#4192](https://github.com/KhulnaSoft/integrations-core/pull/4192))

## 0.31.1 / 2019-07-19

***Fixed***:

* Fix get_current_agent_version sorting in ddev ([#4113](https://github.com/KhulnaSoft/integrations-core/pull/4113))

## 0.31.0 / 2019-07-13

***Added***:

* Add support for selecting an Agent build via environment ([#4112](https://github.com/KhulnaSoft/integrations-core/pull/4112))
* Add ways to control the colorization of output ([#4086](https://github.com/KhulnaSoft/integrations-core/pull/4086))
* Support multiple Python versions for E2E ([#4075](https://github.com/KhulnaSoft/integrations-core/pull/4075))

## 0.30.1 / 2019-07-04

***Fixed***:

* Fix metadata bootstrap workflow ([#4047](https://github.com/KhulnaSoft/integrations-core/pull/4047))

## 0.30.0 / 2019-07-04

***Added***:

* Remove timeout when stopping containers ([#3973](https://github.com/KhulnaSoft/integrations-core/pull/3973))

***Fixed***:

* Update wording on installing extras in ddev create command ([#4032](https://github.com/KhulnaSoft/integrations-core/pull/4032))

## 0.29.0 / 2019-06-24

***Added***:

* Only sign updated checks ([#3944](https://github.com/KhulnaSoft/integrations-core/pull/3944))

## 0.28.0 / 2019-06-19

***Added***:

* Print line number on validate metadata ([#3931](https://github.com/KhulnaSoft/integrations-core/pull/3931))
...
* Allow releasing multiple checks at once ([#3881](https://github.com/KhulnaSoft/integrations-core/pull/3881))

***Fixed***:

* Validate interval in metadata validation ([#3857](https://github.com/KhulnaSoft/integrations-core/pull/3857))

## 0.26.1 / 2019-06-05

***Fixed***:

* Fix JMX template ([#3879](https://github.com/KhulnaSoft/integrations-core/pull/3879))
* Update APM team label ([#3878](https://github.com/KhulnaSoft/integrations-core/pull/3878))
* Fix logic to skip docs PRs for release testing ([#3877](https://github.com/KhulnaSoft/integrations-core/pull/3877))

## 0.26.0 / 2019-06-01

***Added***:

* Better error message when releasing on the wrong branch ([#3832](https://github.com/KhulnaSoft/integrations-core/pull/3832))

## 0.25.2 / 2019-05-28

***Fixed***:

* Fix tox plugin ([#3825](https://github.com/KhulnaSoft/integrations-core/pull/3825))

## 0.25.1 / 2019-05-24

***Fixed***:

* Use safe default when validating manifests ([#3810](https://github.com/KhulnaSoft/integrations-core/pull/3810))

## 0.25.0 / 2019-05-20

***Added***:

* Move all assets to a dedicated directory ([#3768](https://github.com/KhulnaSoft/integrations-core/pull/3768))
...
* Ambari integration ([#3670](https://github.com/KhulnaSoft/integrations-core/pull/3670))
* Fail if service check file doesn't exist ([#3691](https://github.com/KhulnaSoft/integrations-core/pull/3691))
* Add default service check file to new checks templates ([#3726](https://github.com/KhulnaSoft/integrations-core/pull/3726))
* Adds ddev YAML config validator ([#3679](https://github.com/KhulnaSoft/integrations-core/pull/3679))
...
* Remove spurious debug line ([#3703](https://github.com/KhulnaSoft/integrations-core/pull/3703))

## 0.23.1 / 2019-04-30

***Fixed***:

* Fix creation of jmx & tile integrations ([#3701](https://github.com/KhulnaSoft/integrations-core/pull/3701))
* Fix template for new integration to use argument as display name ([#3664](https://github.com/KhulnaSoft/integrations-core/pull/3664))

## 0.23.0 / 2019-04-22

***Removed***:

* Remove `pre` from versioning scheme ([#3655](https://github.com/KhulnaSoft/integrations-core/pull/3655))

***Added***:

* Add extra type for manifest validation ([#3662](https://github.com/KhulnaSoft/integrations-core/pull/3662))
* Adhere to code style ([#3497](https://github.com/KhulnaSoft/integrations-core/pull/3497))

***Fixed***:

* Fix changelog generation for new checks ([#3634](https://github.com/KhulnaSoft/integrations-core/pull/3634))

## 0.22.0 / 2019-04-15

***Added***:

* Build releases automatically ([#3364](https://github.com/KhulnaSoft/integrations-core/pull/3364))
* Add validation on integration_id ([#3598](https://github.com/KhulnaSoft/integrations-core/pull/3598))
...
* Fixed language in template for integration extras readme ([#3606](https://github.com/KhulnaSoft/integrations-core/pull/3606))
* Ensure style envs support every platform ([#3482](https://github.com/KhulnaSoft/integrations-core/pull/3482))
* Fix breakpoint agent check flag ([#3447](https://github.com/KhulnaSoft/integrations-core/pull/3447))
...
* Remove flake8 from tox.ini template ([#3358](https://github.com/KhulnaSoft/integrations-core/pull/3358))
* Support all options for the Agent check command ([#3350](https://github.com/KhulnaSoft/integrations-core/pull/3350))
* Add ability to detect if using JMX based on metadata ([#3330](https://github.com/KhulnaSoft/integrations-core/pull/3330))
* Add style checker and formatter ([#3299](https://github.com/KhulnaSoft/integrations-core/pull/3299))
* Add env var support to E2E containers ([#3263](https://github.com/KhulnaSoft/integrations-core/pull/3263))
* Enforce new integration_id field ([#3264](https://github.com/KhulnaSoft/integrations-core/pull/3264))
* Add row length validation ([#3266](https://github.com/KhulnaSoft/integrations-core/pull/3266))
* Add logo validation ([#3246](https://github.com/KhulnaSoft/integrations-core/pull/3246))
* Default to Python 3.7 for new checks ([#3244](https://github.com/KhulnaSoft/integrations-core/pull/3244))

***Fixed***:

* Make the aggregator fixture lazily import the stub ([#3308](https://github.com/KhulnaSoft/integrations-core/pull/3308))
* Fix sdist build command ([#3252](https://github.com/KhulnaSoft/integrations-core/pull/3252))

## 0.19.1 / 2019-03-01

***Fixed***:

* Run upload command in the proper location ([#3239](https://github.com/KhulnaSoft/integrations-core/pull/3239))

## 0.19.0 / 2019-03-01

***Added***:

* Add integration_id to manifest validation ([#3232](https://github.com/KhulnaSoft/integrations-core/pull/3232))
* Add ability to pass -m & -k to pytest ([#3163](https://github.com/KhulnaSoft/integrations-core/pull/3163))
* Provide a way to update to the new agent build config format ([#3181](https://github.com/KhulnaSoft/integrations-core/pull/3181))
* Support khulnasoft_checks_downloader ([#3164](https://github.com/KhulnaSoft/integrations-core/pull/3164))
* Add util to load jmx metric configs ([#3162](https://github.com/KhulnaSoft/integrations-core/pull/3162))
...
* Update e2e start help text for extras integrations ([#3133](https://github.com/KhulnaSoft/integrations-core/pull/3133))
* Fix e2e package install order ([#3092](https://github.com/KhulnaSoft/integrations-core/pull/3092))
...
* Ensure new checks use editable install of khulnasoft_checks_base for tests ([#2427][39])
...
* Move khulnasoft_checks_base code into sub base package ([#2167][67])
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2854
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2879
[3]: https://github.com/KhulnaSoft/integrations-core/pull/2878
[4]: https://github.com/KhulnaSoft/integrations-core/pull/2816
[5]: https://github.com/KhulnaSoft/integrations-core/pull/2764
[6]: https://github.com/KhulnaSoft/integrations-core/pull/2808
[7]: https://github.com/KhulnaSoft/integrations-core/pull/2794
[8]: https://github.com/KhulnaSoft/integrations-core/pull/2736
[9]: https://github.com/KhulnaSoft/integrations-core/pull/2746
[10]: https://github.com/KhulnaSoft/integrations-core/pull/2782
[11]: https://github.com/KhulnaSoft/integrations-core/pull/2771
[12]: https://github.com/KhulnaSoft/integrations-core/pull/2765
[13]: https://github.com/KhulnaSoft/integrations-core/pull/2759
[14]: https://github.com/KhulnaSoft/integrations-core/pull/2724
[15]: https://github.com/KhulnaSoft/integrations-core/pull/2689
[16]: https://github.com/KhulnaSoft/integrations-core/pull/2664
[17]: https://github.com/KhulnaSoft/integrations-core/pull/2645
[18]: https://github.com/KhulnaSoft/integrations-core/pull/2647
[19]: https://github.com/KhulnaSoft/integrations-core/pull/2641
[20]: https://github.com/KhulnaSoft/integrations-core/pull/2642
[21]: https://github.com/KhulnaSoft/integrations-core/pull/2613
[22]: https://github.com/KhulnaSoft/integrations-core/pull/2617
[23]: https://github.com/KhulnaSoft/integrations-core/pull/2600
[24]: https://github.com/KhulnaSoft/integrations-core/pull/2599
[25]: https://github.com/KhulnaSoft/integrations-core/pull/2593
[26]: https://github.com/KhulnaSoft/integrations-core/pull/2503
[27]: https://github.com/KhulnaSoft/integrations-core/pull/2502
[28]: https://github.com/KhulnaSoft/integrations-core/pull/2491
[29]: https://github.com/KhulnaSoft/integrations-core/pull/2478
[30]: https://github.com/KhulnaSoft/integrations-core/pull/2474
[31]: https://github.com/KhulnaSoft/integrations-core/pull/2465
[32]: https://github.com/KhulnaSoft/integrations-core/pull/2444
[33]: https://github.com/KhulnaSoft/integrations-core/pull/2432
[34]: https://github.com/KhulnaSoft/integrations-core/pull/2457
[35]: https://github.com/KhulnaSoft/integrations-core/pull/2455
[36]: https://github.com/KhulnaSoft/integrations-core/pull/2454
[37]: https://github.com/KhulnaSoft/integrations-core/pull/2447
[38]: https://github.com/KhulnaSoft/integrations-core/pull/2430
[39]: https://github.com/KhulnaSoft/integrations-core/pull/2427
[40]: https://github.com/KhulnaSoft/integrations-core/pull/2416
[41]: https://github.com/KhulnaSoft/integrations-core/pull/2418
[42]: https://github.com/KhulnaSoft/integrations-core/pull/2411
[43]: https://github.com/KhulnaSoft/integrations-core/pull/2406
[44]: https://github.com/KhulnaSoft/integrations-core/pull/2408
[45]: https://github.com/KhulnaSoft/integrations-core/pull/2399
[46]: https://github.com/KhulnaSoft/integrations-core/pull/2375
[47]: https://github.com/KhulnaSoft/integrations-core/pull/2386
[48]: https://github.com/KhulnaSoft/integrations-core/pull/2364
[49]: https://github.com/KhulnaSoft/integrations-core/pull/2365
[50]: https://github.com/KhulnaSoft/integrations-core/pull/2345
[51]: https://github.com/KhulnaSoft/integrations-core/pull/2342
[52]: https://github.com/KhulnaSoft/integrations-core/pull/2343
[53]: https://github.com/KhulnaSoft/integrations-core/pull/2336
[54]: https://github.com/KhulnaSoft/integrations-core/pull/2312
[55]: https://github.com/KhulnaSoft/integrations-core/pull/2319
[56]: https://github.com/KhulnaSoft/integrations-core/pull/2311
[57]: https://github.com/KhulnaSoft/integrations-core/pull/2315
[58]: https://github.com/KhulnaSoft/integrations-core/pull/2269
[59]: https://github.com/KhulnaSoft/integrations-core/pull/2303
[60]: https://github.com/KhulnaSoft/integrations-core/pull/2285
[61]: https://github.com/KhulnaSoft/integrations-core/pull/2224
[62]: https://github.com/KhulnaSoft/integrations-core/pull/2117
[63]: https://github.com/KhulnaSoft/integrations-core/pull/2277
[64]: https://github.com/KhulnaSoft/integrations-core/pull/2258
[65]: https://github.com/KhulnaSoft/integrations-core/pull/2243
[66]: https://github.com/KhulnaSoft/integrations-core/pull/2240
[67]: https://github.com/KhulnaSoft/integrations-core/pull/2167
[68]: https://github.com/KhulnaSoft/integrations-core/pull/2235
[69]: https://github.com/KhulnaSoft/integrations-core/pull/2196
[70]: https://github.com/KhulnaSoft/integrations-core/pull/2194
[71]: https://github.com/KhulnaSoft/integrations-core/pull/2172
[72]: https://github.com/KhulnaSoft/integrations-core/pull/2188
[73]: https://github.com/KhulnaSoft/integrations-core/pull/2163
[74]: https://github.com/KhulnaSoft/integrations-core/pull/2169
[75]: https://github.com/KhulnaSoft/integrations-core/pull/2162
[76]: https://github.com/KhulnaSoft/integrations-core/pull/2155
[77]: https://github.com/KhulnaSoft/integrations-core/pull/2105
[78]: https://github.com/KhulnaSoft/integrations-core/pull/2037
[79]: https://github.com/KhulnaSoft/integrations-core/pull/1992
[80]: https://github.com/KhulnaSoft/integrations-core/pull/1962
[81]: https://github.com/KhulnaSoft/integrations-core/pull/1953
[82]: https://github.com/KhulnaSoft/integrations-core/pull/1934
[83]: https://github.com/KhulnaSoft/integrations-core/pull/1923
[84]: https://github.com/KhulnaSoft/integrations-core/pull/1921
[85]: https://github.com/KhulnaSoft/integrations-core/pull/1914
[86]: https://github.com/KhulnaSoft/integrations-core/pull/1913
[87]: https://github.com/KhulnaSoft/integrations-core/pull/1911
[88]: https://github.com/KhulnaSoft/integrations-core/pull/1900
[89]: https://github.com/KhulnaSoft/integrations-core/pull/1891
[90]: https://github.com/KhulnaSoft/integrations-core/pull/1878
[91]: https://github.com/KhulnaSoft/integrations-core/pull/1862
