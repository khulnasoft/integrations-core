...
def models(ctx, check, sync, verbose):
    ...
    for check in sorted(checks):
        ...
        if check == 'khulnasoft_checks_base':
            spec_path = path_join(root, 'khulnasoft_checks_base', 'tests', 'models', 'data', 'spec.yaml')
            source = 'test'
            version = '0.0.1'
        else:
        ...
        if check == 'khulnasoft_checks_base':
            models_location = path_join(root, 'khulnasoft_checks_base', 'tests', 'models', 'config_models')
        else:
