...
EXCLUDE_CHECKS = ["khulnasoft_checks_downloader", "khulnasoft_checks_dev", "khulnasoft_checks_base", "ddev"]
...
def package(check):
    ...
    for check in checks:
        ...
        if has_project_file(check):
            ...
            expected_version_file = f'khulnasoft_checks/{get_package_name(check)}/__about__.py'
