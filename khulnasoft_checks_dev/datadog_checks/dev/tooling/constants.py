...
NOT_CHECKS = {'khulnasoft_checks_dev', 'khulnasoft_checks_tests_helper', 'ddev'}
...
[4]: https://github.com/KhulnaSoft/{repository}/blob/master/{name}/khulnasoft_checks/{name}/data/conf.yaml.example
...
[7]: https://github.com/KhulnaSoft/{repository}/blob/master/{name}/metadata.csv
[8]: https://github.com/KhulnaSoft/{repository}/blob/master/{name}/assets/service_checks.json
...
[5]: https://github.com/KhulnaSoft/{repository}/blob/master/{name}/assets/service_checks.json
"""

JMX_LINKS = """\
[1]: **LINK_TO_INTEGERATION_SITE**
[2]: https://app.khulnasoft.com/account/settings/agent/latest
[3]: https://github.com/KhulnaSoft/{repository}/blob/master/{name}/khulnasoft_checks/{name}/data/conf.yaml.example
...
def get_agent_requirements():
    ...
    """
    return os.path.join(get_root(), 'khulnasoft_checks_base', 'khulnasoft_checks', 'base', 'data', 'agent_requirements.in')
