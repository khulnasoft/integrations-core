...
def load_jmx_config():
    ...
    check = basepath(root)
    example_config_path = path_join(root, 'khulnasoft_checks', check, 'data', 'conf.yaml.example')
    metrics_config_path = path_join(root, 'khulnasoft_checks', check, 'data', 'metrics.yaml')
