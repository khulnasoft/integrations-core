...
from khulnasoft_checks.base import AgentCheck  # noqa: F401

# from khulnasoft_checks.base.utils.db import QueryManager
...
class {check_class}(AgentCheck):
    ...
    def __init__(self, name, init_config, instances):
        ...
        # More info at
        # https://khulnasoft.dev/integrations-core/base/databases/#khulnasoft_checks.base.utils.db.core.QueryManager
        # sample_query = {{
        #     "name": "sample",
    ...
    def check(self, _):
        ...
        # More info at https://khulnasoft.dev/integrations-core/base/http/
        # try:
        ...
        # More info at https://khulnasoft.dev/integrations-core/base/api/#khulnasoft_checks.base.checks.base.AgentCheck
        ...
        # More info at
        # https://khulnasoft.dev/integrations-core/base/api/#khulnasoft_checks.base.checks.base.AgentCheck.service_check
