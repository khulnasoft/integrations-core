...
with open(path.join(HERE, 'khulnasoft_checks', 'dev', '__about__.py'), 'r', encoding='utf-8') as f:
    for line in f:
        line = line.strip()
...
setup(
    ...
    packages=['khulnasoft_checks', 'khulnasoft_checks.dev'],
    ...
    entry_points={
        'pytest11': ['khulnasoft_checks = khulnasoft_checks.dev.plugin.pytest'],
        'console_scripts': ['ddev = khulnasoft_checks.dev.tooling.cli:ddev'],
    },
)
