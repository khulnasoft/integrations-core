...
from khulnasoft_checks.dev.tooling.commands.agent.common import get_agent_tags
...
@mock.patch('khulnasoft_checks.dev.tooling.git.git_tag_list', return_value=['1.2.3', '4.5.6', '7.8.9'])
