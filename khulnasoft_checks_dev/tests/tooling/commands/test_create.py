...
from khulnasoft_checks.dev import EnvVars, run_command
from khulnasoft_checks.dev._env import E2E_PREFIX, TESTING_PLUGIN
from khulnasoft_checks.dev.fs import chdir, remove_path
...
def test_new_check_test(integration_type, installable):
    ...
    try:
        ...
        if installable:
            ...
            result = run_command(
                [sys.executable, '-m', 'khulnasoft_checks.dev', 'test', '-s', 'my_check'], capture=True, check=True
            )
