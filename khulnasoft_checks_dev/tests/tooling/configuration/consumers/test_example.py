...
from khulnasoft_checks.dev.tooling.configuration.consumers.example import DESCRIPTION_LINE_LENGTH_LIMIT
...
def test_option_no_section():
    ...
    assert contents == normalize_yaml(
        ...
        ## https://docs.khulnasoft.com/agent/guide/ad_identifiers/
        #
        ad_identifiers:
          - httpd
        """
    ...
    assert contents == normalize_yaml(
        ...
        instances:
          ...
          - foo: <FOO>
            ...
            ##
            ## Learn more about tagging at https://docs.khulnasoft.com/tagging
            #
            # tags:
            #   - <KEY_1>:<VALUE_1>
            #   - <KEY_2>:<VALUE_2>
