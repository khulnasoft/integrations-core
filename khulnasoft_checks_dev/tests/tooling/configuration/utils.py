...
from khulnasoft_checks.dev.tooling.configuration import ConfigSpec
from khulnasoft_checks.dev.tooling.configuration.consumers import ExampleConsumer, ModelConsumer
