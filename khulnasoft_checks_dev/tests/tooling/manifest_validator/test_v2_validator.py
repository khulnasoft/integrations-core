...
import khulnasoft_checks.dev.tooling.manifest_validator.common.validator as common
import khulnasoft_checks.dev.tooling.manifest_validator.v2.validator as v2_validators
import tests.tooling.manifest_validator.input_constants as input_constants
from khulnasoft_checks.dev.tooling.constants import get_root, set_root
from khulnasoft_checks.dev.tooling.datastructures import JSONDict
from khulnasoft_checks.dev.tooling.manifest_validator.constants import V2
...
@mock.patch(
    'khulnasoft_checks.dev.tooling.utils.read_metadata_rows', return_value=input_constants.ORACLE_METADATA_CSV_EXAMPLE
)
...
@mock.patch('khulnasoft_checks.dev.tooling.utils.has_logs', return_value=True)
...
@mock.patch(
    'khulnasoft_checks.dev.tooling.manifest_validator.common.validator.git_show_file',
...
def test_manifest_v2_changelog_found(setup_route):
    ...
    validator.validate('khulnasoft_checks_dev', manifest, False)
