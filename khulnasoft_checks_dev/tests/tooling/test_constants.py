...
from khulnasoft_checks.dev.tooling.constants import (
    get_agent_changelog,
...
def test_get_agent_release_requirements():
    with mock.patch('khulnasoft_checks.dev.tooling.constants.get_root', return_value='foo'):
...
def test_get_agent_requirements():
    with mock.patch('khulnasoft_checks.dev.tooling.constants.get_root', return_value='foo'):
        expected = os.path.join('foo', 'khulnasoft_checks_base', 'khulnasoft_checks', 'base', 'data', 'agent_requirements.in')
