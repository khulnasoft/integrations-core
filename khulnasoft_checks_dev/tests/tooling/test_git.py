...
from khulnasoft_checks.dev.tooling.git import (
    files_changed,
    get_commits_since,
    get_current_branch,
    git_commit,
...
def test_get_current_branch():
    with mock.patch('khulnasoft_checks.dev.tooling.git.chdir') as chdir:
        with mock.patch('khulnasoft_checks.dev.tooling.git.run_command') as run:
            set_root('/foo/')
            get_current_branch()
