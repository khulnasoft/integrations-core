...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'khulnasoft_cluster_agent', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-khulnasoft_cluster_agent',
    version=ABOUT['__version__'],
    description='The Khulnasoft-Cluster-Agent check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent khulnasoft_cluster_agent check',
    ...
    packages=['khulnasoft_checks.khulnasoft_cluster_agent'],
