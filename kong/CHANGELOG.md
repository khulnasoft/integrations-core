...
* Add metrics to support v3.0 of Kong ([#13059](https://github.com/KhulnaSoft/integrations-core/pull/13059))
...
* Add `pyproject.toml` file ([#11379](https://github.com/KhulnaSoft/integrations-core/pull/11379))
...
* Update default Kong configurations to use Openmetrics V2 ([#10839](https://github.com/KhulnaSoft/integrations-core/pull/10839))
...
* Add runtime configuration validation ([#8943](https://github.com/KhulnaSoft/integrations-core/pull/8943))
...
* Add new implementation based on the official Prometheus plugin ([#9031](https://github.com/KhulnaSoft/integrations-core/pull/9031))

***Fixed***:

* Bump minimum base package ([#9107](https://github.com/KhulnaSoft/integrations-core/pull/9107))
* Bump minimum base package version ([#9096](https://github.com/KhulnaSoft/integrations-core/pull/9096))
...
* Adds RequestsWrapper to Kong ([#5807](https://github.com/KhulnaSoft/integrations-core/pull/5807))
...
* Adhere to code style ([#3524](https://github.com/KhulnaSoft/integrations-core/pull/3524))

## 1.4.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Update the kong integration with log instruction ([#2935](https://github.com/KhulnaSoft/integrations-core/pull/2935))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2772
