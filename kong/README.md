...
You can also use Kong's [Khulnasoft plugin][15] to send API, connection, and database metrics to Khulnasoft through the Khulnasoft Agent using [DogStatsD][16]. Read the [Monitor Kong with the Khulnasoft integration][11] blog post for more information.

## Setup

### Installation

The Kong check is included in the [Khulnasoft Agent][1] package, so you don't need to install anything else on your Kong servers.
...
- [Monitor Kong with the Khulnasoft integration][11]
...
[11]: https://www.khulnasoft.com/blog/monitor-kong-khulnasoft
...
[15]: https://docs.konghq.com/hub/kong-inc/khulnasoft/
