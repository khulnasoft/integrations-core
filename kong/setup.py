...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kong', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kong',
    version=ABOUT['__version__'],
    description='The Kong check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kong check',
    ...
    packages=['khulnasoft_checks.kong'],
