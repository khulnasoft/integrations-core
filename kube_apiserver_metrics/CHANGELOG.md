...
* Add etcd.db.total_size for Kubernetes 1.26, 1.27, and 1.28 ([#15940](https://github.com/KhulnaSoft/integrations-core/pull/15940))
* Add apiserver_flowcontrol_current_inqueue_requests and apiserver_flowcontrol_dispatched_requests_total for Kubernetes >= 1.23 ([#15981](https://github.com/KhulnaSoft/integrations-core/pull/15981))
* Add etcd_requests_total and etcd_request_errors_total for Kubernetes >= 1.28 ([#15986](https://github.com/KhulnaSoft/integrations-core/pull/15986))
...
* Deprecate apiserver_longrunning_gauge metric in favor of apiserver_longrunning_requests ([#14856](https://github.com/KhulnaSoft/integrations-core/pull/14856))
* [kube_apiserver_metrics] Rename aggregator_unavailable_apiservice `name` tag to `apiservice_name` ([#14738](https://github.com/KhulnaSoft/integrations-core/pull/14738))
...
* [kube_apiserver_metrics] Rename aggregator_unavailable_apiservice `name` tag to `apiservice_name` (#14738) ([#14751](https://github.com/KhulnaSoft/integrations-core/pull/14751))

## 3.6.0 / 2023-05-26

***Added***:

* Add `flowcontrol` metrics ([#14480](https://github.com/KhulnaSoft/integrations-core/pull/14480))
* [kube-apiserver] Add new `aggregator_unavailable_apiservice` metric ([#14457](https://github.com/KhulnaSoft/integrations-core/pull/14457))

## 3.5.0 / 2023-04-14 / Agent 7.45.0

***Added***:

* Adds new metric `kubernetes_feature_enabled` ([#14147](https://github.com/KhulnaSoft/integrations-core/pull/14147))

## 3.4.0 / 2023-03-03 / Agent 7.44.0

***Added***:

* Add metric `apiserver_admission_webhook_fail_open_count` ([#13750](https://github.com/KhulnaSoft/integrations-core/pull/13750))

## 3.3.0 / 2022-09-16 / Agent 7.40.0

***Added***:

* Add new kube_apiserver_metric for deprecated API usage ([#12887](https://github.com/KhulnaSoft/integrations-core/pull/12887)) Thanks [alex-berger](https://github.com/alex-berger).
...
* Add `pyproject.toml` file ([#11380](https://github.com/KhulnaSoft/integrations-core/pull/11380))
...
* Update the default value of the `bearer_token` parameter to send the bearer token only to secure https endpoints by default ([#10772](https://github.com/KhulnaSoft/integrations-core/pull/10772))

***Added***:

* Add new storage metrics and test for Kubernetes 1.23 ([#10906](https://github.com/KhulnaSoft/integrations-core/pull/10906))
...
* Add kube_apiserver.etcd.db.total_size metric ([#10569](https://github.com/KhulnaSoft/integrations-core/pull/10569))

## 1.11.0 / 2021-10-04 / Agent 7.32.0

***Added***:

* Add runtime configuration validation ([#8944](https://github.com/KhulnaSoft/integrations-core/pull/8944))
...
* Fix auto-discovery for latest versions on Kubernetes ([#9577](https://github.com/KhulnaSoft/integrations-core/pull/9577))
...
* Add new metrics ([#8557](https://github.com/KhulnaSoft/integrations-core/pull/8557))

## 1.7.1 / 2021-01-25 / Agent 7.26.0

***Fixed***:

* Update metrics whose name has changed in Kubernetes 1.14 ([#8337](https://github.com/KhulnaSoft/integrations-core/pull/8337))
...
* Fix default value in example configuration file ([#7034](https://github.com/KhulnaSoft/integrations-core/pull/7034))
...
* kube apiserver signature and specs ([#6831](https://github.com/KhulnaSoft/integrations-core/pull/6831))

***Fixed***:

* Sync example configs ([#6920](https://github.com/KhulnaSoft/integrations-core/pull/6920))
...
* Add admission controller metrics ([#6502](https://github.com/KhulnaSoft/integrations-core/pull/6502))
...
* Update Kube_apiserver_metrics annotations documentation ([#5199](https://github.com/KhulnaSoft/integrations-core/pull/5199))

## 1.2.1 / 2019-12-13 / Agent 7.16.0

***Fixed***:

* Fix scrapper config cache issue ([#5202](https://github.com/KhulnaSoft/integrations-core/pull/5202))

## 1.2.0 / 2019-12-02

***Added***:

* Handle scheme in `prometheus_url` instead of the separate `scheme` option, which is now deprecated ([#4913](https://github.com/KhulnaSoft/integrations-core/pull/4913))

## 1.1.1 / 2019-10-16 / Agent 6.15.0

***Fixed***:

* Use default port for kube apiserver metrics auto conf ([#4785](https://github.com/KhulnaSoft/integrations-core/pull/4785))

## 1.1.0 / 2019-10-11

***Added***:

* Scrape apiserver_request_total metric introduced in v1.15 ([#4546](https://github.com/KhulnaSoft/integrations-core/pull/4546))

## 1.0.1 / 2019-06-06 / Agent 6.12.0

***Fixed***:

* Fix default for bearer_token and ssl_verify ([#3882](https://github.com/KhulnaSoft/integrations-core/pull/3882))

## 1.0.0 / 2019-05-31

***Added***:

* Introducing the Kubernetes APIServer metrics check ([#3746](https://github.com/KhulnaSoft/integrations-core/pull/3746))
