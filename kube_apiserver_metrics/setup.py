...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kube_apiserver_metrics', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube_apiserver_metrics',
    version=ABOUT['__version__'],
    description='The Kube_apiserver_metrics check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_apiserver_metrics check',
    ...
    packages=['khulnasoft_checks.kube_apiserver_metrics'],
