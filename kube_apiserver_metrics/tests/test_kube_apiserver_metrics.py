...
from khulnasoft_checks.kube_apiserver_metrics import KubeAPIServerMetricsCheck
...
def mock_read_bearer_token():
    with mock.patch('khulnasoft_checks.checks.openmetrics.OpenMetricsBaseCheck._get_bearer_token', return_value="XXX"):
        yield
