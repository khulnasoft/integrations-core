...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kube_controller_manager', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube_controller_manager',
    version=ABOUT['__version__'],
    description='The Kubernetes Controller Manager check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_controller_manager check',
    ...
    packages=['khulnasoft_checks.kube_controller_manager'],
