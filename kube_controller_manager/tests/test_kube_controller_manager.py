...
from khulnasoft_checks.kube_controller_manager import KubeControllerManagerCheck
...
def mock_leader():
    ...
    with mock.patch(
        'khulnasoft_checks.kube_controller_manager.KubeControllerManagerCheck._get_record',
