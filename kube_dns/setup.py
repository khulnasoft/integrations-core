...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kube_dns', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube_dns',
    version=ABOUT['__version__'],
    description='The KubeDNS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_dns check',
    ...
    packages=['khulnasoft_checks.kube_dns'],
