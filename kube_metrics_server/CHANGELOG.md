...
* Add `pyproject.toml` file ([#11383](https://github.com/KhulnaSoft/integrations-core/pull/11383))
...
* Add kube_metrics_server config spec ([#10509](https://github.com/KhulnaSoft/integrations-core/pull/10509))

## 1.3.0 / 2021-05-28 / Agent 7.29.0

***Added***:

* Support 0.4.0 metrics server renamed metric names ([#9202](https://github.com/KhulnaSoft/integrations-core/pull/9202)) Thanks [eatwithforks](https://github.com/eatwithforks).
...
* Fix prometheus_url conf ([#4175](https://github.com/KhulnaSoft/integrations-core/pull/4175))

## 1.0.0 / 2019-06-01 / Agent 6.12.0

***Added***:

* Add Kube metrics server integration ([#3666](https://github.com/KhulnaSoft/integrations-core/pull/3666))
