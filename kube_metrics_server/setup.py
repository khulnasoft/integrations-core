...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kube_metrics_server', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube_metrics_server',
    version=ABOUT['__version__'],
    description='The Kubernetes Metrics Server check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_metrics_server check',
    ...
    packages=['khulnasoft_checks.kube_metrics_server'],
