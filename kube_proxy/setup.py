...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "kube_proxy", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube-proxy',
    version=ABOUT["__version__"],
    description='The kube_proxy Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_proxy check',
    ...
    packages=['khulnasoft_checks.kube_proxy'],
