...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kube_scheduler', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kube_scheduler',
    version=ABOUT['__version__'],
    description='The Kubernetes Scheduler check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kube_scheduler check',
    ...
    packages=['khulnasoft_checks.kube_scheduler'],
