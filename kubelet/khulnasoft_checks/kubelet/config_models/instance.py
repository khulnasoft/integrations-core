...
class InstanceConfig(BaseModel):
    ...
    cadvisor_metrics_endpoint: Optional[str] = None
    cadvisor_port: Optional[int] = None
    connect_timeout: Optional[float] = None
    disable_generic_tags: Optional[bool] = None
    empty_default_hostname: Optional[bool] = None
    enabled_gauges: Optional[tuple[str, ...]] = None
    enabled_rates: Optional[tuple[str, ...]] = None
    ...
    kubelet_metrics_endpoint: Optional[str] = None
    ...
    probes_metrics_endpoint: Optional[str] = None
