...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "kubelet", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kubelet',
    version=ABOUT["__version__"],
    description='The Kubelet check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kubelet check',
    ...
    packages=['khulnasoft_checks.kubelet'],
