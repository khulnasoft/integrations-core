...
from khulnasoft_checks.kubelet import KubeletCheck
from khulnasoft_checks.kubelet.common import PodListUtils
from khulnasoft_checks.kubelet.prometheus import CadvisorPrometheusScraperMixin
...
def cadvisor_scraper(check):
    with mock.patch(
        'khulnasoft_checks.kubelet.kubelet.KubeletCheck.retrieve_pod_list',
