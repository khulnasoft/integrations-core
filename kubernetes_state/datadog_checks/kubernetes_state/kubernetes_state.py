...
from khulnasoft_checks.base.checks.openmetrics import OpenMetricsBaseCheck
from khulnasoft_checks.base.config import is_affirmative
from khulnasoft_checks.base.errors import CheckException
from khulnasoft_checks.base.utils.common import to_string

try:
    # this module is only available in agent 6
    from khulnasoft_agent import get_clustername
except ImportError:
...
class KubernetesState(OpenMetricsBaseCheck):
    ...
    def _create_kubernetes_state_prometheus_instance(self, instance):
        ...
        labels_to_get = [
            "label_tags_khulnasoft.com_env",
            "label_tags_khulnasoft.com_service",
            "label_tags_khulnasoft.com_version",
        ]
        ...
        if join_standard_tags:
            ...
            ksm_instance.setdefault("labels_mapper", {}).update(
                {
                    "label_tags_khulnasoft.com_env": "env",
                    "label_tags_khulnasoft.com_service": "service",
                    "label_tags_khulnasoft.com_version": "version",
                }
            )
