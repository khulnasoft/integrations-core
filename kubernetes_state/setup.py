...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'kubernetes_state', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-kubernetes_state',
    version=ABOUT['__version__'],
    description='The Kubernetes State check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent kubernetes_state check',
    ...
    packages=['khulnasoft_checks.kubernetes_state'],
