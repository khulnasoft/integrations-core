...
* Add `pyproject.toml` file ([#11388](https://github.com/KhulnaSoft/integrations-core/pull/11388))
...
* Add runtime configuration validation ([#8946](https://github.com/KhulnaSoft/integrations-core/pull/8946))
...
* Add logs support ([#7791](https://github.com/KhulnaSoft/integrations-core/pull/7791))
* Add config spec ([#7790](https://github.com/KhulnaSoft/integrations-core/pull/7790))
...
* Add Requests Wrapper to Kyototycoon ([#4199](https://github.com/KhulnaSoft/integrations-core/pull/4199))

## 1.6.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3531](https://github.com/KhulnaSoft/integrations-core/pull/3531))

## 1.5.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#3013](https://github.com/KhulnaSoft/integrations-core/pull/3013))
...
* Hardcode the 1978 port in the Autodiscovery template ([#1444](https://github.com/KhulnaSoft/integrations-core/pull/1444) for more information)
