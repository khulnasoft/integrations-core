...
DEBUG:ddtrace.contrib._trace_utils_llm.py:sent 2 logs to 'http-intake.logs.khulnasoft.com'
```
...
[4]: https://github.com/KhulnaSoft/integrations-core/blob/master/langchain/metadata.csv
