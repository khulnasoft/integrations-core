...
* Add `pyproject.toml` file ([#11389](https://github.com/KhulnaSoft/integrations-core/pull/11389))
...
* Fix lighttpd service check name for monitors ([#10977](https://github.com/KhulnaSoft/integrations-core/pull/10977))
...
* Add runtime configuration validation ([#8947](https://github.com/KhulnaSoft/integrations-core/pull/8947))
...
* Remove default `encoding` example in logs config ([#7916](https://github.com/KhulnaSoft/integrations-core/pull/7916))
...
* Add lighttpd logs ([#7719](https://github.com/KhulnaSoft/integrations-core/pull/7719))
...
* Add config specs ([#7057](https://github.com/KhulnaSoft/integrations-core/pull/7057))
...
* Add version metadata ([#5600](https://github.com/KhulnaSoft/integrations-core/pull/5600))
...
* Fix lighttpd logging format ([#4716](https://github.com/KhulnaSoft/integrations-core/pull/4716))
* Fix support for no authentication ([#4689](https://github.com/KhulnaSoft/integrations-core/pull/4689))

## 1.5.0 / 2019-08-24 / Agent 6.14.0

***Added***:

* Add requests wrapper to lighttpd ([#4220](https://github.com/KhulnaSoft/integrations-core/pull/4220))
...
* Adhere to code style ([#3532](https://github.com/KhulnaSoft/integrations-core/pull/3532))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2834
