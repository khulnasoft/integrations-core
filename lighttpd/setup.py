...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "lighttpd", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-lighttpd',
    version=ABOUT["__version__"],
    description='The lighttpd check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent lighttpd check',
    ...
    packages=['khulnasoft_checks.lighttpd'],
