...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "linkerd", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-linkerd',
    version=ABOUT["__version__"],
    description='The Linkerd check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent linkerd check',
    ...
    packages=['khulnasoft_checks.linkerd'],
