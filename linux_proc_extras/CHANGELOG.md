...
* Add `pyproject.toml` file ([#11391](https://github.com/KhulnaSoft/integrations-core/pull/11391))
...
* Add runtime configuration validation ([#8949](https://github.com/KhulnaSoft/integrations-core/pull/8949))
...
* Put interrupt metrics behind a config option ([#7553](https://github.com/KhulnaSoft/integrations-core/pull/7553))

## 1.4.0 / 2020-08-10 / Agent 7.22.0

***Added***:

* Adding interrupts stats ([#7166](https://github.com/KhulnaSoft/integrations-core/pull/7166))
...
* Adhere to code style ([#3534](https://github.com/KhulnaSoft/integrations-core/pull/3534))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2852
