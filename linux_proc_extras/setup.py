...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'linux_proc_extras', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-linux_proc_extras',
    version=ABOUT['__version__'],
    description='The Linux Proc Extras check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent linux_proc_extras check',
    ...
    packages=['khulnasoft_checks.linux_proc_extras'],
