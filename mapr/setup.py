...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'mapr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-mapr',
    version=ABOUT['__version__'],
    description='The mapr check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent mapr check',
    ...
    packages=['khulnasoft_checks.mapr'],
