...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "mapreduce", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-mapreduce',
    version=ABOUT['__version__'],
    description='The MapReduce check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent mapreduce check',
    ...
    packages=['khulnasoft_checks.mapreduce'],
