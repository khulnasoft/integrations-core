...
def test_integration_metrics(aggregator, check, dd_run_check, instance, khulnasoft_agent):
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_metadata(aggregator, check, dd_run_check, instance, khulnasoft_agent):
    check = check(instance)
