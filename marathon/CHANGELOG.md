...
* Add `pyproject.toml` file ([#11394](https://github.com/KhulnaSoft/integrations-core/pull/11394))
...
* Add runtime configuration validation ([#8952](https://github.com/KhulnaSoft/integrations-core/pull/8952))
...
* Add config specs ([#7254](https://github.com/KhulnaSoft/integrations-core/pull/7254))
...
* Add request wrapper to marathon ([#4324](https://github.com/KhulnaSoft/integrations-core/pull/4324))

## 1.8.0 / 2019-07-13 / Agent 6.13.0

***Added***:

* Add log section ([#4014](https://github.com/KhulnaSoft/integrations-core/pull/4014))

## 1.7.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3536](https://github.com/KhulnaSoft/integrations-core/pull/3536))

## 1.6.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#2871](https://github.com/KhulnaSoft/integrations-core/pull/2871))

## 1.5.0 / 2018-10-12 / Agent 6.6.0

***Added***:

* Add ability to tag metrics based on marathon labels ([#2165](https://github.com/KhulnaSoft/integrations-core/pull/2165)) Thanks [ashirley](https://github.com/ashirley).

***Fixed***:

* Removed default arguments from process_apps ([#2337](https://github.com/KhulnaSoft/integrations-core/pull/2337))
...
* [marathon] add task counts metrics for groups ([#1513](https://github.com/KhulnaSoft/integrations-core/pull/1513))

***Fixed***:

* Ensure marathon queue count reports 0 for apps not in queue ([#1548](https://github.com/KhulnaSoft/integrations-core/pull/1548))
...
* Fix duplicate `app:` tags on app-level metrics ([#987](https://github.com/KhulnaSoft/integrations-core/issues/987), thanks [@emil-applause](https://github)com/emil-applause)

## 1.2.0 / 2017-08-28

***Added***:

* Adds v2 queue metrics ([#464](https://github.com/KhulnaSoft/integrations-core/issues/464)

## 1.1.0 / 2017-07-18

***Added***:

* Add gauge for queue size ([#321](https://github.com/KhulnaSoft/integrations-core/issues/321), thanks [@jangie](https://github)com/jangie)
