...
* Add support for marklogic 11 ([#15428](https://github.com/KhulnaSoft/integrations-core/pull/15428))
...
* Add `pyproject.toml` file ([#11395](https://github.com/KhulnaSoft/integrations-core/pull/11395))
...
* Add runtime configuration validation ([#8953](https://github.com/KhulnaSoft/integrations-core/pull/8953))
...
* Support clusters resource type ([#9935](https://github.com/KhulnaSoft/integrations-core/pull/9935))
...
* Handle unavailable specific resource information ([#7944](https://github.com/KhulnaSoft/integrations-core/pull/7944))
* Rename marklogic host tags ([#7960](https://github.com/KhulnaSoft/integrations-core/pull/7960))

## 1.1.1 / 2020-11-05

***Fixed***:

* Remove possible extra '/' from base url configuration ([#7941](https://github.com/KhulnaSoft/integrations-core/pull/7941))
...
* MarkLogic New Integration ([#6524](https://github.com/KhulnaSoft/integrations-core/pull/6524))
