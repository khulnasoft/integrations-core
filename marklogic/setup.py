...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'marklogic', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-marklogic',
    version=ABOUT['__version__'],
    description='The MarkLogic check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent marklogic check',
    ...
    packages=['khulnasoft_checks.marklogic'],
