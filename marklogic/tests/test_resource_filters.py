...
from khulnasoft_checks.marklogic import MarklogicCheck
from khulnasoft_checks.marklogic.config import Config
from khulnasoft_checks.marklogic.parsers.resources import parse_resources
...
@mock.patch('khulnasoft_checks.marklogic.api.MarkLogicApi.http_get', return_value=read_fixture_file('host_status.yaml'))
@mock.patch(
    'khulnasoft_checks.marklogic.api.MarkLogicApi.get_requests_data', return_value=read_fixture_file('host_requests.yaml')
)
...
@mock.patch(
    'khulnasoft_checks.marklogic.api.MarkLogicApi.http_get', return_value=read_fixture_file('bad_resource_storage.yaml')
)
