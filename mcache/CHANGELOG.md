...
* Add the `max_connections` metric ([#12689](https://github.com/KhulnaSoft/integrations-core/pull/12689))
...
* Add `pyproject.toml` file ([#11396](https://github.com/KhulnaSoft/integrations-core/pull/11396))
...
* Fix possible KeyError when collecting metrics ([#10471](https://github.com/KhulnaSoft/integrations-core/pull/10471))
...
* Add runtime configuration validation ([#8954](https://github.com/KhulnaSoft/integrations-core/pull/8954))
...
* Add config specs ([#8140](https://github.com/KhulnaSoft/integrations-core/pull/8140))
...
* Add version metadata ([#4935](https://github.com/KhulnaSoft/integrations-core/pull/4935))

## 1.7.0 / 2019-10-29

***Added***:

* Add log section in the example configuration file ([#4885](https://github.com/KhulnaSoft/integrations-core/pull/4885))

## 1.6.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3537](https://github.com/KhulnaSoft/integrations-core/pull/3537))

## 1.5.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Finish Python 3 support ([#2915](https://github.com/KhulnaSoft/integrations-core/pull/2915))

## 1.4.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2783](https://github.com/KhulnaSoft/integrations-core/pull/2783))
...
* Fix connection to unix socket for new binary ([#1755](https://github.com/KhulnaSoft/integrations-core/pull/1755))
...
* Hardcode the 11211 port in the Autodiscovery template ([#1444](https://github.com/KhulnaSoft/integrations-core/pull/1444) for more information)
