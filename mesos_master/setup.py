...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'mesos_master', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-mesos_master',
    version=ABOUT['__version__'],
    description='The Mesos master check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent mesos_master check',
    ...
    packages=['khulnasoft_checks.mesos_master'],
