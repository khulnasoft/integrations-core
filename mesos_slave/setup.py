...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'mesos_slave', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-mesos_slave',
    version=ABOUT['__version__'],
    description='The Mesos slave check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent mesos_slave check',
    ...
    packages=['khulnasoft_checks.mesos_slave'],
