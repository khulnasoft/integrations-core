...
metadata:
  name: mongo
  annotations:
    ad.khulnasoft.com/mongo.check_names: '["mongo"]'
    ad.khulnasoft.com/mongo.init_configs: '[{}]'
    ad.khulnasoft.com/mongo.instances: |
      [
        {
          "hosts": ["%%host%%:%%port%%"], 
          "username": "khulnasoft", 
...
metadata:
  name: mongo
  annotations:
    ad.khulnasoft.com/mongo.checks: |
      {
        "mongo": {
          "init_config": {},
          "instances": [
...
metadata:
  name: mongo
  annotations:
    ad.khulnasoft.com/mongo.logs: '[{"source":"mongodb","service":"<SERVICE_NAME>"}]'
spec:
  containers:
    - name: mongo
```
...
[1]: https://raw.githubusercontent.com/KhulnaSoft/integrations-core/master/mongo/images/mongo_dashboard.png
...
[5]: https://github.com/KhulnaSoft/integrations-core/blob/master/mongo/khulnasoft_checks/mongo/data/conf.yaml.example
[6]: https://docs.khulnasoft.com/agent/guide/agent-commands/#start-stop-and-restart-the-agent
[7]: https://docs.khulnasoft.com/tracing/send_traces/
[8]: https://docs.khulnasoft.com/tracing/setup/
...
[12]: https://docs.khulnasoft.com/agent/docker/apm/?tab=linux
...
[17]: https://docs.khulnasoft.com/agent/kubernetes/apm/?tab=java
[18]: https://docs.khulnasoft.com/agent/kubernetes/daemonset_setup/?tab=k8sfile#apm-and-distributed-tracing
[19]: https://docs.khulnasoft.com/agent/amazon_ecs/logs/?tab=linux
[20]: https://docs.khulnasoft.com/agent/amazon_ecs/apm/?tab=ec2metadataendpoint#setup
[21]: https://docs.khulnasoft.com/agent/guide/agent-commands/#agent-status-and-information
[22]: https://github.com/KhulnaSoft/integrations-core/blob/master/mongo/metadata.csv
[23]: https://docs.mongodb.org/manual/reference/command/dbStats
[24]: https://github.com/KhulnaSoft/integrations-core/blob/master/mongo/assets/service_checks.json
[25]: https://docs.khulnasoft.com/help/
[26]: https://www.khulnasoft.com/blog/monitoring-mongodb-performance-metrics-wiredtiger
[27]: https://www.khulnasoft.com/blog/monitoring-mongodb-performance-metrics-mmap
