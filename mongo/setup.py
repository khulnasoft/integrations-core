...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'mongo', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-mongo',
    version=ABOUT['__version__'],
    description='The Mongo check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent mongo check',
    ...
    packages=['khulnasoft_checks.mongo'],
