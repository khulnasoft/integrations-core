...
import pymongo
import pytest
from khulnasoft_test_libs.utils.mock_dns import mock_local
from dateutil.tz import tzutc

from khulnasoft_checks.dev import LazyFunction, WaitFor, docker_run, run_command
from khulnasoft_checks.dev.conditions import WaitForPortListening
from khulnasoft_checks.mongo import MongoDb
...
def mock_pymongo(deployment):
    ...
    with mock.patch('khulnasoft_checks.mongo.api.MongoClient', mock.MagicMock(return_value=mocked_client)), mock.patch(
