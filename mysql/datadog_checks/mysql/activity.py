...
from khulnasoft_checks.base import is_affirmative, to_native_string
from khulnasoft_checks.base.utils.db.sql import compute_sql_signature
from khulnasoft_checks.base.utils.db.utils import DBMAsyncJob, obfuscate_sql_with_metadata
        ...
        if self._check.events_wait_current_enabled is False:
            self._check.record_warning(
                ...
                warning_with_tags(
                    ...
                    'https://docs.khulnasoft.com/database_monitoring/setup_mysql/troubleshooting#%s',
