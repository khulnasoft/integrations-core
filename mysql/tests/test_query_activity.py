...
from khulnasoft_checks.mysql import MySql
from khulnasoft_checks.mysql.activity import MySQLActivity
from khulnasoft_checks.mysql.util import StatementTruncationState
...
def test_activity_metadata(aggregator, dd_run_check, dbm_instance, khulnasoft_agent, metadata, expected_metadata_payload):
    check = MySql(CHECK_NAME, {}, [dbm_instance])
...
def test_events_wait_current_disabled(dbm_instance, dd_run_check, root_conn, aggregator):
    ...
    assert check.warnings == [
        ...
        'https://docs.khulnasoft.com/database_monitoring/setup_mysql/troubleshooting#events-waits-current-not-enabled\n'
