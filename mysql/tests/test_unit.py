...
from khulnasoft_checks.mysql.version_utils import get_version
...
def test__get_server_pid():
    ...
    with mock.patch('khulnasoft_checks.mysql.mysql.psutil.process_iter', process_iter):
        with mock.patch('khulnasoft_checks.mysql.mysql.PROC_NAME', 'this_shouldnt_exist'):
