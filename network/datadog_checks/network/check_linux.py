...
from khulnasoft_checks.base.utils.common import pattern_filter
from khulnasoft_checks.base.utils.subprocess_output import SubprocessOutputEmptyError, get_subprocess_output
from khulnasoft_checks.network import ethtool
from khulnasoft_checks.network.const import ENA_METRIC_NAMES, ENA_METRIC_PREFIX
...
class LinuxNetwork(Network):
    ...
    def check(self, _):
        ...
        """
        proc_location = khulnasoft_agent.get_config('procfs_path')
