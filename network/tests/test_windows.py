...
from khulnasoft_checks.network.check_windows import WindowsNetwork
...
@mock.patch('khulnasoft_checks.network.network.Platform.is_solaris', return_value=False)
@mock.patch('khulnasoft_checks.network.network.Platform.is_windows', return_value=True)
...
def test_cx_state_psutil(aggregator):
    ...
    with mock.patch('khulnasoft_checks.network.check_windows.psutil') as mock_psutil:
