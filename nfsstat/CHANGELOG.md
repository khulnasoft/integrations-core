...
* Add `pyproject.toml` file ([#11403](https://github.com/KhulnaSoft/integrations-core/pull/11403))
...
* Add runtime configuration validation ([#8961](https://github.com/KhulnaSoft/integrations-core/pull/8961))
...
* Avoid logging warnings if AutoFS is enabled ([#6903](https://github.com/KhulnaSoft/integrations-core/pull/6903))
* Add specs and use new signature ([#6780](https://github.com/KhulnaSoft/integrations-core/pull/6780))
...
* Fix nfsiostat command ([#6650](https://github.com/KhulnaSoft/integrations-core/pull/6650))
...
* Fix non-ascii mounted folder name ([#3805](https://github.com/KhulnaSoft/integrations-core/pull/3805))

## 1.4.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3544](https://github.com/KhulnaSoft/integrations-core/pull/3544))

## 1.3.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Support Python 3 ([#3228](https://github.com/KhulnaSoft/integrations-core/pull/3228))

## 1.2.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Don't raise Exception when No NFS mounts could be found ([#3069](https://github.com/KhulnaSoft/integrations-core/pull/3069))

## 1.1.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2775](https://github.com/KhulnaSoft/integrations-core/pull/2775))

## 1.0.0 / 2018-10-13 / Agent 6.6.0

***Added***:

* NFSIOStat Check ([#720](https://github.com/KhulnaSoft/integrations-core/pull/720))
...
* makes reports output stats in actual realtime ([#974](https://github.com/KhulnaSoft/integrations-core/pull/974))

## 0.1.0 / 2017-10-10

***Added***:

* adds nfsstat integration ([#720](https://github.com/KhulnaSoft/integrations-core/issues/720))
