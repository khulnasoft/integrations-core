...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'nfsstat', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-nfsstat',
    version=ABOUT["__version__"],
    description='The NFSstat check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent nfsstat check',
    ...
    packages=['khulnasoft_checks.nfsstat'],
