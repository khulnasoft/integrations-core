...
from khulnasoft_checks.base import ensure_unicode
from khulnasoft_checks.nfsstat import NfsStatCheck
...
class TestNfsstat:
    ...
    def test_no_devices(self, aggregator):
        ...
        with mock.patch(
            'khulnasoft_checks.nfsstat.nfsstat.get_subprocess_output',
    ...
    def test_check(self, aggregator):
        ...
        with mock.patch('khulnasoft_checks.nfsstat.nfsstat.get_subprocess_output', return_value=(mock_output, '', 0)):
            c.check(instance)
