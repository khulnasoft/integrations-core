...
* Adjust endpoint detection logic for warn log ([#11567](https://github.com/KhulnaSoft/integrations-core/pull/11567))

## 5.2.0 / 2022-02-19

***Added***:

* Add `pyproject.toml` file ([#11404](https://github.com/KhulnaSoft/integrations-core/pull/11404))
...
* Allow for percentile aggregations for NGINX integration response time metrics ([#11252](https://github.com/KhulnaSoft/integrations-core/pull/11252))

***Fixed***:

* Instruct the user to fix the error ([#11107](https://github.com/KhulnaSoft/integrations-core/pull/11107))
...
* Add option to dynamically determine what APIs to query for metrics ([#10815](https://github.com/KhulnaSoft/integrations-core/pull/10815))

***Fixed***:

* Bump base package ([#11061](https://github.com/KhulnaSoft/integrations-core/pull/11061))
...
* Add support for NGINX Plus versions 4-7 ([#10750](https://github.com/KhulnaSoft/integrations-core/pull/10750))

## 4.0.0 / 2021-10-04 / Agent 7.32.0

***Changed***:

* Add disable generic tags option ([#10249](https://github.com/KhulnaSoft/integrations-core/pull/10249))
...
* Add runtime configuration validation ([#8962](https://github.com/KhulnaSoft/integrations-core/pull/8962))
...
* Lower log level for version metadata submission ([#8448](https://github.com/KhulnaSoft/integrations-core/pull/8448))

## 3.11.0 / 2021-01-25

***Added***:

* Add support for nginx API v3 ([#8392](https://github.com/KhulnaSoft/integrations-core/pull/8392))

## 3.10.1 / 2020-11-16 / Agent 7.25.0

***Fixed***:

* Fix version metadata collection ([#7972](https://github.com/KhulnaSoft/integrations-core/pull/7972))
...
* Option to disable stream api checking in Nginx Plus ([#7241](https://github.com/KhulnaSoft/integrations-core/pull/7241)) Thanks [szibis](https://github.com/szibis).
...
* Add config specs ([#6797](https://github.com/KhulnaSoft/integrations-core/pull/6797))
...
* Handle missing version ([#5250](https://github.com/KhulnaSoft/integrations-core/pull/5250))

## 3.5.0 / 2019-12-02 / Agent 7.16.0

***Added***:

* Submit version metadata ([#4736](https://github.com/KhulnaSoft/integrations-core/pull/4736))
...
* Add requests wrapper to Nginx ([#4268](https://github.com/KhulnaSoft/integrations-core/pull/4268))

## 3.2.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Simplify JSON flattening for timestamps and bool ([#3648](https://github.com/KhulnaSoft/integrations-core/pull/3648)) Thanks [jd](https://github.com/jd).
* Adhere to code style ([#3545](https://github.com/KhulnaSoft/integrations-core/pull/3545))

## 3.1.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2716](https://github.com/KhulnaSoft/integrations-core/pull/2716))

## 3.0.0 / 2018-09-04 / Agent 6.5.0

***Changed***:

* Send correct count values for NGINX ever increasing counters ([#2041](https://github.com/KhulnaSoft/integrations-core/pull/2041))
...
* Log warning, not exception, when trying to collect stream metrics ([#1536](https://github.com/KhulnaSoft/integrations-core/pull/1536))

***Added***:

* Add support for VTS module ([#1295](https://github.com/KhulnaSoft/integrations-core/pull/1295)) Thanks [mattjbray](https://github.com/mattjbray)
...
* Better process status output for good metric names. Breaking if using the badly named metrics in app ([#1053](https://github.com/KhulnaSoft/integrations-core/issues/1053)

## 1.2.0 / 2018-02-13

***Added***:

* Make the check compatible with the new Plus API. [#1013](https://github.com/KhulnaSoft/integrations-core/issues/1013)
* Adding configuration for log collection in `conf.yaml`
* allows the bypassing of proxy settings ([#1051](https://github.com/KhulnaSoft/integrations-core/pull/1051))

## 1.1.0 / 2017-07-18

***Fixed***:

* adds duplicate nginx.upstream.peers.response.*xx_count metrics with type count. [#559](https://github.com/KhulnaSoft/integrations-core/issues/559)
