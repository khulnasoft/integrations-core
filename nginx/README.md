...
metadata:
  name: nginx
  annotations:
    ad.khulnasoft.com/nginx.check_names: '["nginx"]'
    ad.khulnasoft.com/nginx.init_configs: '[{}]'
    ad.khulnasoft.com/nginx.instances: |
      [
        {
...
metadata:
  name: nginx
  annotations:
    ad.khulnasoft.com/nginx.checks: |
      {
        "nginx": {
          "init_config": {},
          "instances": [
...
metadata:
  name: nginx
  annotations:
    ad.khulnasoft.com/nginx.logs: '[{"source":"nginx","service":"nginx"}]'
  labels:
    name: nginx
```
...
[6]: https://github.com/KhulnaSoft/integrations-core/blob/master/nginx/khulnasoft_checks/nginx/data/conf.yaml.example
...
[9]: https://docs.khulnasoft.com/agent/docker/log/?tab=containerinstallation#installation
[10]: https://docs.khulnasoft.com/agent/docker/log/?tab=containerinstallation#log-integrations
[11]: https://docs.khulnasoft.com/agent/kubernetes/integrations/
[12]: https://docs.khulnasoft.com/agent/kubernetes/integrations/?tab=kubernetes#configuration
[13]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=containerinstallation#setup
[14]: https://docs.khulnasoft.com/agent/kubernetes/log/?tab=daemonset#configuration
[15]: https://docs.khulnasoft.com/agent/amazon_ecs/logs/?tab=linux
[16]: https://docs.khulnasoft.com/agent/guide/agent-commands/#agent-status-and-information
[17]: https://github.com/KhulnaSoft/integrations-core/blob/master/nginx/metadata.csv
[18]: https://github.com/KhulnaSoft/integrations-core/blob/master/nginx/assets/service_checks.json
[19]: https://docs.khulnasoft.com/logs/faq/why-do-my-logs-not-have-the-expected-timestamp/
