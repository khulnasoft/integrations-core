...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'nginx', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-nginx',
    version=ABOUT["__version__"],
    description='The Nginx check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent nginx check',
    ...
    packages=['khulnasoft_checks.nginx'],
