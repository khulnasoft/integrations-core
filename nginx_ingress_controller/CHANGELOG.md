...
* Add `pyproject.toml` file ([#11405](https://github.com/KhulnaSoft/integrations-core/pull/11405))
...
* Add runtime configuration validation ([#8963](https://github.com/KhulnaSoft/integrations-core/pull/8963))
...
* fix which prometheus metric is used for reload.success to properly monitor nginx config reload errors ([#7595](https://github.com/KhulnaSoft/integrations-core/pull/7595)) Thanks [rocktavious](https://github.com/rocktavious).
...
* Add flag to collect subset of histogram metrics ([#6860](https://github.com/KhulnaSoft/integrations-core/pull/6860))
* Add configuration spec ([#6857](https://github.com/KhulnaSoft/integrations-core/pull/6857))
* Add response duration metric to nginx ingress controller check ([#6836](https://github.com/KhulnaSoft/integrations-core/pull/6836))
...
* Adhere to code style ([#3546](https://github.com/KhulnaSoft/integrations-core/pull/3546))
