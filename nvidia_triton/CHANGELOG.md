...
* Nvidia Triton supports log collection:
  ...
  - Add classifier for log collection. ([#16438](https://github.com/KhulnaSoft/integrations-core/pull/16438))

## 1.0.0 / 2023-11-10 / Agent 7.50.0

***Added***:

* Add Nvidia Triton integration. ([#15918](https://github.com/KhulnaSoft/integrations-core/pull/15918))
