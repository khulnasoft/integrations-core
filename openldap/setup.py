...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "openldap", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    packages=['khulnasoft_checks.openldap'],
    # Run-time dependencies
    install_requires=[CHECKS_BASE_REQ],
    extras_require={'deps': parse_pyproject_array('deps')},
    # Extra files to ship with the wheel package
    package_data={'khulnasoft_checks.openldap': ['conf.yaml.example']},
