...
def test_check(check, aggregator, mocker):
    ...
    mocker.patch("khulnasoft_checks.openldap.openldap.ldap3.Server", return_value=server_mock)
    mocker.patch("khulnasoft_checks.openldap.openldap.ldap3.Connection", return_value=conn_mock)
...
def test__get_tls_object(check, mocker):
    os_mock = mocker.patch("khulnasoft_checks.openldap.openldap.os")
    ldap3_tls_mock = mocker.patch("khulnasoft_checks.openldap.openldap.ldap3.core.tls.Tls")
    ssl_mock = mocker.patch("khulnasoft_checks.openldap.openldap.ssl")
