...
* Bump minimum base package version ([#15303](https://github.com/KhulnaSoft/integrations-core/pull/15303))
...
* Bumps base check requirement to v25.4.0 ([#12734](https://github.com/KhulnaSoft/integrations-core/pull/12734))

## 2.2.2 / 2022-08-05 / Agent 7.39.0

***Fixed***:

* Hide `extra_metrics` in example config ([#12470](https://github.com/KhulnaSoft/integrations-core/pull/12470))
...
* Don't tag by endpoint on default config ([#11966](https://github.com/KhulnaSoft/integrations-core/pull/11966))
...
* Add `pyproject.toml` file ([#11407](https://github.com/KhulnaSoft/integrations-core/pull/11407))
...
* Add runtime configuration validation ([#8965](https://github.com/KhulnaSoft/integrations-core/pull/8965))
...
* Update documentation for v2 ([#10068](https://github.com/KhulnaSoft/integrations-core/pull/10068))
...
* Allow the use of the new OpenMetrics implementation ([#8440](https://github.com/KhulnaSoft/integrations-core/pull/8440))
...
* Sync OpenMetrics config ([#6250](https://github.com/KhulnaSoft/integrations-core/pull/6250))
...
* Use Kube service account bearer token for authentication ([#3829](https://github.com/KhulnaSoft/integrations-core/pull/3829))

## 1.1.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3549](https://github.com/KhulnaSoft/integrations-core/pull/3549))
...
* Add OpenMetrics integration ([#2148](https://github.com/KhulnaSoft/integrations-core/pull/2148))
