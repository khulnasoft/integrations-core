...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "openmetrics", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-openmetrics',
    version=ABOUT["__version__"],
    description='The openmetrics check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent openmetrics check',
    ...
    packages=['khulnasoft_checks.openmetrics'],
