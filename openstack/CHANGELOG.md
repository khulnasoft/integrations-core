...
* Add missing config_models files and update the base check version ([#16299](https://github.com/KhulnaSoft/integrations-core/pull/16299))
...
* Add `pyproject.toml` file ([#11408](https://github.com/KhulnaSoft/integrations-core/pull/11408))
...
* Openstack log support ([#9116](https://github.com/KhulnaSoft/integrations-core/pull/9116))

***Fixed***:

* Include missing default config templates ([#9150](https://github.com/KhulnaSoft/integrations-core/pull/9150))
...
* Use agent v6 init signature ([#6830](https://github.com/KhulnaSoft/integrations-core/pull/6830))
...
* Fix documented default for `use_agent_proxy` ([#4517](https://github.com/KhulnaSoft/integrations-core/pull/4517))
...
* Adhere to code style ([#3550](https://github.com/KhulnaSoft/integrations-core/pull/3550))

## 1.7.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#3035](https://github.com/KhulnaSoft/integrations-core/pull/3035))
...
* Remove duplicate project call and reword os_host config option ([#2066](https://github.com/KhulnaSoft/integrations-core/pull/2066))
* Use is_affirmative on boolean options ([#2071](https://github.com/KhulnaSoft/integrations-core/pull/2071))
...
* Only use the short hostname when making "host" queries to Nova ([#2070](https://github.com/KhulnaSoft/integrations-core/pull/2070))

## 1.3.0 / 2018-06-06

***Added***:

*  Added support for unscoped access, implemented caching mechanism to reduce API calls to Nova ([#1276](https://github.com/KhulnaSoft/integrations-core/pull/1276))
...
* Adds parameter to collect metrics on all projects in a domain ([#1119](https://github.com/KhulnaSoft/integrations-core/issues/1119)
* Added support for Agent >= 6.0 ([#1126](https://github.com/KhulnaSoft/integrations-core/issues/1126)

***Fixed***:

* Properly disable the Agent's proxy settings when desired ([#1123](https://github.com/KhulnaSoft/integrations-core/issues/1123)

## 1.0.2 / 2017-11-21

***Changed***:

* Don't check on powered off VMs ([#878](https://github.com/KhulnaSoft/integrations-core/issues/878)

## 1.0.1 / 2017-08-28

***Added***:

* Adds human friendly "project_name" tag in all cases ([#515](https://github.com/KhulnaSoft/integrations-core/issues/515)
