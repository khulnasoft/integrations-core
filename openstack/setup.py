...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "openstack", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-openstack',
    version=ABOUT['__version__'],
    description='The Openstack check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent openstack check',
    ...
    packages=['khulnasoft_checks.openstack'],
