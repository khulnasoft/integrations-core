...
* Fix ironic nodes pagination logic ([#16566](https://github.com/KhulnaSoft/integrations-core/pull/16566))
...
* Add pagination support for ironic nodes endpoint ([#16400](https://github.com/KhulnaSoft/integrations-core/pull/16400))

***Fixed***:

* Use params arg over manual url encoding for requests with query params ([#16200](https://github.com/KhulnaSoft/integrations-core/pull/16200))

## 6.1.0 / 2023-11-10 / Agent 7.50.0

***Added***:

* Add support for glance component. ([#16186](https://github.com/KhulnaSoft/integrations-core/pull/16186))

## 6.0.0 / 2023-11-07

***Changed***:

* Refactor integration and add support for Ironic and Octavia components. ([#15918](https://github.com/KhulnaSoft/integrations-core/pull/15918))
...
* Add runtime configuration validation ([#14362](https://github.com/KhulnaSoft/integrations-core/pull/14362))
...
* Standardize log messages ([#14072](https://github.com/KhulnaSoft/integrations-core/pull/14072))
...
* Pin the keystoneauth1 version for py2 ([#13445](https://github.com/KhulnaSoft/integrations-core/pull/13445))
...
* Attempt to use token from project scope with an admin role ([#12135](https://github.com/KhulnaSoft/integrations-core/pull/12135))
...
* Add `pyproject.toml` file ([#11409](https://github.com/KhulnaSoft/integrations-core/pull/11409))
...
* Do not leak password on logs ([#9637](https://github.com/KhulnaSoft/integrations-core/pull/9637))

## 1.11.0 / 2021-04-19 / Agent 7.28.0

***Added***:

* Openstack controller log support ([#9115](https://github.com/KhulnaSoft/integrations-core/pull/9115))

***Fixed***:

* Fix refactored imports ([#9136](https://github.com/KhulnaSoft/integrations-core/pull/9136))
* Add config spec for Openstack Controller ([#9092](https://github.com/KhulnaSoft/integrations-core/pull/9092))

## 1.10.3 / 2021-02-11 / Agent 7.27.0

***Fixed***:

* Remove SimpleApi cache ([#8583](https://github.com/KhulnaSoft/integrations-core/pull/8583))
...
* Bump khulnasoft_checks_base dependency to 11.0.0 ([#5838](https://github.com/KhulnaSoft/integrations-core/pull/5838))
...
* Add requests wrapper to openstack_controller ([#4365](https://github.com/KhulnaSoft/integrations-core/pull/4365))
...
* Retrieve floating IPs from network quotas ([#4079](https://github.com/KhulnaSoft/integrations-core/pull/4079))

## 1.3.0 / 2019-07-09

***Added***:

* Make keystone_server_url config optional in openstack_controller config ([#3920](https://github.com/KhulnaSoft/integrations-core/pull/3920))
* Openstack: introduce artificial metric in controller to distinguish from legacy integration ([#4036](https://github.com/KhulnaSoft/integrations-core/pull/4036))
...
* Sanitize external host tags ([#3792](https://github.com/KhulnaSoft/integrations-core/pull/3792))

## 1.2.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3551](https://github.com/KhulnaSoft/integrations-core/pull/3551))

## 1.1.2 / 2019-04-15

***Fixed***:

* Get details for both private and public flavors ([#3621](https://github.com/KhulnaSoft/integrations-core/pull/3621))

## 1.1.1 / 2019-03-21 / Agent 6.11.0

***Fixed***:

* Fix issue with exception handling preventing re-authentication in case of token expiration ([#3321](https://github.com/KhulnaSoft/integrations-core/pull/3321))

## 1.1.0 / 2019-03-15

***Added***:

* Add project tags to hypervisor metrics ([#3277](https://github.com/KhulnaSoft/integrations-core/pull/3277))
* Add openstacksdk option to openstack_controller ([#3109](https://github.com/KhulnaSoft/integrations-core/pull/3109))

***Fixed***:

* Fix pagination logic when making request to get servers/flavors details ([#3301](https://github.com/KhulnaSoft/integrations-core/pull/3301))
* Refactor openstack_controller check api and back caches ([#3142](https://github.com/KhulnaSoft/integrations-core/pull/3142))

## 1.0.1 / 2019-02-18 / Agent 6.10.0

***Fixed***:

* Refactor openstack_controller check cache ([#3120](https://github.com/KhulnaSoft/integrations-core/pull/3120))

## 1.0.0 / 2019-02-04

***Added***:

* OpenStack Controller ([#2496](https://github.com/KhulnaSoft/integrations-core/pull/2496))
