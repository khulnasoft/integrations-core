...
from khulnasoft_checks.base import AgentCheck, is_affirmative
from khulnasoft_checks.base.utils.discovery import Discovery
from khulnasoft_checks.openstack_controller.api.factory import make_api
from khulnasoft_checks.openstack_controller.components.bare_metal import BareMetal
from khulnasoft_checks.openstack_controller.components.block_storage import BlockStorage
from khulnasoft_checks.openstack_controller.components.compute import Compute
from khulnasoft_checks.openstack_controller.components.identity import Identity
from khulnasoft_checks.openstack_controller.components.image import Image
from khulnasoft_checks.openstack_controller.components.load_balancer import LoadBalancer
from khulnasoft_checks.openstack_controller.components.network import Network
from khulnasoft_checks.openstack_controller.config import OpenstackConfig, normalize_discover_config_include
...
class OpenStackControllerCheck(AgentCheck, ConfigMixin):
    def __new__(cls, name, init_config, instances):
        ...
        if is_affirmative(instances[0].get('use_legacy_check_version', True)):
            from khulnasoft_checks.openstack_controller.legacy.openstack_controller_legacy import (
