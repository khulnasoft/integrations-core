...
@mock.patch(
    'khulnasoft_checks.openstack_controller.legacy.api.SimpleApi._make_request', side_effect=make_request_responses
)
def test_scenario(make_request, aggregator):
    ...
    with mock.patch(
        'khulnasoft_checks.openstack_controller.legacy.api.Authenticator._post_auth_token',
