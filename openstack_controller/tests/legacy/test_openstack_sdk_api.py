...
from khulnasoft_checks.openstack_controller.legacy.api import OpenstackSDKApi
...
def test_get_endpoint():
    ...
    with mock.patch(
        'khulnasoft_checks.openstack_controller.legacy.api.OpenstackSDKApi._get_service',
