...
from khulnasoft_checks.openstack_controller.api.type import ApiType
...
@pytest.mark.skipif(
    Version(metadata("khulnasoft_checks_base")["VERSION"]) < Version("34.1.2"),
    reason='assert_external_tags was added in version 34.1.2',
)
def test_external_tags(khulnasoft_agent, dd_run_check, check):
    dd_run_check(check)
    khulnasoft_agent.assert_external_tags(
    ...
    khulnasoft_agent.assert_external_tags_count(16)
