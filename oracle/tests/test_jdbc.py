...
from khulnasoft_checks.oracle import Oracle
...
def test__get_connection_jdbc(instance, dd_run_check, aggregator, expected_tags, dsn, jdbc_connect_properties):
    ...
    mocks = [
        ('khulnasoft_checks.oracle.oracle.jdb', jdb),
        ('khulnasoft_checks.oracle.oracle.jpype', jpype),
        ('khulnasoft_checks.oracle.oracle.JDBC_IMPORT_ERROR', None),
    ]
