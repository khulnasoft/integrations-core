...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'pan_firewall', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-pan_firewall',
    version=ABOUT['__version__'],
    description='The pan_firewall check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent pan_firewall check',
    ...
    packages=['khulnasoft_checks.pan_firewall'],
