...
* Add `pyproject.toml` file ([#11412](https://github.com/KhulnaSoft/integrations-core/pull/11412))
...
* Add runtime configuration validation ([#8967](https://github.com/KhulnaSoft/integrations-core/pull/8967))
...
* add counterset validation in pdh check ([#7386](https://github.com/KhulnaSoft/integrations-core/pull/7386))

## 1.12.0 / 2020-08-10 / Agent 7.22.0

***Added***:

* Add config spec ([#7153](https://github.com/KhulnaSoft/integrations-core/pull/7153))
...
* PDH check to use new agent signature ([#6159](https://github.com/KhulnaSoft/integrations-core/pull/6159))
...
* Make the admin share configurable ([#5485](https://github.com/KhulnaSoft/integrations-core/pull/5485))
...
* Make PDHCheck use PDHBaseCHeck ([#3818](https://github.com/KhulnaSoft/integrations-core/pull/3818))

## 1.5.0 / 2019-05-14

***Added***:

* Adhere to code style ([#3553](https://github.com/KhulnaSoft/integrations-core/pull/3553))

## 1.4.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 ([#3049](https://github.com/KhulnaSoft/integrations-core/pull/3049))
...
* Fix tag key-value separator. [#927](https://github.com/KhulnaSoft/integrations-core/issues/927)
