...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'pdh_check', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    packages=['khulnasoft_checks.pdh_check'],
