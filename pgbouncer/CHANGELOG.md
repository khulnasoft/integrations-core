...
* Drop support for Python 2 ([#15949](https://github.com/KhulnaSoft/integrations-core/pull/15949))
...
* Add `pgbouncer_db` tag into pgbouncer metrics and remove `name` tag from pool metrics ([#13976](https://github.com/KhulnaSoft/integrations-core/pull/13976))

## 4.4.0 / 2023-02-15

***Added***:

* Add `name` tag to pool metrics ([#13952](https://github.com/KhulnaSoft/integrations-core/pull/13952))
...
* Add per-client/server metrics ([#12350](https://github.com/KhulnaSoft/integrations-core/pull/12350)) Thanks [jcoleman](https://github.com/jcoleman).

## 4.2.1 / 2022-05-15 / Agent 7.37.0

***Fixed***:

* Handle errors for individual rows ([#11993](https://github.com/KhulnaSoft/integrations-core/pull/11993))
...
* Add `pyproject.toml` file ([#11414](https://github.com/KhulnaSoft/integrations-core/pull/11414))
...
* Add runtime configuration validation ([#8968](https://github.com/KhulnaSoft/integrations-core/pull/8968))

## 3.1.0 / 2021-09-06 / Agent 7.32.0

***Added***:

* Add max_client_conn metric ([#10033](https://github.com/KhulnaSoft/integrations-core/pull/10033)) Thanks [JordanP](https://github.com/JordanP).
...
* Make pgbouncer more reslient ([#8124](https://github.com/KhulnaSoft/integrations-core/pull/8124))
...
* Add config spec ([#7589](https://github.com/KhulnaSoft/integrations-core/pull/7589))
...
* Support more recent version in metadata ([#6634](https://github.com/KhulnaSoft/integrations-core/pull/6634))

## 1.9.0 / 2020-04-01 / Agent 7.19.0

***Added***:

* Adding maxwait_us, total_wait_time, and avg_wait_time metrics ([#6180](https://github.com/KhulnaSoft/integrations-core/pull/6180)) Thanks [blaines](https://github.com/blaines).
* Add pgbouncer version metadata ([#5761](https://github.com/KhulnaSoft/integrations-core/pull/5761))
* Refactor check code ([#5737](https://github.com/KhulnaSoft/integrations-core/pull/5737))
...
* Add logs section ([#3961](https://github.com/KhulnaSoft/integrations-core/pull/3961))
...
* Adhere to code style ([#3554](https://github.com/KhulnaSoft/integrations-core/pull/3554))

***Fixed***:

* Use name instead of db to identify databases from SHOW DATABASES ([#3459](https://github.com/KhulnaSoft/integrations-core/pull/3459)) Thanks [joekohlsdorf](https://github.com/joekohlsdorf).

## 1.5.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Add support for database metrics ([#2777](https://github.com/KhulnaSoft/integrations-core/pull/2777)) Thanks [joekohlsdorf](https://github.com/joekohlsdorf).
* Support Python 3 ([#3039](https://github.com/KhulnaSoft/integrations-core/pull/3039))
...
* Failure to reconnect to PGBouncer when using database URL ([#2587](https://github.com/KhulnaSoft/integrations-core/pull/2587)) Thanks [VSpike](https://github.com/VSpike).
...
* Add the ability to specify 'use_cached' connections in config ([#2000](https://github.com/KhulnaSoft/integrations-core/pull/2000)) Thanks [kellydunn](https://github.com/kellydunn).
...
* Added new metrics for PGBouncer 1.8 `SHOW STATS` and `SHOW POOLS` See [#1016](https://github.com/KhulnaSoft/integrations-core/issues/1016)

## 1.0.2 / 2017-11-21

***Fixed***:

* Fixed newest versions failing checks due to extra field ([#735](https://github.com/KhulnaSoft/integrations-core/issues/735)
