...
from khulnasoft_checks.pgbouncer import PgBouncer
...
def test_check(instance, aggregator, khulnasoft_agent, dd_run_check):
    # add some stats
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_check_with_clients(instance, aggregator, khulnasoft_agent, dd_run_check):
    # add some stats
    connection = psycopg2.connect(
        host=common.HOST,
        port=common.PORT,
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_check_with_servers(instance, aggregator, khulnasoft_agent, dd_run_check):
    # add some stats
    connection = psycopg2.connect(
        host=common.HOST,
        port=common.PORT,
...
@pytest.mark.integration
@pytest.mark.usefixtures("dd_environment")
def test_check_with_url(instance_with_url, aggregator, khulnasoft_agent, dd_run_check):
    # run the check
