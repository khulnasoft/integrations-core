...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'php_fpm', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-php_fpm',
    version=ABOUT['__version__'],
    description='The PHP FPM check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent php_fpm check',
    ...
    packages=['khulnasoft_checks.php_fpm'],
