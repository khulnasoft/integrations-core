...
1. Edit the file `postfix.d/conf.yaml`, in the `conf.d/` folder at the root of your [Agent's configuration directory][3]. See the [sample postfix.d/conf.yaml][4] for all available configuration options:
   ...
   instances:
     ...
     ## information see https://docs.khulnasoft.com/integrations/postfix/#using-sudo.
     #
...
[1]: https://raw.githubusercontent.com/KhulnaSoft/integrations-core/master/postfix/images/postfixgraph.png
[2]: https://app.khulnasoft.com/account/settings/agent/latest
[3]: https://docs.khulnasoft.com/agent/guide/agent-configuration-files/#agent-configuration-directory
[4]: https://github.com/KhulnaSoft/integrations-core/blob/master/postfix/khulnasoft_checks/postfix/data/conf.yaml.example
...
[8]: https://github.com/KhulnaSoft/integrations-core/blob/master/postfix/metadata.csv
[9]: https://docs.khulnasoft.com/help/
[10]: https://www.khulnasoft.com/blog/monitor-postfix-queues
