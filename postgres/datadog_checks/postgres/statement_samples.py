...
from khulnasoft_checks.base.utils.time import get_timestamp
from khulnasoft_checks.base.utils.tracking import tracked_method
from khulnasoft_checks.postgres.explain_parameterized_queries import ExplainParameterizedQueries
...
class PostgresStatementSamples(DBMAsyncJob):
        ...
        try:
            ...
            self._check.record_warning(
                ...
                warning_with_tags(
                    ...
                    "https://docs.khulnasoft.com/database_monitoring/setup_postgres/troubleshooting#%s "
                    "for more details: %s",
                    dbname,
    ...
    def _collect_plan_for_statement(self, row):
        ...
        if plan_dict:
            ...
            try:
                normalized_plan = khulnasoft_agent.obfuscate_sql_exec_plan(plan, normalize=True)
