...
from khulnasoft_checks.base.utils.db.statement_metrics import StatementMetrics
from khulnasoft_checks.base.utils.db.utils import DBMAsyncJob, default_json_event_encoding, obfuscate_sql_with_metadata
            ...
            if pg_stat_statements_max > self._pg_stat_statements_max_warning_threshold:
                self._check.record_warning(
                    ...
                    warning_with_tags(
                        ...
                        "See https://docs.khulnasoft.com/database_monitoring/setup_postgres/"
            ...
            if (
                ...
                self._check.record_warning(
                    ...
                    warning_with_tags(
                        ...
                        "in database '%s'. See https://docs.khulnasoft.com/database_monitoring/setup_postgres/"
                        "troubleshooting#%s for more details",
                        self._config.dbname,
                ...
                self._check.warning(
                    warning_with_tags(
                        ...
                        "in database '%s'. See https://docs.khulnasoft.com/database_monitoring/troubleshooting for "
                        "help: %s",
                        self._config.dbname,
                        str(e),
                        host=self._check.resolved_hostname,
