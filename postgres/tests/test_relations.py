...
from khulnasoft_checks.postgres.relationsmanager import QUERY_PG_CLASS, RelationsManager
...
def test_vacuum_age(aggregator, integration_check, pg_instance):
    pg_instance['relations'] = ['persons']
    pg_instance['dbname'] = 'khulnasoft_test'
    ...
    expected_tags = _get_expected_tags(check, pg_instance, db='khulnasoft_test', table='persons', schema='public')
