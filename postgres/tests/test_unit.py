...
from khulnasoft_checks.postgres import PostgreSql, util
...
def test_version_metadata(check, test_case, params):
    ...
    with mock.patch('khulnasoft_checks.base.stubs.khulnasoft_agent.set_check_metadata') as m:
...
def test_resolved_hostname(disable_generic_tags, expected_hostname, pg_instance):
    ...
    with mock.patch(
        'khulnasoft_checks.postgres.PostgreSql.resolve_db_host', return_value='resolved.hostname'
