...
* Add `pyproject.toml` file ([#11418](https://github.com/KhulnaSoft/integrations-core/pull/11418))
...
* Add runtime configuration validation ([#8972](https://github.com/KhulnaSoft/integrations-core/pull/8972))
...
* Add config spec ([#7742](https://github.com/KhulnaSoft/integrations-core/pull/7742))
...
* Add version metadata ([#6916](https://github.com/KhulnaSoft/integrations-core/pull/6916))
...
* Add requests wrapper to powerdns_recursor ([#4261](https://github.com/KhulnaSoft/integrations-core/pull/4261))

## 1.3.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3558](https://github.com/KhulnaSoft/integrations-core/pull/3558))

## 1.2.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2789][1])
...
* adds powerdns_recursor integration.

[1]: https://github.com/KhulnaSoft/integrations-core/pull/2789
