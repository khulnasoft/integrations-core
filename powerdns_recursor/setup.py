...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "powerdns_recursor", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-powerdns_recursor',
    version=ABOUT["__version__"],
    description='The PowerDNS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent powerdns_recursor check',
    ...
    packages=['khulnasoft_checks.powerdns_recursor'],
