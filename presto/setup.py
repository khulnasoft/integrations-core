...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'presto', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-presto',
    version=ABOUT['__version__'],
    description='The Presto check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent presto check',
    ...
    packages=['khulnasoft_checks.presto'],
