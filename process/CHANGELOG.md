...
* Change log level to debug ([#13080](https://github.com/KhulnaSoft/integrations-core/pull/13080)) Thanks [rsafonseca](https://github.com/rsafonseca).
...
* Add `pyproject.toml` file ([#11420](https://github.com/KhulnaSoft/integrations-core/pull/11420))
...
* Lower warning to debug level ([#10414](https://github.com/KhulnaSoft/integrations-core/pull/10414))
...
* Update logic to run sudo for `num_fds` ([#10109](https://github.com/KhulnaSoft/integrations-core/pull/10109))
...
* Add runtime configuration validation ([#8974](https://github.com/KhulnaSoft/integrations-core/pull/8974))
...
* Clear process cache if cached PIDs not found ([#8414](https://github.com/KhulnaSoft/integrations-core/pull/8414)) Thanks [gingerlime](https://github.com/gingerlime).

## 1.17.0 / 2020-12-28

***Added***:

* Clear stale PIDs from cache ([#8263](https://github.com/KhulnaSoft/integrations-core/pull/8263)) Thanks [gingerlime](https://github.com/gingerlime).
...
* Handle unfound processes in no matching PIDs logs ([#7474](https://github.com/KhulnaSoft/integrations-core/pull/7474)) Thanks [TheBooper](https://github.com/TheBooper).

## 1.15.1 / 2020-07-02 / Agent 7.21.0

***Fixed***:

* Fix NoSuchProcess log message level ([#7045](https://github.com/KhulnaSoft/integrations-core/pull/7045))

## 1.15.0 / 2020-06-29

***Added***:

* Config specs and new agent signature ([#6781](https://github.com/KhulnaSoft/integrations-core/pull/6781))
...
* Improve check performance ([#5920](https://github.com/KhulnaSoft/integrations-core/pull/5920))

## 1.11.1 / 2020-01-15 / Agent 7.17.0

***Fixed***:

* Fix debug logging ([#5460](https://github.com/KhulnaSoft/integrations-core/pull/5460))
...
* Uncomment required config: search_string ([#5359](https://github.com/KhulnaSoft/integrations-core/pull/5359))

## 1.10.4 / 2019-12-23

***Fixed***:

* Add debug logging when processes are not found ([#5313](https://github.com/KhulnaSoft/integrations-core/pull/5313))
...
* Make iowrite_bytes and ioread_bytes counts ([#4655](https://github.com/KhulnaSoft/integrations-core/pull/4655))
...
* Adhere to code style ([#3559](https://github.com/KhulnaSoft/integrations-core/pull/3559))

***Fixed***:

* Do not return prematurely when calling `memory_info` on windows and solaris ([#3618](https://github.com/KhulnaSoft/integrations-core/pull/3618))
...
* Finish Python 3 Support ([#2950](https://github.com/KhulnaSoft/integrations-core/pull/2950))

## 1.7.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2812](https://github.com/KhulnaSoft/integrations-core/pull/2812))
...
* Added regex support to process check when exact_match is False. ([#2055](https://github.com/KhulnaSoft/integrations-core/pull/2055)) Thanks [asandeep](https://github.com/asandeep).
* [Add] Add cpu.normalized_pct metric ([#1729](https://github.com/KhulnaSoft/integrations-core/pull/1729))
...
* Add option to use sudo for privileged process checks on file descriptors ([#1530](https://github.com/KhulnaSoft/integrations-core/pull/1530), thanks [@pdecat](https://github.com/pdecat))

## 1.2.0 / 2018-01-10

***Added***:

* Filter processes by user ([#337](https://github.com/KhulnaSoft/integrations-core/pull/337)

## 1.1.2 / 2017-08-28

***Added***:

* Better logging when a process was not found ([#609](https://github.com/KhulnaSoft/integrations-core/pull/609)

## 1.1.1 / 2017-07-18

***Fixed***:

* Make process validation case-insensitve on Windows See [#479](https://github.com/KhulnaSoft/integrations-core/pull/479)

## 1.1.0 / 2017-06-05

***Added***:

* Add option to collect metrics for children of matched processes ([#425](https://github.com/KhulnaSoft/integrations-core/issues/425)

## 1.0.1 / 2017-05-11

***Fixed***:

* Handle the case where the pidfile doesn't exist ([#349](https://github.com/KhulnaSoft/integrations-core/issues/349)
