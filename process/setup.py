...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'process', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-process',
    version=ABOUT['__version__'],
    description='The Process check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent process check',
    ...
    packages=['khulnasoft_checks.process'],
