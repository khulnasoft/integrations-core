...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "prometheus", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='khulnasoft agent prometheus check',
    ...
    packages=['khulnasoft_checks.prometheus'],
