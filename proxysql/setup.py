...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'proxysql', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-proxysql',
    version=ABOUT['__version__'],
    description='The ProxySQL check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent proxysql check',
    ...
    packages=['khulnasoft_checks.proxysql'],
