...
* Add metric limit for rabbitmq ([#14541](https://github.com/KhulnaSoft/integrations-core/pull/14541))
...
* Fix autodiscovery config instances ([#14112](https://github.com/KhulnaSoft/integrations-core/pull/14112))

## 4.0.0 / 2023-03-03

***Changed***:

* Remove support for /metrics/per-object endpoint ([#13869](https://github.com/KhulnaSoft/integrations-core/pull/13869))

***Added***:

* Add autodiscovery for docker containers ([#13960](https://github.com/KhulnaSoft/integrations-core/pull/13960))

***Fixed***:

* Improve descriptions of config fields to select objects ([#14045](https://github.com/KhulnaSoft/integrations-core/pull/14045))

## 3.3.1 / 2023-01-27

***Fixed***:

* Add validation for `include_aggregated_endpoint` ([#13793](https://github.com/KhulnaSoft/integrations-core/pull/13793))

## 3.3.0 / 2023-01-20

***Added***:

* Support RabbitMQ Prometheus Metrics ([#13662](https://github.com/KhulnaSoft/integrations-core/pull/13662))
* Add drop unroutable metric ([#13553](https://github.com/KhulnaSoft/integrations-core/pull/13553)) Thanks [laststem](https://github.com/laststem).

## 3.2.0 / 2022-09-16 / Agent 7.40.0

***Added***:

* Add new metric to track size of queues in bytes ([#12869](https://github.com/KhulnaSoft/integrations-core/pull/12869))
...
* Add `pyproject.toml` file ([#11423](https://github.com/KhulnaSoft/integrations-core/pull/11423))
...
* Minor refactor ([#10270](https://github.com/KhulnaSoft/integrations-core/pull/10270))
...
* Fix documented default value of `use_legacy_auth_encoding` ([#9880](https://github.com/KhulnaSoft/integrations-core/pull/9880))

## 1.18.0 / 2021-06-23 / Agent 7.30.0

***Added***:

* Add runtime configuration validation ([#8976](https://github.com/KhulnaSoft/integrations-core/pull/8976))
...
* Add support for named groups in regular expressions ([#7814](https://github.com/KhulnaSoft/integrations-core/pull/7814)) Thanks [lkobus](https://github.com/lkobus).
...
* Add config specs ([#7467](https://github.com/KhulnaSoft/integrations-core/pull/7467))

***Fixed***:

* Ensure basic auth encoding defaults to UTF-8 ([#7451](https://github.com/KhulnaSoft/integrations-core/pull/7451))
...
* Add head_message_timestamp metric ([#6809](https://github.com/KhulnaSoft/integrations-core/pull/6809))

***Fixed***:

* Continue check execution when only a few vhosts are unhealthy ([#6954](https://github.com/KhulnaSoft/integrations-core/pull/6954))
...
* Add option to disable node metrics in rabbitmq ([#5750](https://github.com/KhulnaSoft/integrations-core/pull/5750))
...
* Add version metadata to RabbitMQ check ([#4918](https://github.com/KhulnaSoft/integrations-core/pull/4918))

## 1.10.1 / 2019-10-18 / Agent 6.15.0

***Fixed***:

* Fix for rabbit 3.1 queue_totals introduced in #4668 ([#4805](https://github.com/KhulnaSoft/integrations-core/pull/4805))

## 1.10.0 / 2019-10-11

***Added***:

* verifies if `root` is dict before doing `.get` ([#4668](https://github.com/KhulnaSoft/integrations-core/pull/4668))
...
* Ignore empty data for metrics limit ([#4544](https://github.com/KhulnaSoft/integrations-core/pull/4544))

## 1.9.1 / 2019-08-29 / Agent 6.14.0

***Fixed***:

* Revert "Fix queue, node and echange limit" ([#4467](https://github.com/KhulnaSoft/integrations-core/pull/4467))

## 1.9.0 / 2019-08-24

***Added***:

* Add mem_limit to RabbitMQ Checks ([#4250](https://github.com/KhulnaSoft/integrations-core/pull/4250)) Thanks [ParthKolekar](https://github.com/ParthKolekar).
* Add requests wrapper to RabbitMQ ([#4257](https://github.com/KhulnaSoft/integrations-core/pull/4257))

***Fixed***:

* Fix queue, node and echange limit ([#4108](https://github.com/KhulnaSoft/integrations-core/pull/4108))

## 1.8.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3561](https://github.com/KhulnaSoft/integrations-core/pull/3561))

***Fixed***:

* Fix default log path ([#3611](https://github.com/KhulnaSoft/integrations-core/pull/3611))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2791
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2706
[3]: https://github.com/KhulnaSoft/integrations-core/pull/2472
[4]: https://github.com/tebriel
[5]: https://github.com/KhulnaSoft/integrations-core/pull/2465
[6]: https://github.com/KhulnaSoft/integrations-core/pull/2449
[7]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[8]: https://github.com/KhulnaSoft/integrations-core/issues/1100
[9]: https://github.com/sylr
[10]: https://github.com/KhulnaSoft/integrations-core/pull/1057
[11]: https://github.com/KhulnaSoft/integrations-core/pull/176
[12]: https://github.com/wholroyd
[13]: https://github.com/KhulnaSoft/integrations-core/issues/902
[14]: https://github.com/dnavre
[15]: https://github.com/KhulnaSoft/integrations-core/issues/909
[16]: https://github.com/KhulnaSoft/integrations-core/issues/910
[17]: https://github.com/KhulnaSoft/integrations-core/issues/924
[18]: https://github.com/KhulnaSoft/integrations-core/issues/729
[19]: https://github.com/ian28223
[20]: https://github.com/KhulnaSoft/integrations-core/issues/674
[21]: https://github.com/KhulnaSoft/integrations-core/issues/635
[22]: https://github.com/KhulnaSoft/integrations-core/issues/504
[23]: https://github.com/KhulnaSoft/integrations-core/issues/506
[24]: https://github.com/KhulnaSoft/integrations-core/issues/514
[25]: https://github.com/jamescarr
[26]: https://github.com/KhulnaSoft/integrations-core/issues/407
