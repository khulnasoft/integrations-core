...
class PrometheusPlugin(BaseModel):
    ...
    include_aggregated_endpoint: Optional[bool] = None
    unaggregated_endpoint: Optional[str] = None
...
class InstanceConfig(BaseModel):
    ...
    nodes_regexes: Optional[tuple[str, ...]] = None
    ...
    prometheus_plugin: Optional[PrometheusPlugin] = None
    ...
    tag_families: Optional[bool] = None
    ...
    vhosts: Optional[tuple[str, ...]] = None
