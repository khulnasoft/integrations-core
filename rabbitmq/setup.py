...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'rabbitmq', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-rabbitmq',
    version=ABOUT['__version__'],
    description='The RabbitMQ check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent rabbitmq check',
    ...
    packages=['khulnasoft_checks.rabbitmq'],
