...
metadata:
  name: ray
  annotations:
    ad.khulnasoft.com/apache.logs: '[{"source":"ray","service":"ray"}]'
spec:
  containers:
    - name: ray
```
...
[4]: https://github.com/KhulnaSoft/integrations-core/blob/master/ray/khulnasoft_checks/ray/data/conf.yaml.example
...
[7]: https://github.com/KhulnaSoft/integrations-core/blob/master/ray/metadata.csv
[8]: https://github.com/KhulnaSoft/integrations-core/blob/master/ray/assets/service_checks.json
[9]: https://docs.khulnasoft.com/help/
[10]: https://docs.ray.io/en/latest/ray-observability/user-guides/add-app-metrics.html
[11]: https://github.com/KhulnaSoft/integrations-core/blob/master/ray/khulnasoft_checks/ray/data/conf.yaml.example#L59-L105 
