...
from khulnasoft_checks.base import AgentCheck, ConfigurationError, ensure_unicode, is_affirmative
from khulnasoft_checks.base.utils.common import round_value
...
class Redis(AgentCheck):
    ...
    def _check_slowlog(self):
        ...
        try:
            ...
            self.log.error(
                ...
                'https://docs.khulnasoft.com/agent/versions/upgrade_to_agent_v7/?tab=linux'
            )
            slowlogs = []
    ...
    def _check_command_stats(self, conn, tags):
        ...
        for key, stats in iteritems(command_stats):
            ...
            # see https://github.com/KhulnaSoft/integrations-core/issues/839
