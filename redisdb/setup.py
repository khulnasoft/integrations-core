...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "redisdb", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-redisdb',
    version=ABOUT["__version__"],
    description='The Redis Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent Redis check',
    ...
    packages=['khulnasoft_checks.redisdb'],
