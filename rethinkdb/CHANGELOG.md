...
* Add `pyproject.toml` file ([#11425](https://github.com/KhulnaSoft/integrations-core/pull/11425))
...
* Add runtime configuration validation ([#8978](https://github.com/KhulnaSoft/integrations-core/pull/8978))
...
* Use agent 8 signature ([#9649](https://github.com/KhulnaSoft/integrations-core/pull/9649))
...
* Refactor to use QueryManager ([#8143](https://github.com/KhulnaSoft/integrations-core/pull/8143))
...
* Add an out-of-the-box dashboard for RethinkDB ([#6837](https://github.com/KhulnaSoft/integrations-core/pull/6837)) Thanks [ptgott](https://github.com/ptgott).
...
* Submit server tags with a namespace ([#6295](https://github.com/KhulnaSoft/integrations-core/pull/6295))
