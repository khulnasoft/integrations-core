...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'rethinkdb', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-rethinkdb',
    version=ABOUT['__version__'],
    description='The RethinkDB check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent rethinkdb check',
    ...
    packages=['khulnasoft_checks.rethinkdb'],
