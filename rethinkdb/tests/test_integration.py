...
class TestCheck:
    METRICS_COLLECTION_MOCK_TARGET = 'khulnasoft_checks.rethinkdb.check.RethinkDBCheck.collect_metrics'
...
class TestVersionMetadata:
    VERSION_MOCK_TARGET = 'khulnasoft_checks.rethinkdb.queries_impl.get_version_metadata'
    ...
    def test_default(self, instance, dd_run_check, khulnasoft_agent):
        ...
        dd_run_check(check)
        khulnasoft_agent.assert_metadata(check_id, metadata)
