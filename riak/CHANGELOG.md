...
* Add `pyproject.toml` file ([#11426](https://github.com/KhulnaSoft/integrations-core/pull/11426))
...
* Add runtime configuration validation ([#8979](https://github.com/KhulnaSoft/integrations-core/pull/8979))
...
* Add config specs ([#7068](https://github.com/KhulnaSoft/integrations-core/pull/7068))
...
* Use Agent 6 signature ([#6448](https://github.com/KhulnaSoft/integrations-core/pull/6448))
...
* Add logs section ([#3995](https://github.com/KhulnaSoft/integrations-core/pull/3995))

## 1.5.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3563](https://github.com/KhulnaSoft/integrations-core/pull/3563))

## 1.4.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2774](https://github.com/KhulnaSoft/integrations-core/pull/2774))
...
* Hardcode the 8098 port in the Autodiscovery template ([#1444](https://github.com/KhulnaSoft/integrations-core/pull/1444) for more information)
