...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "riak", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-riak',
    version=ABOUT["__version__"],
    description='The Riak Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent riak check',
    ...
    packages=['khulnasoft_checks.riak'],
