...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'riakcs', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-riakcs',
    version=ABOUT['__version__'],
    description='The Riak CS check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent riakcs check',
    ...
    packages=['khulnasoft_checks.riakcs'],
