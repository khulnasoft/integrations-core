...
* Change docker image / Do not emit message on OK service check ([#12826](https://github.com/KhulnaSoft/integrations-core/pull/12826))

## 2.2.0 / 2022-08-01 / Agent 7.39.0

***Added***:

* Add retries to test and emit warnings when connections fail ([#12528](https://github.com/KhulnaSoft/integrations-core/pull/12528))
* Add an option to set the tenant databases schema ([#12492](https://github.com/KhulnaSoft/integrations-core/pull/12492))
...
* Add `pyproject.toml` file ([#11428](https://github.com/KhulnaSoft/integrations-core/pull/11428))
...
* Add support for only_custom_queries ([#10695](https://github.com/KhulnaSoft/integrations-core/pull/10695))

## 1.9.0 / 2021-11-13 / Agent 7.33.0

***Added***:

* Support the `hdbcli` client library ([#10595](https://github.com/KhulnaSoft/integrations-core/pull/10595))

***Fixed***:

* Resolve unexpected errors when statuses other than 'running' or 'idle' are received ([#10333](https://github.com/KhulnaSoft/integrations-core/pull/10333))

## 1.8.2 / 2021-10-15 / Agent 7.32.0

***Fixed***:

* Ensure `persist_db_connections` is read from init_config ([#10417](https://github.com/KhulnaSoft/integrations-core/pull/10417))
...
* Add option to disable persistent database connections ([#10023](https://github.com/KhulnaSoft/integrations-core/pull/10023))
...
* Add runtime configuration validation ([#8981](https://github.com/KhulnaSoft/integrations-core/pull/8981))

## 1.4.1 / 2021-03-07 / Agent 7.27.0

***Fixed***:

* Catch exception when closing lost connection ([#8630](https://github.com/KhulnaSoft/integrations-core/pull/8630))
...
* Add SSL support for connection ([#8098](https://github.com/KhulnaSoft/integrations-core/pull/8098))

## 1.3.0 / 2020-10-31 / Agent 7.24.0

***Added***:

* Add config spec ([#7715](https://github.com/KhulnaSoft/integrations-core/pull/7715))
