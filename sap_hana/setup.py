...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'sap_hana', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-sap_hana',
    version=ABOUT['__version__'],
    description='The SAP HANA check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent sap_hana check',
    ...
    packages=['khulnasoft_checks.sap_hana'],
