...
* Add new ScyllaDB metrics ([#15592](https://github.com/KhulnaSoft/integrations-core/pull/15592))
...
* Add `pyproject.toml` file ([#11429](https://github.com/KhulnaSoft/integrations-core/pull/11429))
...
* Add runtime configuration validation ([#8982](https://github.com/KhulnaSoft/integrations-core/pull/8982))
...
* Fix logs section placement in example config ([#8605](https://github.com/KhulnaSoft/integrations-core/pull/8605))
...
* Add config spec ([#7735](https://github.com/KhulnaSoft/integrations-core/pull/7735))
...
* Fix discrepancies in `batchlog_manager`, `execution_stages`, `io_queue` and `query_processor` metric group names ([#5885](https://github.com/KhulnaSoft/integrations-core/pull/5885))

## 1.0.1 / 2020-02-25

***Fixed***:

* Fix typo in explicit send_histograms_buckets option ([#5867](https://github.com/KhulnaSoft/integrations-core/pull/5867))

## 1.0.0 / 2020-02-21

***Added***:

* Scylla new integration ([#5440](https://github.com/KhulnaSoft/integrations-core/pull/5440))
