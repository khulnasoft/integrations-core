...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'sidekiq', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-sidekiq',
    version=ABOUT['__version__'],
    description='The Sidekiq check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent sidekiq check',
    ...
    packages=['khulnasoft_checks.sidekiq'],
