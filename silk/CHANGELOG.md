...
* Improve Silk service check tagging ([#13816](https://github.com/KhulnaSoft/integrations-core/pull/13816))
...
* Add debug logging for unknown server statuses ([#11587](https://github.com/KhulnaSoft/integrations-core/pull/11587))
...
* Update system state log line wording  ([#11577](https://github.com/KhulnaSoft/integrations-core/pull/11577))
* Update example port ([#11578](https://github.com/KhulnaSoft/integrations-core/pull/11578))

## 1.0.1 / 2022-02-23

***Fixed***:

* Bump base package dependency ([#11549](https://github.com/KhulnaSoft/integrations-core/pull/11549))

## 1.0.0 / 2022-02-19

***Added***:

* Add Silk integration ([#10783](https://github.com/KhulnaSoft/integrations-core/pull/10783))
