...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'silk', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-silk',
    version=ABOUT['__version__'],
    description='The Silk check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent silk check',
    ...
    packages=['khulnasoft_checks.silk'],
