...
from khulnasoft_checks.dev.fs import read_file
from khulnasoft_checks.silk import SilkCheck
from khulnasoft_checks.silk.events import SilkEvent
...
def test_event_payload():
    ...
    actual_payload = normalized_event.get_khulnasoft_payload()
