...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'singlestore', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-singlestore',
    version=ABOUT['__version__'],
    description='The SingleStore check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent singlestore check',
    ...
    packages=['khulnasoft_checks.singlestore'],
