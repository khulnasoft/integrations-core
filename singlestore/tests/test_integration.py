...
from khulnasoft_checks.singlestore.check import SinglestoreCheck

from .common import EXPECTED_INTEGRATION_METRICS


def test_integration(dd_environment, dd_run_check, khulnasoft_agent, aggregator):
    ...
    khulnasoft_agent.assert_metadata('', version_metadata)
