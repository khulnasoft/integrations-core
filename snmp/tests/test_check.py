...
from khulnasoft_checks.base import ConfigurationError, to_native_string
...
def test_transient_error(aggregator):
    ...
    with mock.patch('khulnasoft_checks.snmp.commands._handle_error', side_effect=RuntimeError):
        check.check(instance)
...
def test_oids_cache_command_calls(refresh_interval, getnext_call_counts, getnext_call_count_after_reset):
    ...
    with mock.patch('khulnasoft_checks.snmp.snmp.snmp_getnext') as snmp_getnext:
