...
from khulnasoft_checks.snmp import SnmpCheck
from khulnasoft_checks.snmp.config import InstanceConfig
from khulnasoft_checks.snmp.discovery import discover_instances
from khulnasoft_checks.snmp.parsing import ParsedSymbolMetric, ParsedTableMetric
from khulnasoft_checks.snmp.resolver import OIDTrie
from khulnasoft_checks.snmp.utils import (
...
@mock.patch("khulnasoft_checks.snmp.pysnmp_types.lcd")
...
@mock.patch("khulnasoft_checks.snmp.snmp.read_persistent_cache")
...
@mock.patch("khulnasoft_checks.snmp.snmp.read_persistent_cache")
@mock.patch("khulnasoft_checks.snmp.snmp.write_persistent_cache")
...
@mock.patch("khulnasoft_checks.snmp.snmp.read_persistent_cache")
@mock.patch("khulnasoft_checks.snmp.discovery.write_persistent_cache")
