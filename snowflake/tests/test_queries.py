...
from khulnasoft_checks.base.utils.db import Query
from khulnasoft_checks.dev.utils import get_metadata_metrics
from khulnasoft_checks.snowflake import SnowflakeCheck, queries
...
def test_storage_metrics(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_storage):
...
def test_db_storage_metrics(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_db_storage_usage
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_credit_usage_metrics(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_credit_usage):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_warehouse_usage_metrics(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_wh_usage):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_login_metrics(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_login_metrics):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_warehouse_load(dd_run_check, aggregator, instance):
    ...
    expected_tags = EXPECTED_TAGS + ['warehouse:COMPUTE_WH']
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_wl_metrics):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_currency_usage(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_currency_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_credit_usage(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_org_credit_usage_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_contract_items(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_org_contract_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_warehouse_credit_usage(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_credit_usage_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_storage_daily(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_storage_daily_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_balance(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_balance_metrics):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_data_transfer(dd_run_check, aggregator, instance):
    ...
    with mock.patch(
        'khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_data_transfer_metrics
    ):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
...
def test_org_rate_sheet(dd_run_check, aggregator, instance):
    ...
    with mock.patch('khulnasoft_checks.snowflake.SnowflakeCheck.execute_query_raw', return_value=expected_rate_metrics):
        check = SnowflakeCheck(CHECK_NAME, {}, [instance])
        check._conn = mock.MagicMock()
