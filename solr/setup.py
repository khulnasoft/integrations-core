...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'solr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-solr',
    version=ABOUT['__version__'],
    description='The Solr check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent solr check',
    ...
    packages=['khulnasoft_checks.solr'],
