...
* Switch a log from `warn` to `debug` ([#14428](https://github.com/KhulnaSoft/integrations-core/pull/14428))

## 2.2.3 / 2023-01-16 / Agent 7.43.0

***Fixed***:

* Support components from paginated endpoint ([#13699](https://github.com/KhulnaSoft/integrations-core/pull/13699))

## 2.2.2 / 2022-12-23 / Agent 7.42.0

***Fixed***:

* Fix config spec to allow additionalProperties ([#13512](https://github.com/KhulnaSoft/integrations-core/pull/13512))

## 2.2.1 / 2022-12-16

***Fixed***:

* Projects processed in `components` excluded from `components_discovery` ([#13531](https://github.com/KhulnaSoft/integrations-core/pull/13531))
* Fix configuration spec ([#13504](https://github.com/KhulnaSoft/integrations-core/pull/13504))

## 2.2.0 / 2022-12-09

***Added***:

* Add autodiscovery feature for components ([#13450](https://github.com/KhulnaSoft/integrations-core/pull/13450))
...
* Add `pyproject.toml` file ([#11435](https://github.com/KhulnaSoft/integrations-core/pull/11435))
...
* Add runtime configuration validation ([#8985](https://github.com/KhulnaSoft/integrations-core/pull/8985))
...
* Fix collection of PendingTime ([#8817](https://github.com/KhulnaSoft/integrations-core/pull/8817))

## 1.1.1 / 2021-02-16

***Fixed***:

* Fix automatic discovery of metrics from web API and improve example config documentation ([#8552](https://github.com/KhulnaSoft/integrations-core/pull/8552))
...
* Add SonarQube integration ([#7807](https://github.com/KhulnaSoft/integrations-core/pull/7807))
