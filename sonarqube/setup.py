...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'sonarqube', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-sonarqube',
    version=ABOUT['__version__'],
    description='The SonarQube check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent sonarqube check',
    ...
    packages=['khulnasoft_checks.sonarqube'],
