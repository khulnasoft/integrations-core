...
* Allow punctuation marks in query name when publishing spark structured streaming metrics ([#13246](https://github.com/KhulnaSoft/integrations-core/pull/13246)) Thanks [cpolito88](https://github.com/cpolito88).

## 3.1.2 / 2022-10-28 / Agent 7.41.0

***Fixed***:

* Add a log line when no running apps are found ([#13067](https://github.com/KhulnaSoft/integrations-core/pull/13067))
...
* Add `pyproject.toml` file ([#11436](https://github.com/KhulnaSoft/integrations-core/pull/11436))
...
* Add `query_name` as tag for Spark Structured Streaming metrics ([#10689](https://github.com/KhulnaSoft/integrations-core/pull/10689)) Thanks [otosky](https://github.com/otosky).

***Fixed***:

* Don't submit query name tag if query is a uuid ([#11015](https://github.com/KhulnaSoft/integrations-core/pull/11015))
...
* Add runtime configuration validation ([#8986](https://github.com/KhulnaSoft/integrations-core/pull/8986))

## 1.20.0 / 2021-03-07 / Agent 7.27.0

***Added***:

* Rename cluster_name tag to spark_cluster ([#8592](https://github.com/KhulnaSoft/integrations-core/pull/8592))

***Fixed***:

* Skip apps which have the UI disabled ([#8558](https://github.com/KhulnaSoft/integrations-core/pull/8558))
...
* Update check signature ([#8259](https://github.com/KhulnaSoft/integrations-core/pull/8259))

## 1.19.0 / 2020-12-29

***Added***:

* Add metrics for structured streams ([#8078](https://github.com/KhulnaSoft/integrations-core/pull/8078))

## 1.18.0 / 2020-11-23 / Agent 7.25.0

***Added***:

* Add more granular executor metrics ([#8028](https://github.com/KhulnaSoft/integrations-core/pull/8028))
...
* Add Stage and Job ID tags ([#7459](https://github.com/KhulnaSoft/integrations-core/pull/7459))
...
* Add documentation for spark logs ([#7109](https://github.com/KhulnaSoft/integrations-core/pull/7109))
...
* Add config specs ([#6921](https://github.com/KhulnaSoft/integrations-core/pull/6921))
...
* Update documentation in example config ([#5508](https://github.com/KhulnaSoft/integrations-core/pull/5508))

## 1.11.3 / 2020-01-30

***Fixed***:

* Handle warning message from proxy ([#5525](https://github.com/KhulnaSoft/integrations-core/pull/5525))

## 1.11.2 / 2020-01-29

***Fixed***:

* Prevent crash when a single app fails ([#5552](https://github.com/KhulnaSoft/integrations-core/pull/5552))

## 1.11.1 / 2020-01-15 / Agent 7.17.0

***Fixed***:

* Make sure version collection fails gracefully ([#5465](https://github.com/KhulnaSoft/integrations-core/pull/5465))
...
* Collect version metadata ([#5032](https://github.com/KhulnaSoft/integrations-core/pull/5032))

## 1.10.1 / 2019-12-06 / Agent 7.16.0

***Fixed***:

* Remove reference to Kubernetes in the service check message for `spark_driver_mode` ([#5159](https://github.com/KhulnaSoft/integrations-core/pull/5159))

## 1.10.0 / 2019-12-02

***Added***:

* Add Spark driver support ([#4631](https://github.com/KhulnaSoft/integrations-core/pull/4631)) Thanks [mrmuggymuggy](https://github.com/mrmuggymuggy).
...
* Remove unused configs and code for spark check ([#4133](https://github.com/KhulnaSoft/integrations-core/pull/4133))

## 1.8.0 / 2019-07-09

***Added***:

* Use the new RequestsWrapper for connecting to services ([#4058](https://github.com/KhulnaSoft/integrations-core/pull/4058))

## 1.7.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3566](https://github.com/KhulnaSoft/integrations-core/pull/3566))

## 1.6.0 / 2019-01-08 / Agent 6.10.0

***Added***:

* Allow disabling of streaming metrics ([#2889](https://github.com/KhulnaSoft/integrations-core/pull/2889))
* Support Kerberos auth ([#2825](https://github.com/KhulnaSoft/integrations-core/pull/2825))

## 1.5.0 / 2018-12-20 / Agent 6.9.0

***Added***:

* Add streaming statistics metrics to the spark integration ([#2437](https://github.com/KhulnaSoft/integrations-core/pull/2437))
...
* Add support for HTTP authentication ([#1680](https://github.com/KhulnaSoft/integrations-core/pull/1680))
...
* Add configuration options `ssl_verify`, `ssl_cert` and `ssl_key` to allow SSL configuration ([#1064](https://github.com/KhulnaSoft/integrations-core/pull/1064))

## 1.1.0 / 2018-01-10

***Added***:

* Filter Spark frameworks by port ([#459](https://github.com/KhulnaSoft/integrations-core/pull/459))  (Thanks [@johnjeffers](https://github.com/johnjeffers))

## 1.0.1 / 2017-07-18

***Fixed***:

* Build proxy-compatible URL  ([#437](https://github.com/KhulnaSoft/integrations-core/issues/437)
