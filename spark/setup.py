...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'spark', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-spark',
    version=ABOUT["__version__"],
    description='The Spark check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent spark check',
    ...
    packages=['khulnasoft_checks.spark'],
