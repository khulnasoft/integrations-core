...
**Note**: To install Database Monitoring for SQL Server, select your hosting solution on the [documentation site](https://docs.khulnasoft.com/database_monitoring/#sqlserver) for instructions.

Supported versions of SQL Server for the SQL Server check are the same as for Database Monitoring. Visit the [Setting up SQL Server page](https://docs.khulnasoft.com/database_monitoring/setup_sql_server/) to see the currently supported versions under the **Self-hosted** heading.
...
[6]: https://github.com/KhulnaSoft/integrations-core/blob/master/sqlserver/khulnasoft_checks/sqlserver/data/conf.yaml.example
...
[13]: https://docs.khulnasoft.com/agent/faq/template_variables/
