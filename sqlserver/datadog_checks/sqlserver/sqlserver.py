...
from khulnasoft_checks.base.config import is_affirmative
from khulnasoft_checks.base.utils.db import QueryExecutor, QueryManager
from khulnasoft_checks.base.utils.db.utils import default_json_event_encoding, resolve_db_host, tracked_query
from khulnasoft_checks.base.utils.serialization import json
from khulnasoft_checks.sqlserver.activity import SqlserverActivity
from khulnasoft_checks.sqlserver.config import SQLServerConfig
from khulnasoft_checks.sqlserver.metadata import SqlserverMetadata
from khulnasoft_checks.sqlserver.statements import SqlserverStatementMetrics
from khulnasoft_checks.sqlserver.stored_procedures import SqlserverProcedureMetrics
from khulnasoft_checks.sqlserver.utils import Database, construct_use_statement, parse_sqlserver_major_version

try:
    import khulnasoft_agent
except ImportError:
    from ..stubs import khulnasoft_agent

from khulnasoft_checks.sqlserver import metrics
from khulnasoft_checks.sqlserver.__about__ import __version__
from khulnasoft_checks.sqlserver.connection import Connection, SQLConnectionError, split_sqlserver_host_port
from khulnasoft_checks.sqlserver.const import (
    AO_METRICS,
    AO_METRICS_PRIMARY,
...
from khulnasoft_checks.sqlserver.metrics import DEFAULT_PERFORMANCE_TABLE, VALID_TABLES
from khulnasoft_checks.sqlserver.queries import (
...
from khulnasoft_checks.sqlserver.utils import is_azure_database, set_default_driver_conf
...
class SQLServer(AgentCheck):
    ...
    def agent_hostname(self):
        ...
        if self._agent_hostname is None:
            self._agent_hostname = khulnasoft_agent.get_hostname()
    ...
    def _send_database_instance_metadata(self):
        if self.resolved_hostname not in self._database_instance_emitted:
            event = {
                ...
                "agent_version": khulnasoft_agent.get_version(),
                "dbms": "sqlserver",
