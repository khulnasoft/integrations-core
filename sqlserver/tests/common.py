...
from khulnasoft_checks.dev.utils import ON_MACOS, ON_WINDOWS
...
from khulnasoft_checks.sqlserver.queries import get_query_file_stats
...
# As documented here: https://docs.khulnasoft.com/integrations/guide/collect-sql-server-custom-metrics/
