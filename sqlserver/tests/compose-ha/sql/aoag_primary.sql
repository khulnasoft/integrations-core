...
USE khulnasoft_test;
CREATE TABLE khulnasoft_test.dbo.ϑings (id int, name varchar(255));
INSERT INTO khulnasoft_test.dbo.ϑings VALUES (1, 'foo'), (2, 'bar');
...
ALTER DATABASE khulnasoft_test SET RECOVERY FULL ;
GO

BACKUP DATABASE khulnasoft_test TO  DISK = N'/var/opt/mssql/backup/khulnasoft_test.bak' WITH NOFORMAT, NOINIT,  NAME = N'khulnasoft_test-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
GO
...
ALTER AVAILABILITY GROUP [AG1] ADD DATABASE [khulnasoft_test]
GO
