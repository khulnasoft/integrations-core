...
from khulnasoft_checks.dev import EnvVars
from khulnasoft_checks.sqlserver import SQLServer
from khulnasoft_checks.sqlserver.connection import split_sqlserver_host_port
from khulnasoft_checks.sqlserver.metrics import SqlFractionMetric, SqlMasterDatabaseFileStats
from khulnasoft_checks.sqlserver.sqlserver import SQLConnectionError
from khulnasoft_checks.sqlserver.utils import (
    Database,
...
def test_missing_db(instance_docker, dd_run_check):
    ...
    with mock.patch('khulnasoft_checks.sqlserver.connection.Connection.check_database', return_value=(False, 'db')):
...
@mock.patch('khulnasoft_checks.sqlserver.connection.Connection.open_managed_default_database')
@mock.patch('khulnasoft_checks.sqlserver.connection.Connection.get_cursor')
