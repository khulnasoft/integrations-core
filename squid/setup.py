...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "squid", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-squid',
    version=ABOUT["__version__"],
    description='The Squid Check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent squid check',
    ...
    packages=['khulnasoft_checks.squid'],
