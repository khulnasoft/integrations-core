...
* Add `pyproject.toml` file ([#11439](https://github.com/KhulnaSoft/integrations-core/pull/11439))
...
* Add runtime configuration validation ([#8989](https://github.com/KhulnaSoft/integrations-core/pull/8989))
...
* Add integration test for ssh keypair and make code more accurate ([#7655](https://github.com/KhulnaSoft/integrations-core/pull/7655))

## 1.11.2 / 2020-09-21

***Fixed***:

* pass the password to be used for pkey decryption ([#6862](https://github.com/KhulnaSoft/integrations-core/pull/6862))

## 1.11.1 / 2020-06-29 / Agent 7.21.0

***Fixed***:

* Add config specs ([#6923](https://github.com/KhulnaSoft/integrations-core/pull/6923))
* Agent6 style init ([#6924](https://github.com/KhulnaSoft/integrations-core/pull/6924))
...
* Add version metadata ([#5016](https://github.com/KhulnaSoft/integrations-core/pull/5016))
...
* Adhere to code style ([#3569](https://github.com/KhulnaSoft/integrations-core/pull/3569))

## 1.5.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Support Python 3 ([#2836](https://github.com/KhulnaSoft/integrations-core/pull/2836))
...
* Check that the private_key_file exists in the yaml configuration before attempting to access it ([#988](https://github.com/KhulnaSoft/integrations-core/issues/988)

## 1.1.2 / 2017-11-21

***Fixed***:

* If `ssh_check` passes and uses `None` as `exception_message`, downstream aggregator rejects it with a type error. Instead, specify a default message ([#852](https://github.com/KhulnaSoft/integrations-core/issues/852)
...
* Drop dependency on pycrypto ([#426](https://github.com/KhulnaSoft/integrations-core/issues/426) and [#454](https://github.com/KhulnaSoft/integrations-core/issues/454)

***Fixed***:

* Fix misplaced parentheses in config validation ([#416](https://github.com/KhulnaSoft/integrations-core/issues/416), thanks [@ilkka](https://github)com/ilkka)
