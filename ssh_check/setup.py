...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "ssh_check", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-ssh_check',
    version=ABOUT["__version__"],
    description='The SSH check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent ssh_check check',
    ...
    packages=['khulnasoft_checks.ssh_check'],
