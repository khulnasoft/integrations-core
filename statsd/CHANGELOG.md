...
* Add `pyproject.toml` file ([#11440](https://github.com/KhulnaSoft/integrations-core/pull/11440))
...
* Allow float value for timeout ([#9711](https://github.com/KhulnaSoft/integrations-core/pull/9711))

## 1.7.0 / 2021-07-12

***Added***:

* Add runtime configuration validation ([#8990](https://github.com/KhulnaSoft/integrations-core/pull/8990))
...
* Add statsd logs ([#7773](https://github.com/KhulnaSoft/integrations-core/pull/7773))

## 1.5.0 / 2020-09-21 / Agent 7.23.0

***Added***:

* Add config specs ([#7481](https://github.com/KhulnaSoft/integrations-core/pull/7481))
...
* Adhere to code style ([#3570](https://github.com/KhulnaSoft/integrations-core/pull/3570))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2831
