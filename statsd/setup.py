...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'statsd', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-statsd',
    version=ABOUT['__version__'],
    description='The StatsD check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent statsd check',
    ...
    packages=['khulnasoft_checks.statsd'],
