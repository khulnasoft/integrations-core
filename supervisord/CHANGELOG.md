...
* Stop raising `TypeError`s when `status_mapping_override` contains unknown Khulnasoft statuses ([#15632](https://github.com/KhulnaSoft/integrations-core/pull/15632))
