...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'supervisord', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-supervisord',
    version=ABOUT['__version__'],
    description='The Supervisord check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent supervisord check',
    ...
    packages=['khulnasoft_checks.supervisord'],
