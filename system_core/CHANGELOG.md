...
* Collect the number of cpu cores using `psutil.cpu_count()` ([#13483](https://github.com/KhulnaSoft/integrations-core/pull/13483))

***Added***:

* Adds `system.core.frequency` metric ([#13349](https://github.com/KhulnaSoft/integrations-core/pull/13349))

## 1.14.0 / 2022-08-05 / Agent 7.39.0

***Added***:

* Add total cpu percentages as a metric ([#12525](https://github.com/KhulnaSoft/integrations-core/pull/12525))
...
* Add `pyproject.toml` file ([#11442](https://github.com/KhulnaSoft/integrations-core/pull/11442))
...
* Add runtime configuration validation ([#8992](https://github.com/KhulnaSoft/integrations-core/pull/8992))
...
* Add config specs ([#7977](https://github.com/KhulnaSoft/integrations-core/pull/7977))
...
* Adhere to code style ([#3572](https://github.com/KhulnaSoft/integrations-core/pull/3572))
...
* adds system_core integration.
 ...
 [1]: https://github.com/KhulnaSoft/integrations-core/pull/2805
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2576
[3]: https://github.com/KhulnaSoft/integrations-core/pull/2190
[4]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[5]: https://github.com/KhulnaSoft/integrations-core/pull/411
