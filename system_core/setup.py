...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "system_core", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-system_core',
    version=ABOUT["__version__"],
    description='The System Core check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent system_core check',
    ...
    packages=['khulnasoft_checks.system_core'],
