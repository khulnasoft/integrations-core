...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'system_swap', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-system_swap',
    version=ABOUT['__version__'],
    description='The System Swap check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent system_swap check',
    ...
    packages=['khulnasoft_checks.system_swap'],
