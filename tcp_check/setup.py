...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'tcp_check', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-tcp_check',
    version=ABOUT['__version__'],
    description='The TCP check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent tcp_check check',
    ...
    packages=['khulnasoft_checks.tcp_check'],
