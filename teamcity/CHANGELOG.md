...
* Allow all projects to be collected in REST implementation ([#14433](https://github.com/KhulnaSoft/integrations-core/pull/14433)) Thanks [njrs92](https://github.com/njrs92).
...
* Fix event tagging ([#13537](https://github.com/KhulnaSoft/integrations-core/pull/13537))

## 3.0.0 / 2022-12-06

***Changed***:

* Support TeamCity metrics and service checks ([#12852](https://github.com/KhulnaSoft/integrations-core/pull/12852))
...
* Add `pyproject.toml` file ([#11445](https://github.com/KhulnaSoft/integrations-core/pull/11445))
...
* Add runtime configuration validation ([#8995](https://github.com/KhulnaSoft/integrations-core/pull/8995))
...
* Document logs support ([#7702](https://github.com/KhulnaSoft/integrations-core/pull/7702))
...
* Add config spec ([#7530](https://github.com/KhulnaSoft/integrations-core/pull/7530))
...
* Fix RequestsWrapper usage ([#4486](https://github.com/KhulnaSoft/integrations-core/pull/4486))

## 1.5.0 / 2019-08-24

***Added***:

* Add requests wrapper to teamcity ([#4209](https://github.com/KhulnaSoft/integrations-core/pull/4209))

***Fixed***:

* Update __init__ method params ([#4243](https://github.com/KhulnaSoft/integrations-core/pull/4243))
* Fix wording for config option description ([#4217](https://github.com/KhulnaSoft/integrations-core/pull/4217))

## 1.4.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3575](https://github.com/KhulnaSoft/integrations-core/pull/3575))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2829
[2]: https://github.com/KhulnaSoft/integrations-core/pull/1945
[3]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[4]: https://github.com/KhulnaSoft/integrations-core/pull/1649
