...
class Projects(BaseModel):
    ...
    exclude: Optional[tuple[str, ...]] = None
    include: Optional[tuple[IncludeItem, ...]] = None
...
class InstanceConfig(BaseModel):
    ...
    build_config_metrics: Optional[bool] = None
    build_configuration: Optional[str] = None
    build_problem_health_check: Optional[bool] = None
    ...
    global_build_configs_exclude: Optional[tuple[str, ...]] = None
    global_build_configs_include: Optional[tuple[str, ...]] = None
    ...
    projects_refresh_interval: Optional[int] = None
    ...
    tests_health_check: Optional[bool] = None
