...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "teamcity", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-teamcity',
    version=ABOUT["__version__"],
    description='The Teamcity check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent teamcity check',
    ...
    packages=['khulnasoft_checks.teamcity'],
