...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'tenable', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-tenable',
    version=ABOUT['__version__'],
    description='The Tenable check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent tenable check',
    ...
    packages=['khulnasoft_checks.tenable'],
