...
from khulnasoft_checks.teradata.check import TeradataCheck
...
def test_connect(test_instance, dd_run_check, aggregator, expected_tags, conn_params):
    ...
    mocks = [
        ('khulnasoft_checks.teradata.check.teradatasql', teradatasql),
        ('khulnasoft_checks.teradata.check.TERADATASQL_IMPORT_ERROR', None),
    ]
