...
from khulnasoft_checks.tokumx.vendor.bson.py3compat import b, StringIO
...
try:
    ...
    _use_c = False
from khulnasoft_checks.tokumx.vendor.pymongo.errors import DocumentTooLarge, InvalidOperation, OperationFailure
