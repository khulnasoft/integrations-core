...
from khulnasoft_checks.tokumx.vendor.pymongo.collection import ReturnDocument
from khulnasoft_checks.tokumx.vendor.pymongo.common import (MIN_SUPPORTED_WIRE_VERSION,
                            MAX_SUPPORTED_WIRE_VERSION)
from khulnasoft_checks.tokumx.vendor.pymongo.cursor import CursorType
from khulnasoft_checks.tokumx.vendor.pymongo.mongo_client import MongoClient
from khulnasoft_checks.tokumx.vendor.pymongo.mongo_replica_set_client import MongoReplicaSetClient
...
def has_c():
    ...
    try:
        from khulnasoft_checks.tokumx.vendor.pymongo import _cmessage
        return True
    except ImportError:
        return False
