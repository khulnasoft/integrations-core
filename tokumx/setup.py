...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'tokumx', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-tokumx',
    version=ABOUT['__version__'],
    description='The TokuMX check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent tokumx check',
    ...
    packages=['khulnasoft_checks.tokumx'],
