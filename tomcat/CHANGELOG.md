...
* Make JMX metrics available on both standalone and embedded Tomcat versions ([#15761](https://github.com/KhulnaSoft/integrations-core/pull/15761))
...
* Add `pyproject.toml` file ([#11449](https://github.com/KhulnaSoft/integrations-core/pull/11449))
...
* Add runtime configuration validation ([#8998](https://github.com/KhulnaSoft/integrations-core/pull/8998))
...
* add Catalina domain specification to tomcat bean includes ([#7054](https://github.com/KhulnaSoft/integrations-core/pull/7054)) Thanks [binaryphile](https://github.com/binaryphile).
...
* Add string cache and web cache metrics ([#6404](https://github.com/KhulnaSoft/integrations-core/pull/6404))
* Use config spec ([#6301](https://github.com/KhulnaSoft/integrations-core/pull/6301))
...
* [Update] Update auto_conf.yaml template ([#1523](https://github.com/KhulnaSoft/integrations-core/pull/1523))
