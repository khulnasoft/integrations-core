...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'tomcat', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-tomcat',
    version=ABOUT['__version__'],
    description='The Tomcat check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent tomcat check',
    ...
    packages=['khulnasoft_checks.tomcat'],
