...
* Add `traffic_server_url` tag ([#11862](https://github.com/KhulnaSoft/integrations-core/pull/11862))
* Add more default metrics ([#11858](https://github.com/KhulnaSoft/integrations-core/pull/11858))

## 1.0.0 / 2022-04-05

***Added***:

* Add Traffic Server integration ([#11471](https://github.com/KhulnaSoft/integrations-core/pull/11471))
