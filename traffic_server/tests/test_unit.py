...
from khulnasoft_checks.traffic_server import TrafficServerCheck, metrics
...
def test_collect_version(caplog, khulnasoft_agent, instance, mock_response_data, expected_version):
    check = TrafficServerCheck('traffic_server', {}, [instance])
    check.check_id = 'test:123'

    check.collect_version(mock_response_data)
    khulnasoft_agent.assert_metadata("test:123", expected_version)
