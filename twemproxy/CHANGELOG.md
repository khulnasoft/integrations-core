...
* Add `pyproject.toml` file ([#11450](https://github.com/KhulnaSoft/integrations-core/pull/11450))
...
* Add log support for Twemproxy ([#9066](https://github.com/KhulnaSoft/integrations-core/pull/9066))

***Fixed***:

* Reflect default port in config ([#9217](https://github.com/KhulnaSoft/integrations-core/pull/9217))

## 1.9.0 / 2021-04-19 / Agent 7.28.0

***Added***:

* Add runtime configuration validation ([#8999](https://github.com/KhulnaSoft/integrations-core/pull/8999))
...
* Add config spec ([#7709](https://github.com/KhulnaSoft/integrations-core/pull/7709))

## 1.7.1 / 2020-07-03 / Agent 7.21.0

***Fixed***:

* Don't collect version if metadata is not enabled ([#7010](https://github.com/KhulnaSoft/integrations-core/pull/7010))

## 1.7.0 / 2020-06-29

***Added***:

* Collect version metadata ([#6899](https://github.com/KhulnaSoft/integrations-core/pull/6899))
...
* Adhere to code style ([#3577](https://github.com/KhulnaSoft/integrations-core/pull/3577))

## 1.3.0 / 2019-01-04 / Agent 6.9.0

***Added***:

* Refactor Twemproxy tests and add E2E ([#2820](https://github.com/KhulnaSoft/integrations-core/pull/2820))
* Support Python 3 ([#2817](https://github.com/KhulnaSoft/integrations-core/pull/2817))
...
* Add `can_connect` service check ([#420](https://github.com/KhulnaSoft/integrations-core/issues/420)
