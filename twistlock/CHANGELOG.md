...
* Skip over "/image" endpoint instances with no images ([#16680](https://github.com/KhulnaSoft/integrations-core/pull/16680))
...
* Add `pyproject.toml` file ([#11451](https://github.com/KhulnaSoft/integrations-core/pull/11451))
...
* Add runtime configuration validation ([#9000](https://github.com/KhulnaSoft/integrations-core/pull/9000))
...
* Add config specs ([#6795](https://github.com/KhulnaSoft/integrations-core/pull/6795))
...
* Add Prisma Cloud compatibility ([#5360](https://github.com/KhulnaSoft/integrations-core/pull/5360))
...
* Fix possible TypeError due to NoneType in parser.isoparse ([#5265](https://github.com/KhulnaSoft/integrations-core/pull/5265))
* Fix possible KeyError in _report_compliance_information ([#5248](https://github.com/KhulnaSoft/integrations-core/pull/5248))

## 1.4.0 / 2019-11-06 / Agent 7.16.0

***Added***:

* Allow passing a "project" query parameter ([#4667](https://github.com/KhulnaSoft/integrations-core/pull/4667))
...
* Fix date format matching ([#4304](https://github.com/KhulnaSoft/integrations-core/pull/4304))

## 1.2.0 / 2019-08-02

***Added***:

* Add RequestsWrapper to twistlock ([#4122](https://github.com/KhulnaSoft/integrations-core/pull/4122))
...
* Adhere to code style ([#3578](https://github.com/KhulnaSoft/integrations-core/pull/3578))

## 1.0.0 / 2019-03-29 / Agent 6.11.0

***Added***:

* Adds Twistlock Integration ([#3074](https://github.com/KhulnaSoft/integrations-core/pull/3074))
