...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'twistlock', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-twistlock',
    version=ABOUT['__version__'],
    description='The Twistlock check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent twistlock check',
    ...
    packages=['khulnasoft_checks.twistlock'],
