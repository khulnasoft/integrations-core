...
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "varnish", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-varnish',
    version=ABOUT["__version__"],
    description='The Varnish check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent varnish check',
    ...
    packages=['khulnasoft_checks.varnish'],
