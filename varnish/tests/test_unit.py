...
from khulnasoft_checks.varnish import Varnish
...
@mock.patch('khulnasoft_checks.varnish.varnish.geteuid')
@mock.patch('khulnasoft_checks.varnish.varnish.Varnish._get_version_info')
@mock.patch('khulnasoft_checks.varnish.varnish.get_subprocess_output', side_effect=mocks.backend_manual_unhealthy_mock)
...
def test_command_line_healthy(
    ...
    with mock.patch('khulnasoft_checks.varnish.varnish.get_subprocess_output', side_effect=output_mock) as mock_subprocess:
        check.check(instance)
        args, _ = mock_subprocess.call_args
        assert args[0] == expected_cmd
    aggregator.assert_service_check(
