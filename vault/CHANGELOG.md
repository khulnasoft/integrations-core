...
* Add metrics for PKI tidy operations ([#14327](https://github.com/KhulnaSoft/integrations-core/pull/14327))
...
* Ensure X-Vault-Request header is set to `true` on all requests ([#13006](https://github.com/KhulnaSoft/integrations-core/pull/13006))

## 3.3.2 / 2022-09-16 / Agent 7.40.0

***Fixed***:

* Do not use the `client_token` if `no_token` is true with the openmetrics v1 implementation ([#12776](https://github.com/KhulnaSoft/integrations-core/pull/12776))
* Use the `client_token` option with the openmetrics v2 implementation ([#12764](https://github.com/KhulnaSoft/integrations-core/pull/12764))

## 3.3.1 / 2022-08-05 / Agent 7.39.0

***Fixed***:

* Properly read `collect_secondary_dr` and improve code readability ([#12435](https://github.com/KhulnaSoft/integrations-core/pull/12435))

## 3.3.0 / 2022-06-01 / Agent 7.38.0

***Added***:

* Add config option to collect from secondary replication mode ([#12099](https://github.com/KhulnaSoft/integrations-core/pull/12099))

***Fixed***:

* Ensure vault_wal_gc_total is collected as gauge ([#12036](https://github.com/KhulnaSoft/integrations-core/pull/12036))
...
* Add `vault.replication.wal.gc.*` metrics ([#11984](https://github.com/KhulnaSoft/integrations-core/pull/11984))

***Fixed***:

* Fix metric naming ([#11847](https://github.com/KhulnaSoft/integrations-core/pull/11847))
...
* Add OpenMetrics V2 service check to Vault ([#11558](https://github.com/KhulnaSoft/integrations-core/pull/11558))
...
* Add `pyproject.toml` file ([#11453](https://github.com/KhulnaSoft/integrations-core/pull/11453))
* Add support for OpenMetrics v2 ([#11293](https://github.com/KhulnaSoft/integrations-core/pull/11293))
...
* Update vault metrics ([#9953](https://github.com/KhulnaSoft/integrations-core/pull/9953))
...
* Add new vault metrics ([#9728](https://github.com/KhulnaSoft/integrations-core/pull/9728))
* Add Vault route metrics to be fetched from the Prometheus endpoint ([#9612](https://github.com/KhulnaSoft/integrations-core/pull/9612)) Thanks [mdgreenfield](https://github.com/mdgreenfield).
* Add newer Hashicorp Vault metrics ([#9641](https://github.com/KhulnaSoft/integrations-core/pull/9641)) Thanks [mdgreenfield](https://github.com/mdgreenfield).

## 2.13.0 / 2021-05-28 / Agent 7.29.0

***Added***:

* Add runtime configuration validation ([#9002](https://github.com/KhulnaSoft/integrations-core/pull/9002))

## 2.12.0 / 2021-04-19 / Agent 7.28.0

***Added***:

* Add Additional Vault Route Metrics ([#8761](https://github.com/KhulnaSoft/integrations-core/pull/8761))

***Fixed***:

* Fix refactored imports ([#9136](https://github.com/KhulnaSoft/integrations-core/pull/9136))
* Bump minimum base package ([#9107](https://github.com/KhulnaSoft/integrations-core/pull/9107))

## 2.11.0 / 2021-03-07 / Agent 7.27.0

***Added***:

* Rename cluster_name tag to vault_cluster ([#8577](https://github.com/KhulnaSoft/integrations-core/pull/8577))
...
* Add new Vault 1.5+ metrics ([#8031](https://github.com/KhulnaSoft/integrations-core/pull/8031))

## 2.9.1 / 2020-11-04 / Agent 7.24.0

***Fixed***:

* Fix secondary mode detection logic ([#7926](https://github.com/KhulnaSoft/integrations-core/pull/7926))

## 2.9.0 / 2020-10-21

***Added***:

* Detect replication DR secondary mode and skip Prometheus metric collection ([#7825](https://github.com/KhulnaSoft/integrations-core/pull/7825))
...
* Fix vault raft storage metric name ([#6622](https://github.com/KhulnaSoft/integrations-core/pull/6622)) Thanks [tgermain](https://github.com/tgermain).
...
* Add Raft storage backend metrics ([#6492](https://github.com/KhulnaSoft/integrations-core/pull/6492)) Thanks [fabienrenaud](https://github.com/fabienrenaud).

## 2.3.2 / 2020-05-04 / Agent 7.19.2

***Fixed***:

* Fixed infinite stream of Vault leader detection events ([#6552](https://github.com/KhulnaSoft/integrations-core/pull/6552)) Thanks [fabienrenaud](https://github.com/fabienrenaud).
...
* Fix event submission on leader change ([#6039](https://github.com/KhulnaSoft/integrations-core/pull/6039))
...
* Add missing vault summary metric ([#5670](https://github.com/KhulnaSoft/integrations-core/pull/5670))

## 2.1.2 / 2020-01-24 / Agent 7.17.0

***Fixed***:

* Send summary count metrics as a count ([#5538](https://github.com/KhulnaSoft/integrations-core/pull/5538))
...
* Add support for metric collection without a token ([#5424](https://github.com/KhulnaSoft/integrations-core/pull/5424))
...
* Collect prometheus metrics if a client token is available ([#5177](https://github.com/KhulnaSoft/integrations-core/pull/5177))

## 1.7.1 / 2019-10-21 / Agent 6.15.0

***Fixed***:

* Fix is_leader when vault sealed ([#4838](https://github.com/KhulnaSoft/integrations-core/pull/4838))

## 1.7.0 / 2019-10-18

***Added***:

* Allows certain expected HTTP error status_codes for the `/sys/health` endpoint ([#4745](https://github.com/KhulnaSoft/integrations-core/pull/4745))
...
* Fix crash in HA mode ([#4698](https://github.com/KhulnaSoft/integrations-core/pull/4698))

## 1.5.0 / 2019-08-24 / Agent 6.14.0

***Added***:

* Add requests wrapper to vault ([#4259](https://github.com/KhulnaSoft/integrations-core/pull/4259))

## 1.4.1 / 2019-07-31

***Fixed***:

* Submit critical service check with 500 server errors ([#4242](https://github.com/KhulnaSoft/integrations-core/pull/4242))

## 1.4.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3580](https://github.com/KhulnaSoft/integrations-core/pull/3580))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2793
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2657
[3]: https://github.com/eedwards-sk
[4]: https://github.com/KhulnaSoft/integrations-core/pull/2057
[5]: https://github.com/KhulnaSoft/integrations-core/pull/2009
[6]: https://github.com/KhulnaSoft/integrations-core/pull/1727
[7]: https://github.com/KhulnaSoft/integrations-core/pull/1759
