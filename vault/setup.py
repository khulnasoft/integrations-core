...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'vault', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-vault',
    version=ABOUT['__version__'],
    description='The Vault check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent vault check',
    ...
    packages=['khulnasoft_checks.vault'],
