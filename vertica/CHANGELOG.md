...
* Update dependencies ([#16394](https://github.com/KhulnaSoft/integrations-core/pull/16394)), ([#16502](https://github.com/KhulnaSoft/integrations-core/pull/16502))
...
* Update Vertica dependency to 1.3.5 ([#15922](https://github.com/KhulnaSoft/integrations-core/pull/15922))
...
* Close and recreate a connection instead of using the `reset_connection` method ([#15413](https://github.com/KhulnaSoft/integrations-core/pull/15413))
...
* Use QueryManager to get metrics from queries ([#12542](https://github.com/KhulnaSoft/integrations-core/pull/12542))

## 3.3.2 / 2022-07-19

***Fixed***:

* Support projection storage and storage containers for Vertica 11+ ([#12465](https://github.com/KhulnaSoft/integrations-core/pull/12465))
* Make integration compatible with Vertica 11 ([#12394](https://github.com/KhulnaSoft/integrations-core/pull/12394))
...
* Add `pyproject.toml` file ([#11454](https://github.com/KhulnaSoft/integrations-core/pull/11454))
...
* Fix required values in vertica ([#9479](https://github.com/KhulnaSoft/integrations-core/pull/9479))

## 2.1.0 / 2021-05-28

***Added***:

* Add runtime configuration validation ([#9003](https://github.com/KhulnaSoft/integrations-core/pull/9003))

## 2.0.2 / 2021-04-19 / Agent 7.28.0

***Fixed***:

* Fix logs section in example config file ([#8876](https://github.com/KhulnaSoft/integrations-core/pull/8876))
...
* Update Vertica TLS implementation with in-house TLS library ([#8228](https://github.com/KhulnaSoft/integrations-core/pull/8228))

***Added***:

* Update Vertica to use use_tls config ([#8250](https://github.com/KhulnaSoft/integrations-core/pull/8250))
...
* Add option to limit metric collection ([#7997](https://github.com/KhulnaSoft/integrations-core/pull/7997))
...
* Add config spec for Vertica ([#7513](https://github.com/KhulnaSoft/integrations-core/pull/7513))
...
* Improve collection of library logs for debug flares ([#7252](https://github.com/KhulnaSoft/integrations-core/pull/7252))

***Fixed***:

* Use DEBUG log level for Vertica when Agent log level is DEBUG or TRACE ([#7264](https://github.com/KhulnaSoft/integrations-core/pull/7264))
...
* Add version metadata ([#6346](https://github.com/KhulnaSoft/integrations-core/pull/6346))
...
* Fix client log ([#5011](https://github.com/KhulnaSoft/integrations-core/pull/5011))

## 1.3.0 / 2019-11-14

***Added***:

* Add vertica lib log config ([#5005](https://github.com/KhulnaSoft/integrations-core/pull/5005))

## 1.2.0 / 2019-11-11

***Added***:

* Create a new connection at every check run when necessary ([#4983](https://github.com/KhulnaSoft/integrations-core/pull/4983))

## 1.1.1 / 2019-11-06

***Fixed***:

* Recreate connection when closed ([#4958](https://github.com/KhulnaSoft/integrations-core/pull/4958))

## 1.1.0 / 2019-10-11 / Agent 6.15.0

***Added***:

* Add more Vertica metrics ([#4649](https://github.com/KhulnaSoft/integrations-core/pull/4649))

## 1.0.0 / 2019-08-24 / Agent 6.14.0

***Added***:

* Add Vertica integration ([#3890](https://github.com/KhulnaSoft/integrations-core/pull/3890))
