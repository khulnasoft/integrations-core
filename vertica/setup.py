...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'vertica', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-vertica',
    version=ABOUT['__version__'],
    description='The Vertica check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent vertica check',
    ...
    packages=['khulnasoft_checks.vertica'],
