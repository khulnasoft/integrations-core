...
from khulnasoft_checks.base.log import TRACE_LEVEL
from khulnasoft_checks.vertica import VerticaCheck
from khulnasoft_checks.vertica.utils import parse_major_version
...
def test_ssl_config_ok(aggregator, tls_instance):
    with mock.patch('khulnasoft_checks.vertica.vertica.vertica') as vertica:
        with mock.patch('khulnasoft_checks.base.utils.tls.ssl') as ssl:
