...
from khulnasoft_checks.vertica.vertica import VerticaClient
...
def test_check(aggregator, khulnasoft_agent, instance, dd_run_check):
    ...
    khulnasoft_agent.assert_metadata_count(len(version_metadata) + 4)
