...
* Fix mapping of columns and use delta=1 where required ([#11775](https://github.com/KhulnaSoft/integrations-core/pull/11775)) Thanks [kjmadscience](https://github.com/kjmadscience).
...
* Pass Delta flag to calls to Statistics ([#11655](https://github.com/KhulnaSoft/integrations-core/pull/11655)) Thanks [ssomagani](https://github.com/ssomagani).
...
* Add `pyproject.toml` file ([#11455](https://github.com/KhulnaSoft/integrations-core/pull/11455))
...
* Add runtime configuration validation ([#9004](https://github.com/KhulnaSoft/integrations-core/pull/9004))

## 1.2.0 / 2021-04-28

***Added***:

* New voltdb metrics ([#9233](https://github.com/KhulnaSoft/integrations-core/pull/9233))

## 1.1.0 / 2021-03-07 / Agent 7.27.0

***Added***:

* Remove code for legacy workaround ([#8451](https://github.com/KhulnaSoft/integrations-core/pull/8451))
...
* Add VoltDB integration ([#7973](https://github.com/KhulnaSoft/integrations-core/pull/7973))
