...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'voltdb', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-voltdb',
    version=ABOUT['__version__'],
    description='The VoltDB check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent voltdb check',
    ...
    packages=['khulnasoft_checks.voltdb'],
