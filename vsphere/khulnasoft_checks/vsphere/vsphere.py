...
from khulnasoft_checks.base import AgentCheck, is_affirmative, to_string
from khulnasoft_checks.base.checks.libs.timer import Timer
from khulnasoft_checks.base.utils.time import get_current_datetime, get_timestamp
from khulnasoft_checks.vsphere.api import APIConnectionError, VSphereAPI
from khulnasoft_checks.vsphere.api_rest import VSphereRestAPI
from khulnasoft_checks.vsphere.cache import InfrastructureCache, MetricsMetadataCache
from khulnasoft_checks.vsphere.config import VSphereConfig
from khulnasoft_checks.vsphere.constants import (
...
from khulnasoft_checks.vsphere.event import VSphereEvent
from khulnasoft_checks.vsphere.metrics import ALLOWED_METRICS_FOR_MOR, PERCENT_METRICS
from khulnasoft_checks.vsphere.resource_filters import TagFilter
from khulnasoft_checks.vsphere.types import (
    CounterId,  # noqa: F401
...
from khulnasoft_checks.vsphere.utils import (
    MOR_TYPE_AS_STRING,
    add_additional_tags,
    format_metric_name,
...
try:
    ...
    from khulnasoft_checks.base.stubs import khulnasoft_agent
...
class VSphereCheck(AgentCheck):
    ...
    def __new__(cls, name, init_config, instances):
        ...
        if is_affirmative(instances[0].get('use_legacy_check_version', True)):
            from khulnasoft_checks.vsphere.legacy.vsphere_legacy import VSphereLegacyCheck
    ...
    def collect_events(self):
        ...
        try:
            ...
            for event in new_events:
                ...
                event_payload = normalized_event.get_khulnasoft_payload()
    ...
    def check(self, _):
        # type: (Any) -> None
        self._hostname = khulnasoft_agent.get_hostname()
