...
from khulnasoft_checks.vsphere.cache import InfrastructureCache, MetricsMetadataCache, VSphereCache
...
def test_generic_cache_usage():
    interval = 120
    with patch('khulnasoft_checks.vsphere.cache.time') as time:
