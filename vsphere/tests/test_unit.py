...
from khulnasoft_checks.base.utils.time import get_current_datetime
from khulnasoft_checks.vsphere import VSphereCheck
...
def test_metadata(khulnasoft_agent, aggregator, dd_run_check, default_instance, service_instance):
    check = VSphereCheck('vsphere', {}, [default_instance])
...
def test_disabled_metadata(khulnasoft_agent, aggregator, dd_run_check, default_instance, service_instance):
    check = VSphereCheck('vsphere', {}, [default_instance])
    check.check_id = 'test:123'
    khulnasoft_agent._config["enable_metadata_collection"] = False
    dd_run_check(check)
...
def test_property_metrics_expired_cache(
    ...
    with mock.patch('khulnasoft_checks.vsphere.cache.time') as time:
