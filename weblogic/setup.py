...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'weblogic', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-weblogic',
    version=ABOUT['__version__'],
    description='The weblogic check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent weblogic check',
    ...
    packages=['khulnasoft_checks.weblogic'],
