...
from khulnasoft_checks.base.errors import SkipInstanceError
from khulnasoft_checks.base.utils.common import exclude_undefined_keys
...
class Win32EventLogCheck(AgentCheck, ConfigMixin):
    ...
    # https://docs.khulnasoft.com/integrations/faq/list-of-api-source-attribute-value/
