...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'win32_event_log', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-win32_event_log',
    version=ABOUT['__version__'],
    description='The Win32 Event Log check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent win32_event_log check',
    ...
    packages=['khulnasoft_checks.win32_event_log'],
