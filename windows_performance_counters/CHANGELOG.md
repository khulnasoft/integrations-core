...
* Add `pyproject.toml` file ([#11459](https://github.com/KhulnaSoft/integrations-core/pull/11459))
...
* Add new integration for monitoring Windows performance counters ([#10619](https://github.com/KhulnaSoft/integrations-core/pull/10619))
