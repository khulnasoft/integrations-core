...
* Fix regression introduced in Agent 7.41.0 when handling service name patterns that are a prefix of another pattern ([#16120](https://github.com/KhulnaSoft/integrations-core/pull/16120))

## 4.7.0 / 2023-10-26

***Added***:

* Add Windows service `trigger_start` filter to config ([#16038](https://github.com/KhulnaSoft/integrations-core/pull/16038))
...
* Add Windows service `startup_type` filter to config ([#12940](https://github.com/KhulnaSoft/integrations-core/pull/12940))

## 4.3.0 / 2022-09-16 / Agent 7.40.0

***Added***:

* Add optional windows_service_startup_type tag ([#12932](https://github.com/KhulnaSoft/integrations-core/pull/12932))
...
* Add `pyproject.toml` file ([#11460](https://github.com/KhulnaSoft/integrations-core/pull/11460))
...
* Add runtime configuration validation ([#9007](https://github.com/KhulnaSoft/integrations-core/pull/9007))
...
* Report UNKNOWN instead of CRITICAL if no Windows service matches the query ([#8171](https://github.com/KhulnaSoft/integrations-core/pull/8171))

## 2.8.0 / 2020-12-11 / Agent 7.25.0

***Added***:

* windows service config specs ([#7974](https://github.com/KhulnaSoft/integrations-core/pull/7974))
...
* Deprecate `service` tag ([#5545](https://github.com/KhulnaSoft/integrations-core/pull/5545))
...
* Search patterns in reverse sort order ([#4503](https://github.com/KhulnaSoft/integrations-core/pull/4503))

## 2.1.0 / 2019-05-14 / Agent 6.12.0

***Added***:

* Adhere to code style ([#3583](https://github.com/KhulnaSoft/integrations-core/pull/3583))

***Fixed***:

* Add debug to compare short names, service names and patterns ([#3427](https://github.com/KhulnaSoft/integrations-core/pull/3427))
...
[1]: https://github.com/KhulnaSoft/integrations-core/pull/2322
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2305
[3]: https://github.com/KhulnaSoft/integrations-core/pull/1727
