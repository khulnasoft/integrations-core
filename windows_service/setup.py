...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'windows_service', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-windows_service',
    version=ABOUT['__version__'],
    description='The Windows Service check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent windows_service check',
    ...
    packages=['khulnasoft_checks.windows_service'],
