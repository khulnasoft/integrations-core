...
from khulnasoft_checks.windows_service import WindowsService
...
def test_trigger_count_failure(aggregator, check, instance_trigger_start, caplog):
    ...
    with patch(
        'khulnasoft_checks.windows_service.windows_service.QueryServiceConfig2W',
...
def test_name_regex_order(aggregator, check, instance_name_regex_prefix):
    ...
    See https://github.com/KhulnaSoft/integrations-core/pull/4503
    """
