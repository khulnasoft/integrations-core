...
* Add `pyproject.toml` file ([#11461](https://github.com/KhulnaSoft/integrations-core/pull/11461))
...
* Add runtime configuration validation ([#9008](https://github.com/KhulnaSoft/integrations-core/pull/9008))
...
* Fix missing tags from tag_by ([#7706](https://github.com/KhulnaSoft/integrations-core/pull/7706))

## 1.9.1 / 2020-08-10 / Agent 7.22.0

***Fixed***:

* Fix namespace default value ([#7179](https://github.com/KhulnaSoft/integrations-core/pull/7179))
...
* Remove multi-instances support ([#6325](https://github.com/KhulnaSoft/integrations-core/pull/6325))
...
* Add config specs ([#6409](https://github.com/KhulnaSoft/integrations-core/pull/6409))
...
* Adhere to code style ([#3584](https://github.com/KhulnaSoft/integrations-core/pull/3584))

## 1.3.0 / 2019-02-18 / Agent 6.10.0

***Added***:

* Support Python 3 for WMI ([#3031](https://github.com/KhulnaSoft/integrations-core/pull/3031))
...
[2]: https://github.com/KhulnaSoft/integrations-core/pull/2133
