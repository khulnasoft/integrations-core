...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'khulnasoft_checks', 'wmi_check', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-wmi_check',
    version=ABOUT['__version__'],
    description='The WMI check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent wmi_check check',
    ...
    packages=['khulnasoft_checks.wmi_check'],
