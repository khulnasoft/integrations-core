...
# Get version info
ABOUT = {}
with open(path.join(HERE, "khulnasoft_checks", "yarn", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='khulnasoft-yarn',
    version=ABOUT['__version__'],
    description='The Yarn check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='khulnasoft agent yarn check',
    ...
    packages=['khulnasoft_checks.yarn'],
