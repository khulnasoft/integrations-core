...
from khulnasoft_checks.base import AgentCheck, ensure_bytes, ensure_unicode, is_affirmative
...
class ZookeeperCheck(AgentCheck):
    ...
    def check(self, _):
        ...
        try:
            ...
            self.warning(e)
            self.increment('zookeeper.khulnasoft_client_exception')
            if self.should_report_instance_mode:
    ...
    def parse_stat(self, buf):
        ...
        # See https://github.com/KhulnaSoft/integrations-core/issues/816
