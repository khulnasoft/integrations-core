...
METRICS_36 = METRICS_34 + [
    ...
    'zookeeper.inflight_diff_count_count',
    'zookeeper.inflight_diff_count_sum',
    'zookeeper.inflight_snap_count_count',
    'zookeeper.inflight_snap_count_sum',
    ...
    'zookeeper.jvm_pause_time_ms_count',
    'zookeeper.jvm_pause_time_ms_sum',
